...
from mastapy._private.utility.property import _1890
...
class _Cast_DutyCyclePropertySummaryStress:
    ...
    def duty_cycle_property_summary(
        self: "CastSelf",
    ) -> "_1890.DutyCyclePropertySummary":
        return self.__parent__._cast(_1890.DutyCyclePropertySummary)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DutyCyclePropertySummaryStress(_1890.DutyCyclePropertySummary[_1765.Stress, T]):
    """DutyCyclePropertySummaryStress
