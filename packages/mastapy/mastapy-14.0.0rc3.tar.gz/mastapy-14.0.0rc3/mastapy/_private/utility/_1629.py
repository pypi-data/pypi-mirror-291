...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility import _1642, _1628
...
class EnvironmentSummary(_0.APIBase):
    ...
    @property
    def current_culture(self: "Self") -> "_1642.NumberFormatInfoSummary":
    ...
    @property
    def dispatchers(self: "Self") -> "List[_1628.DispatcherHelper]":
