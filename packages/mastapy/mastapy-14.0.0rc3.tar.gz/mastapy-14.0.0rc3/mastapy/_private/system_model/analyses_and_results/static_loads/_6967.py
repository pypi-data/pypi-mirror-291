...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results import _2741, _2737, _2735
...
class BearingLoadCase(_6998.ConnectorLoadCase):
    ...
    def include_fitting_effects(
        ...
        value = (
            enum_with_selected_value.EnumWithSelectedValue_LoadCaseOverrideOption.wrapped_type()
        )
        return enum_with_selected_value_runtime.create(temp, value)
    ...
    def include_fitting_effects(
        ...
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
            enum_with_selected_value.EnumWithSelectedValue_LoadCaseOverrideOption.implicit_type()
        )
        value = conversion.mp_to_pn_enum(value, enclosed_type)
        value = wrapper_type[enclosed_type](value)
