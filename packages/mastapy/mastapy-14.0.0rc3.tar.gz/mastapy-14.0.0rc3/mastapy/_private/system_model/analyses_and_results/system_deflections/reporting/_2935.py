...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.enums import _1873
    from mastapy._private.utility.report import _1820, _1821, _1822, _1814
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftSystemDeflectionSectionsReport(_1807.CustomReportChart):
    """ShaftSystemDeflectionSectionsReport
    ...
    @property
    def display(self: "Self") -> "_1873.TableAndChartOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.enums._1873", "TableAndChartOptions"
        )(value)

    @display.setter
    @enforce_parameter_types
    def display(self: "Self", value: "_1873.TableAndChartOptions") -> None:
