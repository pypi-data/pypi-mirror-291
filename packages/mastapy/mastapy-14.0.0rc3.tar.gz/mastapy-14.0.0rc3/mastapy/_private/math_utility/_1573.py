...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility import _1557, _1572, _1574, _1579, _1584
...
class _Cast_RealMatrix:
    ...
    @property
    def generic_matrix(self: "CastSelf") -> "_1562.GenericMatrix":
        pass

        return self.__parent__._cast(_1562.GenericMatrix)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RealMatrix(_1562.GenericMatrix[float, "RealMatrix"]):
    """RealMatrix
