...
class OnedimensionalFunctionLookupTable(
    _1614.LookupTableBase["OnedimensionalFunctionLookupTable"]
):
    """OnedimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self: "Self") -> "_1583.Vector2DListAccessor":
    ...
    def lookup_table(self: "Self", value: "_1583.Vector2DListAccessor") -> None:
