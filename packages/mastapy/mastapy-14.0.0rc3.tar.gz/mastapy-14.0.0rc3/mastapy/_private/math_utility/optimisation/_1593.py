...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.optimisation import _1592, _1604
...
class _Cast_OptimizationVariable:
    ...
    @property
    def optimization_input(self: "CastSelf") -> "_1592.OptimizationInput":
        from mastapy._private.math_utility.optimisation import _1592

        return self.__parent__._cast(_1592.OptimizationInput)

    @property
    def reporting_optimization_input(
        self: "CastSelf",
    ) -> "_1604.ReportingOptimizationInput":
        from mastapy._private.math_utility.optimisation import _1604

        return self.__parent__._cast(_1604.ReportingOptimizationInput)
...
class OptimizationVariable(_0.APIBase):
    ...
    @property
    def measurement(self: "Self") -> "_1655.MeasurementBase":
    ...
    def measurement(self: "Self", value: "_1655.MeasurementBase") -> None:
