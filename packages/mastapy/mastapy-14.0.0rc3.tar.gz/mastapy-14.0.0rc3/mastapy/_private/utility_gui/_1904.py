...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.enums import _1872
...
class ScalingDrawStyle(_0.APIBase):
    ...
    @property
    def bearing_force_arrows(self: "Self") -> "_1872.BearingForceArrowOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.enums._1872", "BearingForceArrowOption"
        )(value)

    @bearing_force_arrows.setter
    @enforce_parameter_types
    def bearing_force_arrows(
        self: "Self", value: "_1872.BearingForceArrowOption"
    ) -> None:
