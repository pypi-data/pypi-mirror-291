...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility_gui.charts import _1917, _1911
...
class _Cast_ConstantLine:
    ...
    @property
    def mode_constant_line(self: "CastSelf") -> "_1911.ModeConstantLine":
        from mastapy._private.utility_gui.charts import _1911

        return self.__parent__._cast(_1911.ModeConstantLine)
...
class ConstantLine(_0.APIBase):
    ...
    @property
    def axis(self: "Self") -> "_1917.SMTAxis":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility_gui.charts._1917", "SMTAxis"
        )(value)
