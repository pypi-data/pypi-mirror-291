...
class EnumWithSelectedValue_StressConcentrationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_StressConcentrationMethod]",
    ) -> "_2163.StressConcentrationMethod":
        ...
        Returns:
            _2163.StressConcentrationMethod
        """
        return _2163.StressConcentrationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2163.StressConcentrationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_2163.StressConcentrationMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_2163.StressConcentrationMethod]":
