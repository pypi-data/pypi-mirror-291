...
class EnumWithSelectedValue_BearingToleranceClass(
    ...
    def wrapped_type(
        ...
        Returns:
            _1956.BearingToleranceClass
        """
        return _1956.BearingToleranceClass
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1956.BearingToleranceClass.type_()

    @property
    def selected_value(self: "Self") -> "_1956.BearingToleranceClass":
    ...
    @property
    def available_values(self: "Self") -> "List[_1956.BearingToleranceClass]":
