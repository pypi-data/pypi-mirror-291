...
class EnumWithSelectedValue_DynamicsResponseScaling(
    ...
    def wrapped_type(
        ...
        Returns:
            _1554.DynamicsResponseScaling
        """
        return _1554.DynamicsResponseScaling
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1554.DynamicsResponseScaling.type_()

    @property
    def selected_value(self: "Self") -> "_1554.DynamicsResponseScaling":
    ...
    @property
    def available_values(self: "Self") -> "List[_1554.DynamicsResponseScaling]":
