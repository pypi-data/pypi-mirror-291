...
class EnumWithSelectedValue_SplineFitClassType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1460.SplineFitClassType
        """
        return _1460.SplineFitClassType
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_SplineFitClassType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1460.SplineFitClassType.type_()

    @property
    def selected_value(self: "Self") -> "_1460.SplineFitClassType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1460.SplineFitClassType]":
