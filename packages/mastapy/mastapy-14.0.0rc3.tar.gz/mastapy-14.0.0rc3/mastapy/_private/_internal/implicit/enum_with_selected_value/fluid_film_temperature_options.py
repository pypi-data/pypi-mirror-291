...
class EnumWithSelectedValue_FluidFilmTemperatureOptions(
    ...
    def wrapped_type(
        ...
        Returns:
            _1937.FluidFilmTemperatureOptions
        """
        return _1937.FluidFilmTemperatureOptions
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1937.FluidFilmTemperatureOptions.type_()

    @property
    def selected_value(self: "Self") -> "_1937.FluidFilmTemperatureOptions":
    ...
    @property
    def available_values(self: "Self") -> "List[_1937.FluidFilmTemperatureOptions]":
