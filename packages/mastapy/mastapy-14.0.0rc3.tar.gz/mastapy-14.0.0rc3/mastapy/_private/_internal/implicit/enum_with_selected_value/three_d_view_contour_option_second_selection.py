...
class EnumWithSelectedValue_ThreeDViewContourOptionSecondSelection(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ThreeDViewContourOptionSecondSelection]",
    ) -> "_1876.ThreeDViewContourOptionSecondSelection":
        ...
        Returns:
            _1876.ThreeDViewContourOptionSecondSelection
        """
        return _1876.ThreeDViewContourOptionSecondSelection
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1876.ThreeDViewContourOptionSecondSelection.type_()

    @property
    def selected_value(self: "Self") -> "_1876.ThreeDViewContourOptionSecondSelection":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1876.ThreeDViewContourOptionSecondSelection]":
