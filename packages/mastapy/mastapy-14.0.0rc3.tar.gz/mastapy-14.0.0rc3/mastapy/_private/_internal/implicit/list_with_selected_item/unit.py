...
class ListWithSelectedItem_Unit(_1660.Unit, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_Unit]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1660.Unit.TYPE

    @property
    def selected_value(self: "Self") -> "_1660.Unit":
    ...
    @property
    def available_values(self: "Self") -> "List[_1660.Unit]":
