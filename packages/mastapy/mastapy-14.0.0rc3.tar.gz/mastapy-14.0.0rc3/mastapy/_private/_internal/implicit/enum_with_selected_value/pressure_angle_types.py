...
class EnumWithSelectedValue_PressureAngleTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1452.PressureAngleTypes
        """
        return _1452.PressureAngleTypes
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_PressureAngleTypes]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1452.PressureAngleTypes.type_()

    @property
    def selected_value(self: "Self") -> "_1452.PressureAngleTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_1452.PressureAngleTypes]":
