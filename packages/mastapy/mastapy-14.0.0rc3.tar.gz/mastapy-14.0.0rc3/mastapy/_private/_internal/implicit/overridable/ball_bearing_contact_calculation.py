...
from mastapy._private.bearings.bearing_results.rolling import _2021
...
class Overridable_BallBearingContactCalculation(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2021.BallBearingContactCalculation
        """
        return _2021.BallBearingContactCalculation
    ...
    def implicit_type(cls: "Type[Overridable_BallBearingContactCalculation]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2021.BallBearingContactCalculation.type_()

    @property
    def value(self: "Self") -> "_2021.BallBearingContactCalculation":
    ...
    @property
    def override_value(self: "Self") -> "_2021.BallBearingContactCalculation":
        """mastapy.bearings.bearing_results.rolling.BallBearingContactCalculation
    ...
    @property
    def calculated_value(self: "Self") -> "_2021.BallBearingContactCalculation":
        """mastapy.bearings.bearing_results.rolling.BallBearingContactCalculation
