...
class EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption]",
    ) -> "_1442.DudleyEffectiveLengthApproximationOption":
        ...
        Returns:
            _1442.DudleyEffectiveLengthApproximationOption
        """
        return _1442.DudleyEffectiveLengthApproximationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1442.DudleyEffectiveLengthApproximationOption.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1442.DudleyEffectiveLengthApproximationOption]":
