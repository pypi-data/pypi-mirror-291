...
class EnumWithSelectedValue_ComplexPartDisplayOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ComplexPartDisplayOption]",
    ) -> "_1543.ComplexPartDisplayOption":
        ...
        Returns:
            _1543.ComplexPartDisplayOption
        """
        return _1543.ComplexPartDisplayOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1543.ComplexPartDisplayOption.type_()

    @property
    def selected_value(self: "Self") -> "_1543.ComplexPartDisplayOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_1543.ComplexPartDisplayOption]":
