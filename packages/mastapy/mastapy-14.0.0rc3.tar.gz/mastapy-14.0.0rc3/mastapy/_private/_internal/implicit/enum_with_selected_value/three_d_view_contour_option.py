...
class EnumWithSelectedValue_ThreeDViewContourOption(
    ...
    def wrapped_type(
        ...
        Returns:
            _1874.ThreeDViewContourOption
        """
        return _1874.ThreeDViewContourOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1874.ThreeDViewContourOption.type_()

    @property
    def selected_value(self: "Self") -> "_1874.ThreeDViewContourOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_1874.ThreeDViewContourOption]":
