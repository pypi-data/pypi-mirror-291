...
class EnumWithSelectedValue_RollingBearingArrangement(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RollingBearingArrangement]",
    ) -> "_1945.RollingBearingArrangement":
        ...
        Returns:
            _1945.RollingBearingArrangement
        """
        return _1945.RollingBearingArrangement
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1945.RollingBearingArrangement.type_()

    @property
    def selected_value(self: "Self") -> "_1945.RollingBearingArrangement":
    ...
    @property
    def available_values(self: "Self") -> "List[_1945.RollingBearingArrangement]":
