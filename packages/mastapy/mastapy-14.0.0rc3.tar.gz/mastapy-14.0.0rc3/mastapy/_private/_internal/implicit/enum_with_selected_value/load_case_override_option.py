...
class EnumWithSelectedValue_LoadCaseOverrideOption(
    ...
    def wrapped_type(
        ...
        Returns:
            _1638.LoadCaseOverrideOption
        """
        return _1638.LoadCaseOverrideOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1638.LoadCaseOverrideOption.type_()

    @property
    def selected_value(self: "Self") -> "_1638.LoadCaseOverrideOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_1638.LoadCaseOverrideOption]":
