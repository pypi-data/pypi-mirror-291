...
from mastapy._private.bearings import _1924
...
class EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod]",
    ) -> "_1924.BasicStaticLoadRatingCalculationMethod":
        ...
        Returns:
            _1924.BasicStaticLoadRatingCalculationMethod
        """
        return _1924.BasicStaticLoadRatingCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1924.BasicStaticLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: "Self") -> "_1924.BasicStaticLoadRatingCalculationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1924.BasicStaticLoadRatingCalculationMethod]":
