...
class EnumWithSelectedValue_SplineToleranceClassTypes(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_SplineToleranceClassTypes]",
    ) -> "_1466.SplineToleranceClassTypes":
        ...
        Returns:
            _1466.SplineToleranceClassTypes
        """
        return _1466.SplineToleranceClassTypes
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1466.SplineToleranceClassTypes.type_()

    @property
    def selected_value(self: "Self") -> "_1466.SplineToleranceClassTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_1466.SplineToleranceClassTypes]":
