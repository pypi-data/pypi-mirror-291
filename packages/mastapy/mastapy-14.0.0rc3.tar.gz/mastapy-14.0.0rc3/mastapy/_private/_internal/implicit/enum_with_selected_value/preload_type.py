...
class EnumWithSelectedValue_PreloadType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_PreloadType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2015.PreloadType.type_()

    @property
    def selected_value(self: "Self") -> "_2015.PreloadType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2015.PreloadType]":
