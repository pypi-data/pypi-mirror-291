...
from mastapy._private.math_utility.hertzian_contact import _1621
...
class Overridable_ContactDampingModel(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1621.ContactDampingModel
        """
        return _1621.ContactDampingModel
    ...
    def implicit_type(cls: "Type[Overridable_ContactDampingModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1621.ContactDampingModel.type_()

    @property
    def value(self: "Self") -> "_1621.ContactDampingModel":
    ...
    @property
    def override_value(self: "Self") -> "_1621.ContactDampingModel":
        """mastapy.math_utility.hertzian_contact.ContactDampingModel
    ...
    @property
    def calculated_value(self: "Self") -> "_1621.ContactDampingModel":
        """mastapy.math_utility.hertzian_contact.ContactDampingModel
