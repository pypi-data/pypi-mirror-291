...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BasicDynamicForceLoadCase(_1407.ElectricMachineLoadCaseBase):
    """BasicDynamicForceLoadCase
    ...
    def number_of_steps_per_operating_point_specification_method(
        self: "Self",
    ) -> "_1416.NumberOfStepsPerOperatingPointSpecificationMethod":
    ...
    @enforce_parameter_types
    def number_of_steps_per_operating_point_specification_method(
        self: "Self", value: "_1416.NumberOfStepsPerOperatingPointSpecificationMethod"
    ) -> None:
    ...
    @property
    def operating_points(self: "Self") -> "List[_1397.DynamicForcesOperatingPoint]":
    ...
    def remove_operating_point(
        self: "Self", operating_point: "_1397.DynamicForcesOperatingPoint"
    ) -> None:
        """Method does not return.
