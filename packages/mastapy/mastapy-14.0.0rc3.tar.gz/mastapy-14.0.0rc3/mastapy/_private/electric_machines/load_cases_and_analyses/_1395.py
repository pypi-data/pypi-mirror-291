...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.load_cases_and_analyses import _1394, _1404
...
class DynamicForceAnalysis(
    _1400.ElectricMachineAnalysis, _1387.IHaveDynamicForceResults
):
    """DynamicForceAnalysis
    ...
    @property
    def load_case(self: "Self") -> "_1394.BasicDynamicForceLoadCase":
    ...
    @property
    def results(self: "Self") -> "_1369.DynamicForceResults":
    ...
    def single_operating_point_analyses(
        self: "Self",
    ) -> "List[_1404.ElectricMachineFEAnalysis]":
