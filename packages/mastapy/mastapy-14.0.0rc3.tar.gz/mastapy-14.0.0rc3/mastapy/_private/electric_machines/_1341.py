...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1328, _1357, _1358
...
class _Cast_RotorInternalLayerSpecification:
    ...
    def u_shaped_layer_specification(
        self: "CastSelf",
    ) -> "_1357.UShapedLayerSpecification":
        from mastapy._private.electric_machines import _1357

        return self.__parent__._cast(_1357.UShapedLayerSpecification)

    @property
    def v_shaped_magnet_layer_specification(
        self: "CastSelf",
    ) -> "_1358.VShapedMagnetLayerSpecification":
        from mastapy._private.electric_machines import _1358

        return self.__parent__._cast(_1358.VShapedMagnetLayerSpecification)
