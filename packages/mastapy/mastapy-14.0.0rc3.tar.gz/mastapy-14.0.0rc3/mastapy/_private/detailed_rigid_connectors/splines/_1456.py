...
if TYPE_CHECKING:
    ...
    from mastapy._private.detailed_rigid_connectors.splines import _1443, _1463
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SAESplineJointDesign(_1468.StandardSplineJointDesign):
    """SAESplineJointDesign
    ...
    @property
    def fit_type(self: "Self") -> "_1443.FitTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.detailed_rigid_connectors.splines._1443", "FitTypes"
        )(value)

    @fit_type.setter
    @enforce_parameter_types
    def fit_type(self: "Self", value: "_1443.FitTypes") -> None:
