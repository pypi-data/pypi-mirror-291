...
if TYPE_CHECKING:
    ...
    from mastapy._private.detailed_rigid_connectors.splines import _1459, _1450, _1462
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DIN5480SplineHalfDesign(_1467.StandardSplineHalfDesign):
    """DIN5480SplineHalfDesign
    ...
    @property
    def finishing_method(self: "Self") -> "_1459.FinishingMethods":
    ...
    def finishing_method(self: "Self", value: "_1459.FinishingMethods") -> None:
    ...
    @property
    def manufacturing_type(self: "Self") -> "_1450.ManufacturingTypes":
    ...
    @enforce_parameter_types
    def manufacturing_type(self: "Self", value: "_1450.ManufacturingTypes") -> None:
        value = conversion.mp_to_pn_enum(
