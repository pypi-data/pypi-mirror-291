...
from mastapy._private.detailed_rigid_connectors.splines import _1442, _1465
from mastapy._private._internal.overridable_constructor import _unpack_overridable
from mastapy._private.detailed_rigid_connectors import _1435
...
class _Cast_SplineJointDesign:
    ...
    def detailed_rigid_connector_design(
        self: "CastSelf",
    ) -> "_1435.DetailedRigidConnectorDesign":
        return self.__parent__._cast(_1435.DetailedRigidConnectorDesign)

    @property
    def custom_spline_joint_design(self: "CastSelf") -> "_1438.CustomSplineJointDesign":
        from mastapy._private.detailed_rigid_connectors.splines import _1438

        return self.__parent__._cast(_1438.CustomSplineJointDesign)

    @property
    def din5480_spline_joint_design(
        self: "CastSelf",
    ) -> "_1441.DIN5480SplineJointDesign":
        from mastapy._private.detailed_rigid_connectors.splines import _1441

        return self.__parent__._cast(_1441.DIN5480SplineJointDesign)

    @property
    def gbt3478_spline_joint_design(
        self: "CastSelf",
    ) -> "_1445.GBT3478SplineJointDesign":
        from mastapy._private.detailed_rigid_connectors.splines import _1445

        return self.__parent__._cast(_1445.GBT3478SplineJointDesign)

    @property
    def iso4156_spline_joint_design(
        self: "CastSelf",
    ) -> "_1448.ISO4156SplineJointDesign":
        from mastapy._private.detailed_rigid_connectors.splines import _1448

        return self.__parent__._cast(_1448.ISO4156SplineJointDesign)

    @property
    def jisb1603_spline_joint_design(
        self: "CastSelf",
    ) -> "_1449.JISB1603SplineJointDesign":
        from mastapy._private.detailed_rigid_connectors.splines import _1449

        return self.__parent__._cast(_1449.JISB1603SplineJointDesign)

    @property
    def sae_spline_joint_design(self: "CastSelf") -> "_1456.SAESplineJointDesign":
        from mastapy._private.detailed_rigid_connectors.splines import _1456

        return self.__parent__._cast(_1456.SAESplineJointDesign)

    @property
    def standard_spline_joint_design(
        self: "CastSelf",
    ) -> "_1468.StandardSplineJointDesign":
        from mastapy._private.detailed_rigid_connectors.splines import _1468

        return self.__parent__._cast(_1468.StandardSplineJointDesign)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SplineJointDesign(_1435.DetailedRigidConnectorDesign):
    """SplineJointDesign
    ...
    @enforce_parameter_types
    def dudley_maximum_effective_length_option(
        self: "Self", value: "_1442.DudleyEffectiveLengthApproximationOption"
    ) -> None:
    ...
    @property
    def fatigue_life_factor_type(self: "Self") -> "_1454.SAEFatigueLifeFactorTypes":
    ...
    def fatigue_life_factor_type(
        self: "Self", value: "_1454.SAEFatigueLifeFactorTypes"
    ) -> None:
    ...
    @property
    def root_type(self: "Self") -> "_1453.RootTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.detailed_rigid_connectors.splines._1453", "RootTypes"
        )(value)

    @root_type.setter
    @enforce_parameter_types
    def root_type(self: "Self", value: "_1453.RootTypes") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def spline_fixture_type(self: "Self") -> "_1461.SplineFixtureTypes":
    ...
    @enforce_parameter_types
    def spline_fixture_type(self: "Self", value: "_1461.SplineFixtureTypes") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def spline_rating_type(self: "Self", value: "_1465.SplineRatingTypes") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def torque_cycles(self: "Self") -> "_1457.SAETorqueCycles":
    ...
    @enforce_parameter_types
    def torque_cycles(self: "Self", value: "_1457.SAETorqueCycles") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def external_half(self: "Self") -> "_1462.SplineHalfDesign":
    ...
    @property
    def internal_half(self: "Self") -> "_1462.SplineHalfDesign":
        """mastapy.detailed_rigid_connectors.splines.SplineHalfDesign
