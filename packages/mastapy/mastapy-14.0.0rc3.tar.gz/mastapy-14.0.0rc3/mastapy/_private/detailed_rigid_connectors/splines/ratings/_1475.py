...
class _Cast_GBT17855SplineHalfRating:
    ...
    @property
    def spline_half_rating(self: "CastSelf") -> "_1479.SplineHalfRating":
        return self.__parent__._cast(_1479.SplineHalfRating)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GBT17855SplineHalfRating(_1479.SplineHalfRating):
    """GBT17855SplineHalfRating
