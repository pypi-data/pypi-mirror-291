...
from mastapy._private.detailed_rigid_connectors.splines import _1460, _1466
...
class FitAndTolerance(_0.APIBase):
    ...
    def fit_class(self: "Self", value: "_1460.SplineFitClassType") -> None:
    ...
    @enforce_parameter_types
    def tolerance_class(self: "Self", value: "_1466.SplineToleranceClassTypes") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
