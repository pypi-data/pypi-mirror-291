...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _1949, _1922, _1938
...
class RollingBearingDatabase(
    _1884.SQLDatabase[_1947.RollingBearingKey, _2219.RollingBearing]
):
    """RollingBearingDatabase
    ...
    def add_to_database(self: "Self", bearing: "_2219.RollingBearing") -> None:
    ...
    @enforce_parameter_types
    def create_bearing(
        self: "Self", type_: "_1949.RollingBearingType", designation: "str" = "None"
    ) -> "_2219.RollingBearing":
    ...
    @enforce_parameter_types
    def remove_from_database(self: "Self", bearing: "_2219.RollingBearing") -> None:
        """Method does not return.
    ...
    def search_for_rolling_bearing_with_catalog(
        self: "Self", catalog: "_1922.BearingCatalog"
    ) -> "List[_2219.RollingBearing]":
    ...
    def search_for_rolling_bearing_with_name_and_catalog(
        self: "Self", designation: "str", catalog: "_1922.BearingCatalog"
    ) -> "_2219.RollingBearing":
        """mastapy.bearings.bearing_designs.rolling.RollingBearing
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(
        self: "Self",
        designation: "str",
        catalog: "_1922.BearingCatalog",
        type_: "_1949.RollingBearingType",
    ) -> "List[_2219.RollingBearing]":
        """List[mastapy.bearings.bearing_designs.rolling.RollingBearing]
    ...
    def search_for_rolling_bearing(
        ...
        catalog: "_1922.BearingCatalog",
        type_: "_1949.RollingBearingType",
        bore_range: "_1537.Range",
        outer_diameter_range: "_1537.Range",
        width_range: "_1537.Range",
        dynamic_capacity_range: "_1537.Range",
        number_of_rows: "int",
        material_type: "_1938.HybridSteelAll",
    ) -> "List[_2219.RollingBearing]":
        """List[mastapy.bearings.bearing_designs.rolling.RollingBearing]
