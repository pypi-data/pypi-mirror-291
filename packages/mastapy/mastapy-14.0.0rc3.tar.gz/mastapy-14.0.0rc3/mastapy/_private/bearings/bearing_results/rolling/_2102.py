...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2083, _2087
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedTaperRollerBearingResults(_2078.LoadedNonBarrelRollerBearingResults):
    """LoadedTaperRollerBearingResults
