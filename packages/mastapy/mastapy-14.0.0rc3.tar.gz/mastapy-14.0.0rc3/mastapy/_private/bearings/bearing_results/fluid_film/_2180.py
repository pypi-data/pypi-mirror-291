...
class _Cast_LoadedTiltingJournalPad:
    ...
    def loaded_fluid_film_bearing_pad(
        self: "CastSelf",
    ) -> "_2172.LoadedFluidFilmBearingPad":
        return self.__parent__._cast(_2172.LoadedFluidFilmBearingPad)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedTiltingJournalPad(_2172.LoadedFluidFilmBearingPad):
    """LoadedTiltingJournalPad
