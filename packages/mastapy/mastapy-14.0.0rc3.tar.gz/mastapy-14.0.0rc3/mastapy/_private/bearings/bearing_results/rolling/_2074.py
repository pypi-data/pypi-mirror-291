...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2081, _2082, _2068
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedNeedleRollerBearingElement(_2062.LoadedCylindricalRollerBearingElement):
    """LoadedNeedleRollerBearingElement
