...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2074, _2082, _2068
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedCylindricalRollerBearingElement(_2081.LoadedNonBarrelRollerElement):
    """LoadedCylindricalRollerBearingElement
