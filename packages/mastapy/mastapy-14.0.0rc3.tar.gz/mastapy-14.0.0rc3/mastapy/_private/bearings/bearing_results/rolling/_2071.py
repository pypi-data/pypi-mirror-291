...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2026, _2087
    from mastapy._private.bearings.bearing_results import _2008, _2011, _2003
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedFourPointContactBallBearingResults(_2056.LoadedBallBearingResults):
    """LoadedFourPointContactBallBearingResults
    ...
    @property
    def raceway_control(self: "Self") -> "_2026.FrictionModelForGyroscopicMoment":
