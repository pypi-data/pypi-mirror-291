...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2108, _2088
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedThrustBallBearingRow(_2057.LoadedBallBearingRow):
    """LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self: "Self") -> "_2108.LoadedThrustBallBearingResults":
