...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results import _2003, _2010, _2013
...
class LoadedBearingDutyCycle(_0.APIBase):
    ...
    @property
    def bearing_design(self: "Self") -> "_2184.BearingDesign":
    ...
    @property
    def bearing_load_case_results(self: "Self") -> "List[_2003.LoadedBearingResults]":
