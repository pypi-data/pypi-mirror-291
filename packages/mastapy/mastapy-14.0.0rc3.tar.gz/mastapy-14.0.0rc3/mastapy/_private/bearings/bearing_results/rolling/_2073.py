...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2069, _2104, _2068
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedMultiPointContactBallBearingElement(_2054.LoadedBallBearingElement):
    """LoadedMultiPointContactBallBearingElement
