...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.rolling import _2216, _2219
    from mastapy._private.bearings.bearing_designs import _2185, _2188, _2184
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TaperRollerBearing(_2215.NonBarrelRollerBearing):
    """TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self: "Self") -> "_1929.BearingMeasurementType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1929", "BearingMeasurementType"
        )(value)

    @bearing_measurement_type.setter
    @enforce_parameter_types
    def bearing_measurement_type(
        self: "Self", value: "_1929.BearingMeasurementType"
    ) -> None:
