...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.rolling import _2214, _2216, _2219
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalRollerBearing(_2215.NonBarrelRollerBearing):
    """CylindricalRollerBearing
    ...
    def permissible_axial_load_default_calculation_method(
        self: "Self",
    ) -> "_1996.CylindricalRollerMaxAxialLoadMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_results._1996",
    ...
    @enforce_parameter_types
    def permissible_axial_load_default_calculation_method(
        self: "Self", value: "_1996.CylindricalRollerMaxAxialLoadMethod"
    ) -> None:
