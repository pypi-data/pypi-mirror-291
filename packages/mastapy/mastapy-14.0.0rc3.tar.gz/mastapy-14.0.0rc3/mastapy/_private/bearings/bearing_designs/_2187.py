...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LinearBearing(_2184.BearingDesign):
    """LinearBearing
    ...
    @property
    def stiffness_options(self: "Self") -> "_1935.BearingStiffnessMatrixOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._1935", "BearingStiffnessMatrixOption"
        )(value)

    @stiffness_options.setter
    @enforce_parameter_types
    def stiffness_options(
        self: "Self", value: "_1935.BearingStiffnessMatrixOption"
    ) -> None:
