...
from mastapy._private.utility.units_and_measurements.measurements import _1717, _1738
...
class ToothThicknessSpecificationBase(_0.APIBase):
    ...
    def chordal_span(
        self: "Self",
    ) -> "_1068.CylindricalGearToothThicknessSpecification[_1717.LengthShort]":
    ...
    def profile_shift_coefficient(
        self: "Self",
    ) -> "_1068.CylindricalGearToothThicknessSpecification[_1738.Number]":
    ...
    def tooth_thickness(
        self: "Self",
    ) -> "List[_1068.CylindricalGearToothThicknessSpecification[_1717.LengthShort]]":
