...
class _Cast_BarForPareto:
    ...
    def pareto_optimisation_strategy_bars(
        self: "CastSelf",
    ) -> "_1598.ParetoOptimisationStrategyBars":
        return self.__parent__._cast(_1598.ParetoOptimisationStrategyBars)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BarForPareto(
    _1598.ParetoOptimisationStrategyBars, Generic[TAnalysis, TCandidate]
):
    """BarForPareto
