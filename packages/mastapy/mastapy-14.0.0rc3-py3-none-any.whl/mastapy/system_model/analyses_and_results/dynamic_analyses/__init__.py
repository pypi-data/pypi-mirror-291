...
if __tc:
    from mastapy._private.system_model.analyses_and_results.dynamic_analyses._6416 import (
        AbstractAssemblyDynamicAnalysis,
    )
    from mastapy._private.system_model.analyses_and_results.dynamic_analyses._6417 import (
        AbstractShaftDynamicAnalysis,
    )
    from mastapy._private.system_model.analyses_and_results.dynamic_analyses._6418 import (
        AbstractShaftOrHousingDynamicAnalysis,
    )
    from mastapy._private.system_model.analyses_and_results.dynamic_analyses._6419 import (
        AbstractShaftToMountableComponentConnectionDynamicAnalysis,
    )
    from mastapy._private.system_model.analyses_and_results.dynamic_analyses._6420 import (
    ...
    __import_structure = {
        "_private.system_model.analyses_and_results.dynamic_analyses._6416": [
            "AbstractAssemblyDynamicAnalysis"
        ],
        "_private.system_model.analyses_and_results.dynamic_analyses._6417": [
            "AbstractShaftDynamicAnalysis"
        ],
        "_private.system_model.analyses_and_results.dynamic_analyses._6418": [
            "AbstractShaftOrHousingDynamicAnalysis"
        ],
        "_private.system_model.analyses_and_results.dynamic_analyses._6419": [
            "AbstractShaftToMountableComponentConnectionDynamicAnalysis"
        ],
        "_private.system_model.analyses_and_results.dynamic_analyses._6420": [
            "AGMAGleasonConicalGearDynamicAnalysis"
        ],
