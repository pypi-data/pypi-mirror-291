...
class _Cast_GenericMatrix:
    ...
    @property
    def complex_matrix(self: "CastSelf") -> "_1542.ComplexMatrix":
        from mastapy._private.math_utility import _1542

        return self.__parent__._cast(_1542.ComplexMatrix)

    @property
    def complex_vector(self: "CastSelf") -> "_1544.ComplexVector":
        from mastapy._private.math_utility import _1544

        return self.__parent__._cast(_1544.ComplexVector)

    @property
    def complex_vector_3d(self: "CastSelf") -> "_1545.ComplexVector3D":
        from mastapy._private.math_utility import _1545

        return self.__parent__._cast(_1545.ComplexVector3D)

    @property
    def complex_vector_6d(self: "CastSelf") -> "_1546.ComplexVector6D":
        from mastapy._private.math_utility import _1546

        return self.__parent__._cast(_1546.ComplexVector6D)

    @property
    def euler_parameters(self: "CastSelf") -> "_1557.EulerParameters":
        from mastapy._private.math_utility import _1557

        return self.__parent__._cast(_1557.EulerParameters)

    @property
    def quaternion(self: "CastSelf") -> "_1572.Quaternion":
        from mastapy._private.math_utility import _1572

        return self.__parent__._cast(_1572.Quaternion)

    @property
    def real_matrix(self: "CastSelf") -> "_1573.RealMatrix":
        from mastapy._private.math_utility import _1573

        return self.__parent__._cast(_1573.RealMatrix)

    @property
    def real_vector(self: "CastSelf") -> "_1574.RealVector":
        from mastapy._private.math_utility import _1574

        return self.__parent__._cast(_1574.RealVector)

    @property
    def square_matrix(self: "CastSelf") -> "_1579.SquareMatrix":
        from mastapy._private.math_utility import _1579

        return self.__parent__._cast(_1579.SquareMatrix)

    @property
    def vector_6d(self: "CastSelf") -> "_1584.Vector6D":
        from mastapy._private.math_utility import _1584

        return self.__parent__._cast(_1584.Vector6D)
