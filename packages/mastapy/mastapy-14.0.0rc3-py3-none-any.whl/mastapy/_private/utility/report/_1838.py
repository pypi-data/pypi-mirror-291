...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.report import _1836, _1824
...
class _Cast_UserTextRow:
    ...
    def custom_report_property_item(
        self: "CastSelf",
    ) -> "_1824.CustomReportPropertyItem":
        from mastapy._private.utility.report import _1824

        return self.__parent__._cast(_1824.CustomReportPropertyItem)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class UserTextRow(_1829.CustomRow):
    """UserTextRow
    ...
    @property
    def heading_size(self: "Self") -> "_1836.HeadingSize":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.report._1836", "HeadingSize"
        )(value)

    @heading_size.setter
    @enforce_parameter_types
    def heading_size(self: "Self", value: "_1836.HeadingSize") -> None:
