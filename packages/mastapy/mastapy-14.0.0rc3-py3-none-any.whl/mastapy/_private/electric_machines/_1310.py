...
from mastapy._private.electric_machines import _1308, _1307
...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1356, _1303
...
class ElectricMachineSetup(_0.APIBase):
    ...
    def two_d_fe_model_for_mechanical_analysis(
        self: "Self",
    ) -> "_1356.TwoDimensionalFEModelForAnalysis[_1307.ElectricMachineMechanicalAnalysisMeshingOptions]":
        """mastapy.electric_machines.TwoDimensionalFEModelForAnalysis[mastapy.electric_machines.ElectricMachineMechanicalAnalysisMeshingOptions]
