...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.harmonic_load_data import _1433, _1434
...
class _Cast_StatorToothInterpolator:
    ...
    def stator_tooth_load_interpolator(
        ...
        return self.__parent__._cast(_1433.StatorToothLoadInterpolator)
    ...
    def stator_tooth_moment_interpolator(
        ...
        return self.__parent__._cast(_1434.StatorToothMomentInterpolator)
