...
class _Cast_StatorToothMomentInterpolator:
    ...
    @property
    def stator_tooth_interpolator(self: "CastSelf") -> "_1432.StatorToothInterpolator":
        return self.__parent__._cast(_1432.StatorToothInterpolator)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StatorToothMomentInterpolator(_1432.StatorToothInterpolator):
    """StatorToothMomentInterpolator
