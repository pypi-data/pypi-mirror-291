...
from mastapy._private.electric_machines import _1342, _1339
...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.results import _1386
...
class ElectricMachineResultsViewable(_182.ElmerResultsViewable):
    ...
    @property
    def force_view_options(self: "Self") -> "_1386.ElectricMachineForceViewOptions":
    ...
    def force_view_options(
        self: "Self", value: "_1386.ElectricMachineForceViewOptions"
    ) -> None:
    ...
    @results.setter
    @enforce_parameter_types
    def results(self: "Self", value: "_1374.ElectricMachineResults") -> None:
        wrapper_type = (
    ...
    @property
    def parts_to_view(self: "Self") -> "List[_1896.EnumWithBoolean[_1339.RegionID]]":
