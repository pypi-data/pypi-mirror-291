...
class _Cast_ElectricMachineResults:
    ...
    def on_load_electric_machine_results(
        self: "CastSelf",
    ) -> "_1392.OnLoadElectricMachineResults":
        from mastapy._private.electric_machines.results import _1392

        return self.__parent__._cast(_1392.OnLoadElectricMachineResults)

    @property
    def open_circuit_electric_machine_results(
        self: "CastSelf",
    ) -> "_1393.OpenCircuitElectricMachineResults":
        from mastapy._private.electric_machines.results import _1393

        return self.__parent__._cast(_1393.OpenCircuitElectricMachineResults)
...
class ElectricMachineResults(_0.APIBase):
    ...
    @property
    def results_timesteps(self: "Self") -> "List[_1383.ElectricMachineResultsTimeStep]":
    ...
    def results_for_conductor_turns(
        self: "Self",
    ) -> "List[_1375.ElectricMachineResultsForConductorTurn]":
    ...
    def results_for_line_to_line(
        self: "Self",
    ) -> "List[_1377.ElectricMachineResultsForLineToLine]":
    ...
    def results_for_phases(
        self: "Self",
    ) -> "List[_1379.ElectricMachineResultsForPhase]":
