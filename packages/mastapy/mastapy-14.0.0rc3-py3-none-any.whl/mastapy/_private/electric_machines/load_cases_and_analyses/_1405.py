...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ElectricMachineFEMechanicalAnalysis(_1400.ElectricMachineAnalysis):
    """ElectricMachineFEMechanicalAnalysis
    ...
    def electric_machine_mechanical_results(
        self: "Self",
    ) -> "_1372.ElectricMachineMechanicalResults":
    ...
    @property
    def load_case(self: "Self") -> "_1409.ElectricMachineMechanicalLoadCase":
