...
from mastapy._private.electric_machines.load_cases_and_analyses import _1420, _1394
...
class _Cast_DynamicForceLoadCase:
    ...
    def electric_machine_load_case_base(
        ...
        return self.__parent__._cast(_1407.ElectricMachineLoadCaseBase)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DynamicForceLoadCase(_1394.BasicDynamicForceLoadCase):
    """DynamicForceLoadCase
    ...
    @property
    def control_strategy(self: "Self") -> "_1402.ElectricMachineControlStrategy":
    ...
    def control_strategy(
        self: "Self", value: "_1402.ElectricMachineControlStrategy"
    ) -> None:
    ...
    @enforce_parameter_types
    def load_specification(self: "Self", value: "_1420.SpecifyTorqueOrCurrent") -> None:
    ...
    def operating_points_specification_method(
        self: "Self",
    ) -> "_1417.OperatingPointsSpecificationMethod":
    ...
    @enforce_parameter_types
    def operating_points_specification_method(
        self: "Self", value: "_1417.OperatingPointsSpecificationMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.ElectricMachines.LoadCasesAndAnalyses.OperatingPointsSpecificationMethod",
    ...
    @property
    def speed_points_distribution(self: "Self") -> "_1421.SpeedPointsDistribution":
    ...
    def speed_points_distribution(
        self: "Self", value: "_1421.SpeedPointsDistribution"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.ElectricMachines.LoadCasesAndAnalyses.SpeedPointsDistribution",
    ...
    def basic_mechanical_loss_settings(
        self: "Self",
    ) -> "_1401.ElectricMachineBasicMechanicalLossSettings":
    ...
    ) -> "_1397.DynamicForcesOperatingPoint":
