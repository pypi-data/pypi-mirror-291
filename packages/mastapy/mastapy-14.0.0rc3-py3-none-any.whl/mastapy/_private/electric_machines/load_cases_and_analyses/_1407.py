...
class _Cast_ElectricMachineLoadCaseBase:
    ...
    def basic_dynamic_force_load_case(
        self: "CastSelf",
    ) -> "_1394.BasicDynamicForceLoadCase":
        from mastapy._private.electric_machines.load_cases_and_analyses import _1394

        return self.__parent__._cast(_1394.BasicDynamicForceLoadCase)

    @property
    def dynamic_force_load_case(self: "CastSelf") -> "_1396.DynamicForceLoadCase":
        from mastapy._private.electric_machines.load_cases_and_analyses import _1396

        return self.__parent__._cast(_1396.DynamicForceLoadCase)

    @property
    def efficiency_map_load_case(self: "CastSelf") -> "_1399.EfficiencyMapLoadCase":
        from mastapy._private.electric_machines.load_cases_and_analyses import _1399

        return self.__parent__._cast(_1399.EfficiencyMapLoadCase)

    @property
    def electric_machine_load_case(self: "CastSelf") -> "_1406.ElectricMachineLoadCase":
        from mastapy._private.electric_machines.load_cases_and_analyses import _1406

        return self.__parent__._cast(_1406.ElectricMachineLoadCase)

    @property
    def electric_machine_mechanical_load_case(
        self: "CastSelf",
    ) -> "_1409.ElectricMachineMechanicalLoadCase":
        from mastapy._private.electric_machines.load_cases_and_analyses import _1409

        return self.__parent__._cast(_1409.ElectricMachineMechanicalLoadCase)

    @property
    def non_linear_dq_model_multiple_operating_points_load_case(
        self: "CastSelf",
    ) -> "_1415.NonLinearDQModelMultipleOperatingPointsLoadCase":
    ...
    def speed_torque_curve_load_case(
        self: "CastSelf",
    ) -> "_1423.SpeedTorqueCurveLoadCase":
        from mastapy._private.electric_machines.load_cases_and_analyses import _1423

        return self.__parent__._cast(_1423.SpeedTorqueCurveLoadCase)

    @property
    def speed_torque_load_case(self: "CastSelf") -> "_1424.SpeedTorqueLoadCase":
        from mastapy._private.electric_machines.load_cases_and_analyses import _1424

        return self.__parent__._cast(_1424.SpeedTorqueLoadCase)
...
class ElectricMachineLoadCaseBase(_0.APIBase):
    ...
    @property
    def temperatures(self: "Self") -> "_1425.Temperatures":
    ...
    @property
    def analyses(self: "Self") -> "List[_1400.ElectricMachineAnalysis]":
    ...
    @enforce_parameter_types
    def copy_to(
        self: "Self", another_group: "_1408.ElectricMachineLoadCaseGroup"
    ) -> "ElectricMachineLoadCaseBase":
    ...
    @enforce_parameter_types
    def remove_analysis(
        self: "Self", electric_machine_analysis: "_1400.ElectricMachineAnalysis"
    ) -> None:
        """Method does not return.
