...
class _Cast_HairpinConductor:
    ...
    @property
    def winding_conductor(self: "CastSelf") -> "_1359.WindingConductor":
        return self.__parent__._cast(_1359.WindingConductor)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HairpinConductor(_1359.WindingConductor):
    """HairpinConductor
