...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2055, _2070
...
class _Cast_LoadedRollingBearingRaceResults:
    ...
    def loaded_ball_bearing_race_results(
        self: "CastSelf",
    ) -> "_2055.LoadedBallBearingRaceResults":
        from mastapy._private.bearings.bearing_results.rolling import _2055

        return self.__parent__._cast(_2055.LoadedBallBearingRaceResults)
