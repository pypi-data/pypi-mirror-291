...
class _Cast_ISOResults:
    ...
    @property
    def ball_iso2812007_results(self: "CastSelf") -> "_2155.BallISO2812007Results":
        from mastapy._private.bearings.bearing_results.rolling.iso_rating_results import (
            _2155,
        )

        return self.__parent__._cast(_2155.BallISO2812007Results)
    ...
    @property
    def iso2812007_results(self: "CastSelf") -> "_2157.ISO2812007Results":
        from mastapy._private.bearings.bearing_results.rolling.iso_rating_results import (
            _2157,
        )

        return self.__parent__._cast(_2157.ISO2812007Results)

    @property
    def isots162812008_results(self: "CastSelf") -> "_2160.ISOTS162812008Results":
        from mastapy._private.bearings.bearing_results.rolling.iso_rating_results import (
            _2160,
        )

        return self.__parent__._cast(_2160.ISOTS162812008Results)

    @property
    def roller_iso2812007_results(self: "CastSelf") -> "_2161.RollerISO2812007Results":
        from mastapy._private.bearings.bearing_results.rolling.iso_rating_results import (
            _2161,
        )

        return self.__parent__._cast(_2161.RollerISO2812007Results)
    ...
    @property
    def ansiabma112014_results(self: "CastSelf") -> "_2169.ANSIABMA112014Results":
        from mastapy._private.bearings.bearing_results.rolling.abma import _2169

        return self.__parent__._cast(_2169.ANSIABMA112014Results)

    @property
    def ansiabma92015_results(self: "CastSelf") -> "_2170.ANSIABMA92015Results":
        from mastapy._private.bearings.bearing_results.rolling.abma import _2170

        return self.__parent__._cast(_2170.ANSIABMA92015Results)

    @property
    def ansiabma_results(self: "CastSelf") -> "_2171.ANSIABMAResults":
        from mastapy._private.bearings.bearing_results.rolling.abma import _2171

        return self.__parent__._cast(_2171.ANSIABMAResults)
