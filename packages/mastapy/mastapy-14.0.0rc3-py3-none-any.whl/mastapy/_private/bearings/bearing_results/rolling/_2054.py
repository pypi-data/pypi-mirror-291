...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.vectors import _1888, _1887
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedBallBearingElement(_2068.LoadedElement):
    """LoadedBallBearingElement
    ...
    @property
    def contact_patch_sliding_speed_inner(self: "Self") -> "_1888.PlaneScalarFieldData":
        """mastapy.utility.vectors.PlaneScalarFieldData
    ...
    @property
    def contact_patch_sliding_speed_outer(self: "Self") -> "_1888.PlaneScalarFieldData":
        """mastapy.utility.vectors.PlaneScalarFieldData
    ...
    def inner_race_contact_geometries(
        self: "Self",
    ) -> "List[_2022.BallBearingRaceContactGeometry]":
