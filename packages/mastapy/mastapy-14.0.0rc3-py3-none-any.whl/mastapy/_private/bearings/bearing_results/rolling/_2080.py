...
class _Cast_LoadedNonBarrelRollerBearingStripLoadResults:
    ...
    def loaded_roller_strip_load_results(
        self: "CastSelf",
    ) -> "_2085.LoadedRollerStripLoadResults":
        return self.__parent__._cast(_2085.LoadedRollerStripLoadResults)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedNonBarrelRollerBearingStripLoadResults(_2085.LoadedRollerStripLoadResults):
    """LoadedNonBarrelRollerBearingStripLoadResults
