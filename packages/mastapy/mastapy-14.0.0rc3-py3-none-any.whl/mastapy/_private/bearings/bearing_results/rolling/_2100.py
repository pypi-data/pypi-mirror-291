...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results import _2013, _2010, _2002
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedTaperRollerBearingDutyCycle(_2077.LoadedNonBarrelRollerBearingDutyCycle):
    """LoadedTaperRollerBearingDutyCycle
