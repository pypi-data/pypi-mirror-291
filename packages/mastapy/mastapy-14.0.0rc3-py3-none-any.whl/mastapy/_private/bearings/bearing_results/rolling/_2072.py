...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2071, _2070, _2088
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedFourPointContactBallBearingRow(_2057.LoadedBallBearingRow):
    """LoadedFourPointContactBallBearingRow
    ...
    def race_results(
        self: "Self",
    ) -> "List[_2070.LoadedFourPointContactBallBearingRaceResults]":
