...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2037, _2041, _2088
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedAngularContactBallBearingRow(_2057.LoadedBallBearingRow):
    """LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self: "Self") -> "_2037.LoadedAngularContactBallBearingResults":
