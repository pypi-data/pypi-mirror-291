...
class SKFModuleResults(_0.APIBase):
    ...
    @property
    def adjusted_speed(self: "Self") -> "_2130.AdjustedSpeed":
    ...
    @property
    def bearing_loads(self: "Self") -> "_2132.BearingLoads":
    ...
    @property
    def bearing_rating_life(self: "Self") -> "_2133.BearingRatingLife":
    ...
    @property
    def frequencies(self: "Self") -> "_2135.Frequencies":
    ...
    @property
    def friction(self: "Self") -> "_2137.Friction":
    ...
    @property
    def minimum_load(self: "Self") -> "_2145.MinimumLoad":
    ...
    @property
    def static_safety_factors(self: "Self") -> "_2153.StaticSafetyFactors":
    ...
    @property
    def viscosities(self: "Self") -> "_2154.Viscosities":
