...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2059, _2088
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedCrossedRollerBearingRow(_2084.LoadedRollerBearingRow):
    """LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self: "Self") -> "_2059.LoadedCrossedRollerBearingResults":
