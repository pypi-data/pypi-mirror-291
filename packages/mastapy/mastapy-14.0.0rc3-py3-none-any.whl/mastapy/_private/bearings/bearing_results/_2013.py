...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.property import _1891, _1894, _1892, _1893
...
class _Cast_LoadedRollingBearingDutyCycle:
    ...
    def loaded_axial_thrust_cylindrical_roller_bearing_duty_cycle(
        self: "CastSelf",
    ) -> "_2046.LoadedAxialThrustCylindricalRollerBearingDutyCycle":
    ...
    def loaded_ball_bearing_duty_cycle(
        self: "CastSelf",
    ) -> "_2053.LoadedBallBearingDutyCycle":
        from mastapy._private.bearings.bearing_results.rolling import _2053

        return self.__parent__._cast(_2053.LoadedBallBearingDutyCycle)

    @property
    def loaded_cylindrical_roller_bearing_duty_cycle(
        self: "CastSelf",
    ) -> "_2061.LoadedCylindricalRollerBearingDutyCycle":
        from mastapy._private.bearings.bearing_results.rolling import _2061

        return self.__parent__._cast(_2061.LoadedCylindricalRollerBearingDutyCycle)
    ...
    def loaded_taper_roller_bearing_duty_cycle(
        self: "CastSelf",
    ) -> "_2100.LoadedTaperRollerBearingDutyCycle":
        from mastapy._private.bearings.bearing_results.rolling import _2100

        return self.__parent__._cast(_2100.LoadedTaperRollerBearingDutyCycle)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedRollingBearingDutyCycle(_2010.LoadedNonLinearBearingDutyCycleResults):
    """LoadedRollingBearingDutyCycle
    ...
    def ansiabma_dynamic_equivalent_load_summary(
        self: "Self",
    ) -> "_1891.DutyCyclePropertySummaryForce[_1928.BearingLoadCaseResultsLightweight]":
    ...
    def maximum_element_normal_stress_inner_summary(
        ...
        "_1894.DutyCyclePropertySummaryStress[_1928.BearingLoadCaseResultsLightweight]"
    ):
    ...
    def maximum_static_contact_stress_duty_cycle(
        self: "Self",
    ) -> "_2115.MaximumStaticContactStressDutyCycle":
    ...
    def maximum_truncation_summary(
        self: "Self",
    ) -> "_1892.DutyCyclePropertySummaryPercentage[_1928.BearingLoadCaseResultsLightweight]":
    ...
    def misalignment_summary(
        self: "Self",
    ) -> "_1893.DutyCyclePropertySummarySmallAngle[_1928.BearingLoadCaseResultsLightweight]":
