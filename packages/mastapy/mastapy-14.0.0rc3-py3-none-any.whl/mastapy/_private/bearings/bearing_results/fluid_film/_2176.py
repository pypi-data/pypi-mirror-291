...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.fluid_film import _2177, _2174, _2178
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedPlainJournalBearingResults(_2173.LoadedFluidFilmBearingResults):
    """LoadedPlainJournalBearingResults
    ...
    def journal_bearing_rows(
        self: "Self",
    ) -> "List[_2177.LoadedPlainJournalBearingRow]":
