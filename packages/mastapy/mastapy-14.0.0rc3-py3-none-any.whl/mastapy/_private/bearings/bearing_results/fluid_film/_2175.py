...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.fluid_film import _2181, _2182
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class LoadedPadFluidFilmBearingResults(_2173.LoadedFluidFilmBearingResults):
    """LoadedPadFluidFilmBearingResults
