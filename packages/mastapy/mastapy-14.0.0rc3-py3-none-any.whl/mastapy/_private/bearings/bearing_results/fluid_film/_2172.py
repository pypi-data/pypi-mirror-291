...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.fluid_film import _2180, _2183
...
class _Cast_LoadedFluidFilmBearingPad:
    ...
    @property
    def loaded_tilting_journal_pad(self: "CastSelf") -> "_2180.LoadedTiltingJournalPad":
        from mastapy._private.bearings.bearing_results.fluid_film import _2180

        return self.__parent__._cast(_2180.LoadedTiltingJournalPad)

    @property
    def loaded_tilting_thrust_pad(self: "CastSelf") -> "_2183.LoadedTiltingThrustPad":
        from mastapy._private.bearings.bearing_results.fluid_film import _2183

        return self.__parent__._cast(_2183.LoadedTiltingThrustPad)
