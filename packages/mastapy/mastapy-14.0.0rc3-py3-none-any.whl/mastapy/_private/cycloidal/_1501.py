...
if TYPE_CHECKING:
    ...
    from mastapy._private.cycloidal import _1510, _1509, _1502
...
class CycloidalAssemblyDesign(_0.APIBase):
    ...
    @property
    def ring_pins(self: "Self") -> "_1510.RingPinsDesign":
    ...
    @property
    def disc_phases(self: "Self") -> "List[_1509.NamedDiscPhase]":
    ...
    @property
    def discs(self: "Self") -> "List[_1502.CycloidalDiscDesign]":
