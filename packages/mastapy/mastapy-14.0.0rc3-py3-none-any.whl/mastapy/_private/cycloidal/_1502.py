...
if TYPE_CHECKING:
    ...
    from mastapy._private.cycloidal import _1503, _1506
...
class CycloidalDiscDesign(_0.APIBase):
    ...
    @property
    def crowning_chart(self: "Self") -> "_1920.TwoDChartDefinition":
    ...
    @property
    def exporter(self: "Self") -> "_1503.CycloidalDiscDesignExporter":
    ...
    def modifications_specification(
        self: "Self",
    ) -> "_1506.CycloidalDiscModificationsSpecification":
