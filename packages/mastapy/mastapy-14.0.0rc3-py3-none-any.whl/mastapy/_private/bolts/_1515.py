...
if TYPE_CHECKING:
    ...
    from mastapy._private.bolts import _1514, _1519, _1524
    from mastapy._private.utility.databases import _1884, _1877
...
T = TypeVar("T", bound="_1514.BoltedJointMaterial")
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltedJointMaterialDatabase(_1881.NamedDatabase[T]):
    """BoltedJointMaterialDatabase
