...
def _init_runtime_setup(
    path_to_dll_folder: str,
    core_version: str = "net6.0",
    ...
    if python_version in SpecifierSet(">=3.9"):
        ...
        python_runtime_path = os.path.join(lib_folder, python_runtime_dll)
...
@functools.lru_cache(maxsize=None)
def _is_dotnet_core(path_to_dll_folder: str) -> bool:
    path_to_deps = os.path.join(path_to_dll_folder, "SMT.Utility.deps.json")
