...
class EnumWithSelectedValue_LoadedBallElementPropertyType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LoadedBallElementPropertyType]",
    ) -> "_2016.LoadedBallElementPropertyType":
        ...
        Returns:
            _2016.LoadedBallElementPropertyType
        """
        return _2016.LoadedBallElementPropertyType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2016.LoadedBallElementPropertyType.type_()

    @property
    def selected_value(self: "Self") -> "_2016.LoadedBallElementPropertyType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2016.LoadedBallElementPropertyType]":
