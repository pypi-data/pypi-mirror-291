...
from mastapy._private.utility.model_validation import _1843
...
class EnumWithSelectedValue_Severity(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[EnumWithSelectedValue_Severity]") -> "_1843.Severity":
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_Severity]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1843.Severity.type_()

    @property
    def selected_value(self: "Self") -> "_1843.Severity":
    ...
    @property
    def available_values(self: "Self") -> "List[_1843.Severity]":
