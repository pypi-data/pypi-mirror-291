...
class EnumWithSelectedValue_BearingToleranceDefinitionOptions(
    ...
    def wrapped_type(
        ...
        Returns:
            _1957.BearingToleranceDefinitionOptions
        """
        return _1957.BearingToleranceDefinitionOptions
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1957.BearingToleranceDefinitionOptions.type_()

    @property
    def selected_value(self: "Self") -> "_1957.BearingToleranceDefinitionOptions":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1957.BearingToleranceDefinitionOptions]":
