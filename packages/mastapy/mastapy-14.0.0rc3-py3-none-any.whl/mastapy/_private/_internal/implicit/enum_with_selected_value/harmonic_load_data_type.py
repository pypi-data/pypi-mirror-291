...
class EnumWithSelectedValue_HarmonicLoadDataType(
    ...
    def wrapped_type(
        ...
        Returns:
            _1430.HarmonicLoadDataType
        """
        return _1430.HarmonicLoadDataType
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_HarmonicLoadDataType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1430.HarmonicLoadDataType.type_()

    @property
    def selected_value(self: "Self") -> "_1430.HarmonicLoadDataType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1430.HarmonicLoadDataType]":
