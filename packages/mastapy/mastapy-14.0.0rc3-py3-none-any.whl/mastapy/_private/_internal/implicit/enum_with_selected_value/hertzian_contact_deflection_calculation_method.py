...
class EnumWithSelectedValue_HertzianContactDeflectionCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_HertzianContactDeflectionCalculationMethod]",
    ) -> "_1622.HertzianContactDeflectionCalculationMethod":
        ...
        Returns:
            _1622.HertzianContactDeflectionCalculationMethod
        """
        return _1622.HertzianContactDeflectionCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1622.HertzianContactDeflectionCalculationMethod.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1622.HertzianContactDeflectionCalculationMethod]":
