...
class EnumWithSelectedValue_RollingBearingRaceType(
    ...
    def wrapped_type(
        ...
        Returns:
            _1948.RollingBearingRaceType
        """
        return _1948.RollingBearingRaceType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1948.RollingBearingRaceType.type_()

    @property
    def selected_value(self: "Self") -> "_1948.RollingBearingRaceType":
    ...
    @property
    def available_values(self: "Self") -> "List[_1948.RollingBearingRaceType]":
