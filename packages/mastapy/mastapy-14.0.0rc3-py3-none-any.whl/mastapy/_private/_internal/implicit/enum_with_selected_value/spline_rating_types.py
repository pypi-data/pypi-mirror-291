...
class EnumWithSelectedValue_SplineRatingTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1465.SplineRatingTypes
        """
        return _1465.SplineRatingTypes
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_SplineRatingTypes]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1465.SplineRatingTypes.type_()

    @property
    def selected_value(self: "Self") -> "_1465.SplineRatingTypes":
    ...
    @property
    def available_values(self: "Self") -> "List[_1465.SplineRatingTypes]":
