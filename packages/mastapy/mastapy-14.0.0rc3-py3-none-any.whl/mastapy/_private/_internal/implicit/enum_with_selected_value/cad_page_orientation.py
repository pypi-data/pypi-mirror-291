...
class EnumWithSelectedValue_CadPageOrientation(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1796.CadPageOrientation
        """
        return _1796.CadPageOrientation
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_CadPageOrientation]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1796.CadPageOrientation.type_()

    @property
    def selected_value(self: "Self") -> "_1796.CadPageOrientation":
    ...
    @property
    def available_values(self: "Self") -> "List[_1796.CadPageOrientation]":
