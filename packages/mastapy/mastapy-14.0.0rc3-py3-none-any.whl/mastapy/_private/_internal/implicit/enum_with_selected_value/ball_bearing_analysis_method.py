...
from mastapy._private.bearings.bearing_results.rolling import _2020
...
class EnumWithSelectedValue_BallBearingAnalysisMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BallBearingAnalysisMethod]",
    ) -> "_2020.BallBearingAnalysisMethod":
        ...
        Returns:
            _2020.BallBearingAnalysisMethod
        """
        return _2020.BallBearingAnalysisMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2020.BallBearingAnalysisMethod.type_()

    @property
    def selected_value(self: "Self") -> "_2020.BallBearingAnalysisMethod":
    ...
    @property
    def available_values(self: "Self") -> "List[_2020.BallBearingAnalysisMethod]":
