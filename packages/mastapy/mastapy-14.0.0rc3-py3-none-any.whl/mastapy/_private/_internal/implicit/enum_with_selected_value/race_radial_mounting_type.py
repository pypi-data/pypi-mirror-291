...
class EnumWithSelectedValue_RaceRadialMountingType(
    ...
    def wrapped_type(
        ...
        Returns:
            _2018.RaceRadialMountingType
        """
        return _2018.RaceRadialMountingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2018.RaceRadialMountingType.type_()

    @property
    def selected_value(self: "Self") -> "_2018.RaceRadialMountingType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2018.RaceRadialMountingType]":
