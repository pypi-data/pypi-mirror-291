...
class EnumWithSelectedValue_FatigueLoadLimitCalculationMethodEnum(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_FatigueLoadLimitCalculationMethodEnum]",
    ) -> "_2206.FatigueLoadLimitCalculationMethodEnum":
        ...
        Returns:
            _2206.FatigueLoadLimitCalculationMethodEnum
        """
        return _2206.FatigueLoadLimitCalculationMethodEnum
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2206.FatigueLoadLimitCalculationMethodEnum.type_()

    @property
    def selected_value(self: "Self") -> "_2206.FatigueLoadLimitCalculationMethodEnum":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2206.FatigueLoadLimitCalculationMethodEnum]":
