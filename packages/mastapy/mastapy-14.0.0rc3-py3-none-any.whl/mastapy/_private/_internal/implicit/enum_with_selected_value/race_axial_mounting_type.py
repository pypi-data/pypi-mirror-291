...
class EnumWithSelectedValue_RaceAxialMountingType(
    ...
    def wrapped_type(
        ...
        Returns:
            _2017.RaceAxialMountingType
        """
        return _2017.RaceAxialMountingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2017.RaceAxialMountingType.type_()

    @property
    def selected_value(self: "Self") -> "_2017.RaceAxialMountingType":
    ...
    @property
    def available_values(self: "Self") -> "List[_2017.RaceAxialMountingType]":
