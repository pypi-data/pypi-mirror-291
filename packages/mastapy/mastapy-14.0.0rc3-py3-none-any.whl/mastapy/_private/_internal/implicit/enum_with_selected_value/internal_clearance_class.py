...
from mastapy._private.bearings.tolerances import _1955
...
class EnumWithSelectedValue_InternalClearanceClass(
    ...
    def wrapped_type(
        ...
        Returns:
            _1955.InternalClearanceClass
        """
        return _1955.InternalClearanceClass
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1955.InternalClearanceClass.type_()

    @property
    def selected_value(self: "Self") -> "_1955.InternalClearanceClass":
    ...
    @property
    def available_values(self: "Self") -> "List[_1955.InternalClearanceClass]":
