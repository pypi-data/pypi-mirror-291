...
class Overridable_CylindricalRollerMaxAxialLoadMethod(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1996.CylindricalRollerMaxAxialLoadMethod
        """
        return _1996.CylindricalRollerMaxAxialLoadMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1996.CylindricalRollerMaxAxialLoadMethod.type_()

    @property
    def value(self: "Self") -> "_1996.CylindricalRollerMaxAxialLoadMethod":
    ...
    @property
    def override_value(self: "Self") -> "_1996.CylindricalRollerMaxAxialLoadMethod":
        """mastapy.bearings.bearing_results.CylindricalRollerMaxAxialLoadMethod
    ...
    @property
    def calculated_value(self: "Self") -> "_1996.CylindricalRollerMaxAxialLoadMethod":
        """mastapy.bearings.bearing_results.CylindricalRollerMaxAxialLoadMethod
