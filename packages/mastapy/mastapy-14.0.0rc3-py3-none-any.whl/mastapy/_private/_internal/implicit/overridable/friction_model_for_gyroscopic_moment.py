...
class Overridable_FrictionModelForGyroscopicMoment(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        cls: "Type[Overridable_FrictionModelForGyroscopicMoment]",
    ) -> "_2026.FrictionModelForGyroscopicMoment":
        ...
        Returns:
            _2026.FrictionModelForGyroscopicMoment
        """
        return _2026.FrictionModelForGyroscopicMoment
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2026.FrictionModelForGyroscopicMoment.type_()

    @property
    def value(self: "Self") -> "_2026.FrictionModelForGyroscopicMoment":
    ...
    @property
    def override_value(self: "Self") -> "_2026.FrictionModelForGyroscopicMoment":
        """mastapy.bearings.bearing_results.rolling.FrictionModelForGyroscopicMoment
    ...
    @property
    def calculated_value(self: "Self") -> "_2026.FrictionModelForGyroscopicMoment":
        """mastapy.bearings.bearing_results.rolling.FrictionModelForGyroscopicMoment
