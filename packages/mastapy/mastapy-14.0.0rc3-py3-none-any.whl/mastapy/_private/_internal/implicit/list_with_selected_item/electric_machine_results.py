...
class ListWithSelectedItem_ElectricMachineResults(
    _1374.ElectricMachineResults, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1374.ElectricMachineResults.TYPE

    @property
    def selected_value(self: "Self") -> "_1374.ElectricMachineResults":
    ...
    @property
    def available_values(self: "Self") -> "List[_1374.ElectricMachineResults]":
