...
class saveAcountKeys:
  ...
  def __init__(self,txnData):
    ...
    self.accountKeys = get_writable_addresses(txnData)+self.get_all_addresses()+get_read_only_addresses(txnData)
    
  def get_all_addresses(self,txnData=None):
    txnData = txnData or self.txnData
    return get_writable_addresses(txnData)+self.get_all_addresses()+get_sorted_addresses(txnData)+get_read_only_addresses(txnData)
