...
class Slider_quad(ft.Container):
    def __init__(self, 
        ...
        self.min = min
        self.max = max
        self.border = ft.border.only(ft.BorderSide(0.3,'white,0.5'),ft.BorderSide(0.3,'white,0.5'),ft.BorderSide(1,'white,0.5'),ft.BorderSide(1,'white,0.5'))
    ...
    def on_pan_update(self, e: ft.DragUpdateEvent):
        ...
        e.control.content.content.value = round(y,2)
        # e.control.update()
        self.Atualizar()
    def Voltar(self,e):
