...
from ri.apiclient.models.generative_testing_config import GenerativeTestingConfig
...
class GenerativeValidationTestRun(BaseModel):
    ...
    """ # noqa: E501
    config: Optional[GenerativeTestingConfig] = None
    id: Optional[ID] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": GenerativeTestingConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
