...
from ri.apiclient.models.generative_testing_result import GenerativeTestingResult
...
class GetResultsResponse(BaseModel):
    ...
    results: Optional[List[GenerativeTestingResult]] = Field(default=None, description="The list of generative testing results.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [GenerativeTestingResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
