...
class FaceTracker(Tracker):
    ...
    def scatter_draw_instructions(self, point_id: int) -> dict:
        ...
        if POINT_ID2NAME[point_id] in ('rightEyeUpper0', 'rightEyeLower0', 'rightEyeUpper1', 'rightEyeLower1', 'rightEyeUpper2', 'rightEyeLower2', 'rightEyeLower3', 'rightEyeIris'):
        ...
        if POINT_ID2NAME[point_id] in ('leftEyeUpper0', 'leftEyeLower0', 'leftEyeUpper1', 'leftEyeLower1', 'leftEyeUpper2', 'leftEyeLower2', 'leftEyeLower3', 'leftEyeIris'):
        ...
        if POINT_ID2NAME[point_id] == 'midwayBetweenEyes':
            rules = {"radius": 5, "color": (0, 0, 0), "thickness": 3}
        if POINT_ID2NAME[point_id] == ('noseTip', 'noseBottom', 'noseRightCorner', 'noseLeftCorner', 'leftCheek', 'rightCheek'):
