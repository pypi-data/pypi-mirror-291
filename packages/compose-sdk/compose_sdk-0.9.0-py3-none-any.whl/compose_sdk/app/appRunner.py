...
from ..core import Utils, EventType, Render, Components, INTERACTION_TYPE, TYPE, JSON
...
class Page:
    ...
    def download(self, file: bytes, filename: str):
        return self.appRunner.scheduler.create_task(
            self.appRunner.download(file, filename)
        )
