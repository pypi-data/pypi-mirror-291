...
class PlanqkQuantumProvider:
    ...
    def get_backend(self, backend_id, **kwargs):
    ...
    def _get_backend_object(self, backend_dto, backend_init_params):
        if backend_dto.provider == PROVIDER.AWS:
            if backend_dto.id == "aws.quera.aquila":
                from planqk.aws.quera_backend import PlanqkQueraAquilaBackend
                return PlanqkQueraAquilaBackend(planqk_client=self._client, **backend_init_params)
