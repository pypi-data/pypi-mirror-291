...
class StreamDerivativesInstrumentMetricsV1Stub(object):
...
class StreamDerivativesInstrumentMetricsV1Servicer(object):
    """Service for streaming derivatives instrument metrics V1
    """
...
def add_StreamDerivativesInstrumentMetricsV1Servicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Subscribe': grpc.unary_stream_rpc_method_handler(
                    servicer.Subscribe,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'kaikosdk.StreamDerivativesInstrumentMetricsV1', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class StreamDerivativesInstrumentMetricsV1(object):
    """Service for streaming derivatives instrument metrics V1
    """
    ...
    def Subscribe(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/kaikosdk.StreamDerivativesInstrumentMetricsV1/Subscribe',
