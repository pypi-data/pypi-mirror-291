...
The Glaider project adheres to a code of conduct that you can read at [Code of Conduct](LINK_TO_CODE_OF_CONDUCT).
...
2. **Clone Your Fork**:
```bash
git clone https://github.com/glaider/glaider-fuzz.git
cd glaider-fuzz
```
...
The easist way to contribute to glaider-fuzz project is by creating a new test! You can see an example PR of a test here: [Contribute new test - base64_injection!](https://github.com/glaider/glaider-fuzz/pull/19)
