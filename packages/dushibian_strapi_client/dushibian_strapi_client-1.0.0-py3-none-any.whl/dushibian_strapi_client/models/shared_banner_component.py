...
class SharedBannerComponent(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "description", "image", "link_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SharedBannerComponent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SharedBannerComponent from a dict"""
        if obj is None:
            return None
