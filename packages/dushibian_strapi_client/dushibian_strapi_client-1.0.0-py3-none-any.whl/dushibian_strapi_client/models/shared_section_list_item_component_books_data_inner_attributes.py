...
class SharedSectionListItemComponentBooksDataInnerAttributes(BaseModel):
    """
    SharedSectionListItemComponentBooksDataInnerAttributes
    """ # noqa: E501
    ...
    tags: Optional[SharedSectionListItemComponentBooksDataInnerAttributesTags] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SharedSectionListItemComponentBooksDataInnerAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SharedSectionListItemComponentBooksDataInnerAttributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "isbn": obj.get("isbn"),
            "tags": SharedSectionListItemComponentBooksDataInnerAttributesTags.from_dict(obj["tags"]) if obj.get("tags") is not None else None,
