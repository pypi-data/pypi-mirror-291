...
class ArticleTagsDataInnerAttributes(BaseModel):
    """
    ArticleTagsDataInnerAttributes
    """ # noqa: E501
    ...
    books: Optional[ArticleTagsDataInnerAttributesBooks] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ArticleTagsDataInnerAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ArticleTagsDataInnerAttributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "level": obj.get("level"),
            "books": ArticleTagsDataInnerAttributesBooks.from_dict(obj["books"]) if obj.get("books") is not None else None,
