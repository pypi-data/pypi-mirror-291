...
class SharedSectionListItemComponentBooksDataInnerAttributesTagsDataInnerAttributesPeopleDataInnerAttributes(BaseModel):
    """
    SharedSectionListItemComponentBooksDataInnerAttributesTagsDataInnerAttributesPeopleDataInnerAttributes
    """ # noqa: E501
    ...
    recommends: Optional[SharedSectionListItemComponentBooksDataInnerAttributesTagsDataInnerAttributesPeopleDataInnerAttributesRecommends] = None
    title: Optional[StrictStr] = None
    social: Optional[List[SharedSectionListItemComponentBooksDataInnerAttributesTagsDataInnerAttributesPeopleDataInnerAttributesRecommendsDataInnerAttributesSource]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SharedSectionListItemComponentBooksDataInnerAttributesTagsDataInnerAttributesPeopleDataInnerAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SharedSectionListItemComponentBooksDataInnerAttributesTagsDataInnerAttributesPeopleDataInnerAttributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "recommends": SharedSectionListItemComponentBooksDataInnerAttributesTagsDataInnerAttributesPeopleDataInnerAttributesRecommends.from_dict(obj["recommends"]) if obj.get("recommends") is not None else None,
            "title": obj.get("title"),
            "social": [SharedSectionListItemComponentBooksDataInnerAttributesTagsDataInnerAttributesPeopleDataInnerAttributesRecommendsDataInnerAttributesSource.from_dict(_item) for _item in obj["social"]] if obj.get("social") is not None else None,
