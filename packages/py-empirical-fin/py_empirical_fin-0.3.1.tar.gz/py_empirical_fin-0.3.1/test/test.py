...
results.summary(rf_df=rf_df, rf="rf", show_t=True, show_stars=True, layout="default", raw_ret=False,
               alpha_models=[ff3], output_path="Single_out_true_strategy_excess_alpha.docx")
...
# result.summary(rf_df=rf_df, rf="rf", raw_ret=True,
#                alpha_models=[ff3], output_path="Double_out_raw_ret_true_strategy.docx")