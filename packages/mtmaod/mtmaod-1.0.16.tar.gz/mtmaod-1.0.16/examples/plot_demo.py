...
from mtmaod.chart import create_figure_and_plot_density_kernel_chart, example_config
...
if __name__ == "__main__":
    ...
    # new style
    create_figure_and_plot_density_kernel_chart(x=x, y=y, save_path="demo_kernels.png", **example_config)
