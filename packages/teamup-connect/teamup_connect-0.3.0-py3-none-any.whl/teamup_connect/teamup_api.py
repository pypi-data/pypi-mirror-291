...
class TeamUP:
    ...
    def create_subcalendar(self, calendar_key_or_id: str, sub_calendar_name: str) -> dict:
        """Creates a subcalendar under the specified calendar.

        Returns: response in the general formal of a dictionary.
            Ex. { "subcalendar": {"id": "string", "name": "string", ...} }
        """
        subcalendar = {
            "name": sub_calendar_name,
            "active": True,
            "color": 17,
            "overlap": True,
            "type": 0,
            "remote_id": sub_calendar_name,
            "feed_url": "https://example.com/calendar.ics",
            "polling_interval": 120,
        }
        subcalendar = self.post(f"{calendar_key_or_id}/subcalendars", data=subcalendar)[
            "subcalendar"
        ]
        return subcalendar
