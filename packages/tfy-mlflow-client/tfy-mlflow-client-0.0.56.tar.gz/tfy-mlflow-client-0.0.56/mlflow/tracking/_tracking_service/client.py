...
TrackingStore = typing.TypeVar("TrackingStore", bound=RestStore)
...
class TrackingServiceClient:
    ...
    def delete_dataset_by_id(self, dataset_id: uuid.UUID, delete_contents: bool = False):
        return self.store.delete_dataset(dataset_id=dataset_id, delete_contents=delete_contents)
