...
class MapQuestionTypeToQuestion:
    ...
    def __init__(self, type_of_questions:Dict[str,str], service = "default"):
        ...
        if self.service == "default":
            self.llm = MiniMaxPro(bot_name="question generation assistant", bot_content="You are given a list of interests and a passage. Your task is to generate questions that align with the interests and the passage. Reflective Thinking: Before you generate the final list of questions, pause to examine your assumptions, biases, and the mental models that the interests might use. Consider how the interests influence what they find interesting, and how they prioritize topics. Be open to learning from previous similar tasks and improving the outcome. Explicitly share your reflective thought process before giving the final answer.")
                ...
                if q_type.lower() in self.type_of_questions:
                    if self.service == "default":
                        ...
                        try:
                            ...
                            print(f"MapQuestionTypeToQuestion json decode error:{e}")
