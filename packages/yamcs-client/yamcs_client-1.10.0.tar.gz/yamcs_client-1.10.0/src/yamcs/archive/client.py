...
class ArchiveClient:
    ...
    def set_command_history_attribute(
        self,
        command: str,
        attribute: str,
        value: Any,
        ...
        """
        Set the value of a command history attribute.
        ...
        :param value:
            The value to set.
        """
        self.set_command_history_attributes(command, attributes={attribute: value})

    def set_command_history_attributes(
        self,
        command: str,
        attributes: Mapping[str, Any],
    ):
        """
        Set command history attributes.
