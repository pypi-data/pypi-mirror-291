...
class S3(Database):
    ...
    async def elevate_privileges(self, request: web.Request, credentials: AWSCredentials, lifespan: int = 30) -> AWSCredentials:
        """
        ...
        :param lifespan: the length of privilege elevation in seconds. The default value is 30.
        ...
        admin_cred = await self.generate_cloud_credentials(request, admin_role, sub)
        assert admin_cred is not None, f'Could not generate cloud credentials with role {admin_role}'
