...
from robust_extraction2 import DEFAULT_PADS, Img, ExtendedModel, Corners, \
...
@E.do[IntersectError]()
def autocorrect(img: Img, model: ExtendedModel, *, descale_h = 1920, **params: Unpack[Params]) -> tuple[Img, Corners]:
  corners = descaled_detect_corners(img, model, descale_h=descale_h, **params).unsafe()
  return pve.correct(img, corners, **params.get('correction_pads', DEFAULT_PADS)), corners