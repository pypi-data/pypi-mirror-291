...
from robust_extraction2 import Contours, ExtendedModel, \
...
def extract_contours(img: vc.Img, model: ExtendedModel, **params: Unpack[Params]) -> Contours:
...
@E.do[ExtractionError]()
def autoextract(img: vc.Img, model: ExtendedModel, *, descale_h: int = 1920, **params: Unpack[Params]) -> Contours:
