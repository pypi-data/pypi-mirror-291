...
from robust_extraction2 import Segments, lines as ls, contours as cs, ExtendedModel
from .params import Params, RequiredParams, DEFAULT_PARAMS

def cropped_lines(img: vc.Img, *, pad_v: float, pad_h: float):
  lns = ls.find(img)
...
def head(img: vc.Img, model: ExtendedModel, **params: Unpack[Params]):
