...
@E.do[IntersectError]()
def descaled_detect_corners(img: vc.Img, model: ExtendedModel, *, descale_h = 1920, **params: Unpack[pipe.Params]) -> vc.Corners:
...
@E.do[IntersectError]()
def autocorrect(img: vc.Img, model: ExtendedModel, *, descale_h = 1920, **params: Unpack[Params]) -> tuple[vc.Img, vc.Corners]:
  ...
  corners = vc.corners.pad(raw_corners, padx=px, pady=py)
  return vc.corners.correct(img, corners), corners