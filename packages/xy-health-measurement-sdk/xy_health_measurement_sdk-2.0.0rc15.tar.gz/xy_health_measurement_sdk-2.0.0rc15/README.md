...
# build docker image
docker build --build-arg ACCELERATE_CONFIG='--trusted-host 127.0.0.1 -i http://127.0.0.1:8081/repository/xy-pypi/simple' -t xiaoyangtech/measurement-python-client-sdk:2.0.0rc14 .
docker build --build-arg ACCELERATE_CONFIG='--trusted-host 127.0.0.1 -i http://127.0.0.1:8081/repository/xy-pypi/simple' -t registry.cn-shanghai.aliyuncs.com/measurement/python-client-sdk:2.0.0rc14 .
```