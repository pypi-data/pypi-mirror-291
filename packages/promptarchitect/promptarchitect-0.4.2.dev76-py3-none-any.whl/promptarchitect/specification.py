...
from typing import Annotated, Literal, Optional, Dict, Union
import frontmatter
...
class EngineeredPromptMetadata(BaseModel):
    ...
    system_role: str = "You are a useful assistant."
...
class InputSample(BaseModel):
    ...
    @staticmethod
    def from_file(input_file: str) -> "InputSample":
        """
        ...
        return InputSample(input=input_data.content, **input_data.metadata)
