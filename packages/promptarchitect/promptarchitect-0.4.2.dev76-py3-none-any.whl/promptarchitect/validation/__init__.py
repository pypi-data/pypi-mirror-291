...
from promptarchitect.specification import EngineeredPromptSpecification, InputSample
...
def discover_input_samples(
    ...
    """
    sample_files = [
        f for f in os.listdir(prompt_spec.metadata.test_path) if f.endswith(".md")
    ]

    input_samples = [
        InputSample.from_file(os.path.join(prompt_spec.metadata.test_path, f))
...
def discover_test_cases(
    ...
    prompt_files = [f for f in os.listdir(path) if f.endswith(".prompt")]
