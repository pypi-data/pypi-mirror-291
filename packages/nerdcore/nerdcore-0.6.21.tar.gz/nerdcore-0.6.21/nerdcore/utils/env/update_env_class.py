...
def update_env_class():
    ...
    # Get the .env.default file variables (nerdcore env props)
    framework_env_vars = dotenv_values(NC_ENV_DEFAULT_PATH)
    ...
    # Get nerdcore environment variables and generate corresponding class definitions
