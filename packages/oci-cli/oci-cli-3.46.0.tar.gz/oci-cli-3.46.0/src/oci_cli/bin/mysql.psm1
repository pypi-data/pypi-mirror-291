...
function GetOciCommandsToLongParams_mysql() {
    $ociCommandsToLongParams = @{
        ...
        'mysql db-system clone' = 'admin-password admin-username availability-domain backup-policy compartment-id configuration-id crash-recovery data-storage data-storage-size-in-gbs database-management defined-tags deletion-policy description display-name fault-domain freeform-tags from-json help hostname-label ip-address is-highly-available maintenance max-wait-seconds mysql-version port port-x secure-connections shape-name source-backup-id subnet-id wait-for-state wait-interval-seconds'
        'mysql db-system create' = 'admin-password admin-username availability-domain backup-policy compartment-id configuration-id crash-recovery data-storage data-storage-size-in-gbs database-management defined-tags deletion-policy description display-name fault-domain freeform-tags from-json help hostname-label ip-address is-highly-available maintenance max-wait-seconds mysql-version port port-x secure-connections shape-name source subnet-id wait-for-state wait-interval-seconds'
        ...
        'mysql db-system import' = 'admin-password admin-username availability-domain backup-policy compartment-id configuration-id crash-recovery data-storage data-storage-size-in-gbs database-management defined-tags deletion-policy description display-name fault-domain freeform-tags from-json help hostname-label ip-address is-highly-available maintenance max-wait-seconds mysql-version port port-x secure-connections shape-name source-url subnet-id wait-for-state wait-interval-seconds'
