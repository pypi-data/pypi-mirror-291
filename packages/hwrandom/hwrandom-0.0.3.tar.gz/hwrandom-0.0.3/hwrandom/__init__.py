...
if system == "Windows":
    if arch == "32bit":
        lib_path = os.path.abspath(r"./rdrand32.dll")
        c_uint_type = ctypes.c_uint32
    else:
        lib_path = os.path.abspath(r"./rdrand64.dll")
        c_uint_type = ctypes.c_uint64
elif system == "Linux":
    if arch == "32bit":
        lib_path = os.path.abspath(r"./librdrand.so")
        c_uint_type = ctypes.c_uint32
    else:
        lib_path = os.path.abspath(r"./librdrand64.so")
        c_uint_type = ctypes.c_uint64
else:
