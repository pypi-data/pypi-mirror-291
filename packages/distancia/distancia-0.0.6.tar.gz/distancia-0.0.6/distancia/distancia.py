...
class Distance(ABC):
	...
	#def distance(self, obj1, obj2):
		...
		"""
		if len(args)==2:
			return self.calculate_function(args[0], args[1])
		if len(args)==3:
			return self.calculate_function(args[0], args[1], args[2])
		if len(args)==4:
			return self.calculate_function(args[0], args[1], args[2], args[3])
