...
class UniversalOptionSnapshot:
    def __init__(self, results):
        ...
        price_change = self.df['underlying_price'].pct_change()

        # Calculate momentum-adjusted Greeks
        self.df['momentum_delta'] = self.df['delta'] * price_change
        self.df['momentum_gamma'] = self.df['gamma'] * price_change
        self.df['momentum_vega'] = self.df['vega'] * price_change
        self.df['momentum_theta'] = self.df['theta'] * price_change
        self.df['momentum_vanna'] = self.df['vanna'] * price_change
        self.df['momentum_charm'] = self.df['charm'] * price_change
        self.df['momentum_veta'] = self.df['veta'] * price_change
        self.df['momentum_speed'] = self.df['speed'] * price_change
        self.df['momentum_zomma'] = self.df['zomma'] * price_change
        self.df['momentum_color'] = self.df['color'] * price_change
        self.df['momentum_ultima'] = self.df['ultima'] * price_change
