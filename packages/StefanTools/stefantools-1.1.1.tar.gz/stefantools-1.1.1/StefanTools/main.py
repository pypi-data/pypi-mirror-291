...
"i guess i would","i think i should","yes indeed","i guess i should","why not"]
    ...
    @staticmethod
    def negative()->list:
        return ["n","no","false","i wouldn't","no way","not at all","nope","no thanks","i don't","i guess not","no i don't",\
"ofc not"]

    @staticmethod
    def exit()->list:
        return ["exit","exit program","quit","quit program","leave","leave program","abort","abort program","home"]
