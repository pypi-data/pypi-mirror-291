...
# Static methods
    ...
    def GetAll(model, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then an array of Segment objects is returned.
        If the property argument is given, that property value for each segment is returned in the array
