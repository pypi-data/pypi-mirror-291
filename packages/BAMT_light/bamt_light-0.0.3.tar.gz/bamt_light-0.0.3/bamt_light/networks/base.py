...
from typing import Dict, List, Optional, Type, Union, Any, Sequence
...
import bamt_light.builders as builders
from bamt_light.display import get_info_
from bamt_light.external.pyitlib.DiscreteRandomVariableUtils import (
    entropy,
    information_mutual,
    information_mutual_conditional,
    entropy_conditional,
)
from bamt_light.log import logger_network
from bamt_light.nodes.base import BaseNode
...
class BaseNetwork(object):
    ...
    def calculate_weights(self, discretized_data: pd.DataFrame):
        ...
        """
        import bamt_light.utils.GraphUtils as gru
