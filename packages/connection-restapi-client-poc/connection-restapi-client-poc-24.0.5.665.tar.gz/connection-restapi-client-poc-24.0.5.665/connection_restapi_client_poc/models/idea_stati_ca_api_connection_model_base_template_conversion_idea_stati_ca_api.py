...
class IdeaStatiCaApiConnectionModelBaseTemplateConversionIdeaStatiCaApi(BaseModel):
    """
    ...
    new_element: Optional[IdeaStatiCaApiConnectionModelSelectedElementIdeaStatiCaApi] = Field(default=None, alias="newElement")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "newElement": IdeaStatiCaApiConnectionModelSelectedElementIdeaStatiCaApi.from_dict(obj["newElement"]) if obj.get("newElement") is not None else None
        })
        return _obj
