...
class IdeaStatiCaApiConnectionModelConLoadEffectIdeaStatiCaApi(BaseModel):
    """
    ...
    member_loadings: Optional[List[IdeaStatiCaApiConnectionModelConLoadEffectMemberLoadIdeaStatiCaApi]] = Field(default=None, alias="memberLoadings")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "memberLoadings": [IdeaStatiCaApiConnectionModelConLoadEffectMemberLoadIdeaStatiCaApi.from_dict(_item) for _item in obj["memberLoadings"]] if obj.get("memberLoadings") is not None else None,
            "id": obj.get("id"),
            "name": obj.get("name"),
