...
class IdeaStatiCaApiConnectionModelConConnectionIdeaStatiCaApi(BaseModel):
    """
    ...
    analysis_type: Optional[IdeaStatiCaApiConnectionModelConAnalysisTypeEnumIdeaStatiCaApi] = Field(default=None, alias="analysisType")
    load_options: Optional[IdeaStatiCaApiConnectionModelConLoadingOptionsIdeaStatiCaApi] = Field(default=None, alias="loadOptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "loadOptions": IdeaStatiCaApiConnectionModelConLoadingOptionsIdeaStatiCaApi.from_dict(obj["loadOptions"]) if obj.get("loadOptions") is not None else None,
