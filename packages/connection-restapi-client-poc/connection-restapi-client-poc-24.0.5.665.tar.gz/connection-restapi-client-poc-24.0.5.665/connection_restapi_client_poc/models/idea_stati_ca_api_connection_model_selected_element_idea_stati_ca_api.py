...
class IdeaStatiCaApiConnectionModelSelectedElementIdeaStatiCaApi(BaseModel):
    """
    ...
    container_type: Optional[IdeaStatiCaApiConnectionModelTableContainerTypeIdeaStatiCaApi] = Field(default=None, alias="containerType")
