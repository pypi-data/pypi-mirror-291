...
class IdeaStatiCaApiConnectionModelTemplateConversionsIdeaStatiCaApi(BaseModel):
    """
    IdeaStatiCaApiConnectionModelTemplateConversionsIdeaStatiCaApi
    """ # noqa: E501
    conversions: Optional[List[IdeaStatiCaApiConnectionModelBaseTemplateConversionIdeaStatiCaApi]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conversions": [IdeaStatiCaApiConnectionModelBaseTemplateConversionIdeaStatiCaApi.from_dict(_item) for _item in obj["conversions"]] if obj.get("conversions") is not None else None,
