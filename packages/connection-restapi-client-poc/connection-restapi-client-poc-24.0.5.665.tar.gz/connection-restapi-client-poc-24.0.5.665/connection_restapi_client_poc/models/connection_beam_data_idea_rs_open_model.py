...
class ConnectionBeamDataIdeaRSOpenModel(BaseModel):
    ...
    plates: Optional[List[ConnectionPlateDataIdeaRSOpenModel]] = Field(default=None, description="Plates of the beam")
    ...
    cuts: Optional[List[ConnectionCutDataIdeaRSOpenModel]] = Field(default=None, description="Cuts on the beam")
