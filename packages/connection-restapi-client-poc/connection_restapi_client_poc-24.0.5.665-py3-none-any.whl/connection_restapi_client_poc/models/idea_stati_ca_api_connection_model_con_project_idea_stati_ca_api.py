...
class IdeaStatiCaApiConnectionModelConProjectIdeaStatiCaApi(BaseModel):
    """
    IdeaStatiCaApiConnectionModelConProjectIdeaStatiCaApi
    """ # noqa: E501
    project_id: Optional[StrictStr] = Field(default=None, alias="projectId")
    project_info: Optional[IdeaStatiCaApiConnectionModelConProjectDataIdeaStatiCaApi] = Field(default=None, alias="projectInfo")
    connections: Optional[List[IdeaStatiCaApiConnectionModelConConnectionIdeaStatiCaApi]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "projectInfo": IdeaStatiCaApiConnectionModelConProjectDataIdeaStatiCaApi.from_dict(obj["projectInfo"]) if obj.get("projectInfo") is not None else None,
            "connections": [IdeaStatiCaApiConnectionModelConConnectionIdeaStatiCaApi.from_dict(_item) for _item in obj["connections"]] if obj.get("connections") is not None else None
        })
        return _obj
