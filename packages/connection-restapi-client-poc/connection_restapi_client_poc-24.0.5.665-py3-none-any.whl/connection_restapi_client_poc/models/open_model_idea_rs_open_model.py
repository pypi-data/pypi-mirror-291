...
class OpenModelIdeaRSOpenModel(BaseModel):
    ...
    point3_d: Optional[List[Geometry3DPoint3DIdeaRSOpenModel]] = Field(default=None, description="List of Point3D", alias="point3D")
    line_segment3_d: Optional[List[Geometry3DLineSegment3DIdeaRSOpenModel]] = Field(default=None, description="List of LineSegment3D", alias="lineSegment3D")
    arc_segment3_d: Optional[List[Geometry3DArcSegment3DIdeaRSOpenModel]] = Field(default=None, description="List of ArcSegment3D", alias="arcSegment3D")
    poly_line3_d: Optional[List[Geometry3DPolyLine3DIdeaRSOpenModel]] = Field(default=None, description="List of PolyLine3D", alias="polyLine3D")
    region3_d: Optional[List[Geometry3DRegion3DIdeaRSOpenModel]] = Field(default=None, description="List of Region3D", alias="region3D")
    mat_concrete: Optional[List[MaterialMatConcreteIdeaRSOpenModel]] = Field(default=None, description="List of MatConcrete", alias="matConcrete")
    mat_reinforcement: Optional[List[MaterialMatReinforcementIdeaRSOpenModel]] = Field(default=None, description="List of MatReinforcement", alias="matReinforcement")
    mat_steel: Optional[List[MaterialMatSteelIdeaRSOpenModel]] = Field(default=None, description="List of MatSteel", alias="matSteel")
    mat_prestress_steel: Optional[List[MaterialMatPrestressSteelIdeaRSOpenModel]] = Field(default=None, description="List of MatPrestressSteel", alias="matPrestressSteel")
    mat_welding: Optional[List[MaterialMatWeldingIdeaRSOpenModel]] = Field(default=None, description="List of MatWelding", alias="matWelding")
    cross_section: Optional[List[CrossSectionCrossSectionIdeaRSOpenModel]] = Field(default=None, description="List of CrossSection", alias="crossSection")
    reinforced_cross_section: Optional[List[CrossSectionReinforcedCrossSectionIdeaRSOpenModel]] = Field(default=None, description="List of Reinforced CrossSection", alias="reinforcedCrossSection")
    hinge_element1_d: Optional[List[ModelHingeElement1DIdeaRSOpenModel]] = Field(default=None, description="List of hinge elements 1D", alias="hingeElement1D")
    opening: Optional[List[DetailOpeningIdeaRSOpenModel]] = Field(default=None, description="List of openings for Detail")
    dapped_end: Optional[List[DetailDappedEndIdeaRSOpenModel]] = Field(default=None, description="List of dapped ends in Detail", alias="dappedEnd")
    patch_device: Optional[List[DetailPatchDeviceIdeaRSOpenModel]] = Field(default=None, description="List of dapped ends in Detail", alias="patchDevice")
    element1_d: Optional[List[ModelElement1DIdeaRSOpenModel]] = Field(default=None, description="List of Elements 1D", alias="element1D")
    beam: Optional[List[DetailBeamIdeaRSOpenModel]] = Field(default=None, description="List of Elements 1D")
    member1_d: Optional[List[ModelMember1DIdeaRSOpenModel]] = Field(default=None, description="List of Member 1D", alias="member1D")
    element2_d: Optional[List[ModelElement2DIdeaRSOpenModel]] = Field(default=None, description="List of Elements 2D", alias="element2D")
    wall: Optional[List[DetailWallIdeaRSOpenModel]] = Field(default=None, description="List of Elements 2D")
    member2_d: Optional[List[ModelMember2DIdeaRSOpenModel]] = Field(default=None, description="List of Member 2D", alias="member2D")
    rigid_link: Optional[List[ModelRigidLinkIdeaRSOpenModel]] = Field(default=None, description="List of Rigid link", alias="rigidLink")
    point_on_line3_d: Optional[List[Geometry3DPointOnLine3DIdeaRSOpenModel]] = Field(default=None, description="List of Point on line 3D", alias="pointOnLine3D")
    point_support_node: Optional[List[ModelPointSupportNodeIdeaRSOpenModel]] = Field(default=None, description="List of Point support in node", alias="pointSupportNode")
    line_support_segment: Optional[List[ModelLineSupportSegmentIdeaRSOpenModel]] = Field(default=None, description="List of Line support on segment", alias="lineSupportSegment")
    loads_in_point: Optional[List[LoadingLoadInPointIdeaRSOpenModel]] = Field(default=None, description="List of point load impulses in this load case", alias="loadsInPoint")
    loads_on_line: Optional[List[LoadingLoadOnLineIdeaRSOpenModel]] = Field(default=None, description="List of line load impulses in this load case", alias="loadsOnLine")
    strain_loads_on_line: Optional[List[LoadingStrainLoadOnLineIdeaRSOpenModel]] = Field(default=None, description="List of generalized strain load impulses along the line in this load case.", alias="strainLoadsOnLine")
    point_loads_on_line: Optional[List[LoadingPointLoadOnLineIdeaRSOpenModel]] = Field(default=None, description="List of point load impulses in this load case", alias="pointLoadsOnLine")
    loads_on_surface: Optional[List[LoadingLoadOnSurfaceIdeaRSOpenModel]] = Field(default=None, description="List surafce load in this load case", alias="loadsOnSurface")
    settlements: Optional[List[LoadingSettlementIdeaRSOpenModel]] = Field(default=None, description="Settlements in this load case")
    temperature_loads_on_line: Optional[List[LoadingTemperatureLoadOnLineIdeaRSOpenModel]] = Field(default=None, description="List of temperature load in this load case", alias="temperatureLoadsOnLine")
    load_group: Optional[List[LoadingLoadGroupIdeaRSOpenModel]] = Field(default=None, description="List of Load groups", alias="loadGroup")
    load_case: Optional[List[LoadingLoadCaseIdeaRSOpenModel]] = Field(default=None, description="List of Load cases", alias="loadCase")
    combi_input: Optional[List[LoadingCombiInputIdeaRSOpenModel]] = Field(default=None, description="List of Combinations", alias="combiInput")
    attribute: Optional[List[Dict[str, Any]]] = Field(default=None, description="List of attributes")
    connection_point: Optional[List[ConnectionConnectionPointIdeaRSOpenModel]] = Field(default=None, description="List of Connection Points", alias="connectionPoint")
    connections: Optional[List[ConnectionConnectionDataIdeaRSOpenModel]] = Field(default=None, description="List of Connection data")
    reinforcement: Optional[List[DetailReinforcementIdeaRSOpenModel]] = Field(default=None, description="List of reinforcement in IDEA StatiCa Detail")
    isd_model: Optional[List[DetailISDModelIdeaRSOpenModel]] = Field(default=None, description="List of Details", alias="isdModel")
    initial_imperfection_of_point: Optional[List[ModelInitialImperfectionOfPointIdeaRSOpenModel]] = Field(default=None, description="List of InitialmperfectionOfPoint", alias="initialImperfectionOfPoint")
    tendon: Optional[List[ModelTendonIdeaRSOpenModel]] = Field(default=None, description="Tendon")
    result_class: Optional[List[LoadingResultClassIdeaRSOpenModel]] = Field(default=None, description="Result Class", alias="resultClass")
    design_member: Optional[List[ModelDesignMemberIdeaRSOpenModel]] = Field(default=None, description="Design Member", alias="designMember")
    sub_structure: Optional[List[ModelSubStructureIdeaRSOpenModel]] = Field(default=None, description="Design Member", alias="subStructure")
    ...
    check_member: Optional[List[ModelCheckMemberIdeaRSOpenModel]] = Field(default=None, description="List of the Check members", alias="checkMember")
    concrete_check_section: Optional[List[ConcreteCheckSectionIdeaRSOpenModel]] = Field(default=None, description="List of the concrete check section", alias="concreteCheckSection")
    ...
    rebar_shape: Optional[List[ModelRebarShapeIdeaRSOpenModel]] = Field(default=None, description="Gets or sets the rebars shapes", alias="rebarShape")
    rebar_general: Optional[List[ModelRebarGeneralIdeaRSOpenModel]] = Field(default=None, description="Gets or sets the rebar General collection", alias="rebarGeneral")
    rebar_single: Optional[List[ModelRebarSingleIdeaRSOpenModel]] = Field(default=None, description="Gets or sets the rebar single collection", alias="rebarSingle")
    rebar_stirrups: Optional[List[ModelRebarStirrupsIdeaRSOpenModel]] = Field(default=None, description="Gets or sets the rebar group (stirrups) collection", alias="rebarStirrups")
    taper: Optional[List[ModelTaperIdeaRSOpenModel]] = None
    span: Optional[List[ModelSpanIdeaRSOpenModel]] = None
    solid_blocks3_d: Optional[List[DetailSolidBlock3DIdeaRSOpenModel]] = Field(default=None, description="List of Solid Blocks 3D", alias="solidBlocks3D")
    surface_supports3_d: Optional[List[DetailSurfaceSupport3DIdeaRSOpenModel]] = Field(default=None, description="List of Surface Supports 3D", alias="surfaceSupports3D")
    base_plates3_d: Optional[List[DetailBasePlate3DIdeaRSOpenModel]] = Field(default=None, description="List of Base Plates 3D", alias="basePlates3D")
    anchors3_d: Optional[List[DetailAnchor3DIdeaRSOpenModel]] = Field(default=None, description="List of Anchors 3D", alias="anchors3D")
    detail_load_case: Optional[List[DetailLoadingDetailLoadCaseIdeaRSOpenModel]] = Field(default=None, description="List of Load cases", alias="detailLoadCase")
    detail_combination: Optional[List[DetailLoadingDetailCombinationIdeaRSOpenModel]] = Field(default=None, description="List of Combinations", alias="detailCombination")
