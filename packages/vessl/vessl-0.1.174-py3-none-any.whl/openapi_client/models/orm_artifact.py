...
class OrmArtifact(object):
    ...
    def __init__(self, artifact_created_by=None, artifact_organization=None, artifact_origin=None, artifact_project=None, artifact_run_execution=None, artifact_workload=None, claim_name=None, created_dt=None, description=None, edges=None, id=None, immutable_slug=None, is_plot_artifact=None, name=None, parent_artifact_id=None, storage_config=None, storage_type=None, sub_path=None, type=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.artifact_project = artifact_project
    ...
    @property
    def artifact_project(self):
        """Gets the artifact_project of this OrmArtifact.  # noqa: E501


        :return: The artifact_project of this OrmArtifact.  # noqa: E501
        :rtype: int
        """
        return self._artifact_project

    @artifact_project.setter
    def artifact_project(self, artifact_project):
        """Sets the artifact_project of this OrmArtifact.


        :param artifact_project: The artifact_project of this OrmArtifact.  # noqa: E501
        :type artifact_project: int
        """

        self._artifact_project = artifact_project
