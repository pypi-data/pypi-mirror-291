...
def calculate_lpips_multiband_multiblock_of_even_size(image1: np.ndarray, image2: np.ndarray, loss_fn, max_block_size: int = 5000) -> (
        list, float):
    """
...
def calculate_lpips_multiband__multiblock_of_fixed_size(image1: np.ndarray, image2: np.ndarray, loss_fn, max_block_size: int = 5000) -> (
        list, float):
    """
...
def calculate_lrsp(image1_path, image2_path) -> dict:
    ...
    lpips_values, lpips_value = calculate_lpips_multiband_multiblock_of_even_size(image1, image2, loss_fn)
