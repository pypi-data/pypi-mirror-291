...
class Launcher:
	...
	def Launch(self) -> int:
		...
		with open(prepareFilePath, READ, encoding = UTF8) as file:
			...
			yaml.add_constructor("!!python/object:dduk.application.prepareddata.PreparedData", PreparedData.YAMLConstrcutor)
			
			yaml.add_constructor("!!python/object/apply:dduk.application.applicationexecutetype.ApplicationExecuteType", ApplicationExecuteType.YAMLConstrcutor)
