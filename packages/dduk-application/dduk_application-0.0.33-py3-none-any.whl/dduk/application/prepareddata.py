...
class PreparedData:
	...
	#--------------------------------------------------------------------------------
	@staticmethod
	def YAMLConstrcutor(loader : yaml.Loader, node : yaml.Node) -> PreparedData:
		mappings : dict = loader.construct_mapping(node, deep = True)
		preparedData = PreparedData()
		preparedData.Name = mappings.get("Name", "noname")
		preparedData.Type = mappings.get("Type", ApplicationExecuteType.UNKNOWN)
		preparedData.Symbols = mappings.get("Name", set())
		preparedData.Arguments = mappings.get("Name", list())
		preparedData.StartModuleName = mappings.get("StartModuleName", "__main__")
		preparedData.StartFunctionName = mappings.get("StartFunctionName", "Main")
		return preparedData