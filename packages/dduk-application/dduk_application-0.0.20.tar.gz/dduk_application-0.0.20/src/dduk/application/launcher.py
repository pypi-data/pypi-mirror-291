...
class Launcher:
	...
	def Launch(self) -> int:
		...
		try:
			...
			module : ModuleType = importlib.import_module(self.__preparedData.START_MODULE_NAME)
			function = builtins.getattr(module, self.__preparedData.START_FUNCTION_NAME)
