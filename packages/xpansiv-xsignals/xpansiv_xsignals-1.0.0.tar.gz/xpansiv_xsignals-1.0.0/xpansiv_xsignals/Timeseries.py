...
class Timeseries:
    ...
    def upload_data(self, file_name, symbols_columns, date_column, group_name,sync=True):
        '''
        ...
        fid = self.uploader.upload_file(file=temp_file, group_name=group_name, file_type='NCSV', sync=sync)
