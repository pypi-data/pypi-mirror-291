...
def delete_components(top_components, to_delete = None,  min_distance = 0.98, how = 'one', dry_run = True, verbose = True):
    ...
    try:
        ...
        assert 'len' in top_components.columns, "top_components dataframe should contain the len columns where this number is an integer signfying the number of images in this component"
