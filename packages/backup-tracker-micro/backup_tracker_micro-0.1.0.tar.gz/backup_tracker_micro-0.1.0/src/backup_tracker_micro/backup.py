...
class BackupTracker(BaseRESTAPI):
    ...
    def __init__(self, host: str, service: str, root_endpoint: str, config_dir: str = None, cache_dir: str = None) -> None:
    ...
    def get_backup_status(self, rows) -> None:
        e = "backup/status"
        p = {
            "rows": rows
        }
    ...
    def get_backup_events(self) -> list:
        e = "backup"
        p = {}
