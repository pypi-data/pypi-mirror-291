...
class DbtPyTestCase(unittest.TestCase):
  ...
  def run_test_180(self):
    ...
    if conn:
      ...
      result2 = ''
      try:
        result = DbtPy.exec_immediate(conn,"insert int0 t_string values(123,1.222333,'one to one')")
      except:
        pass
      if result:
...
#__IDS_EXPECTED__
#[GBasedbt][GBase ODBC Driver][GBasedbt]A syntax error has occurred. SQLCODE=-201col: 0 , affected row: 0
