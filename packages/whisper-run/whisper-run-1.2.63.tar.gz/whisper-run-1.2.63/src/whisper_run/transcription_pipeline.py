...
class Segment(NamedTuple):
    ...
    words: Any  # Assuming words could be a list or another type, adjust as necessary


def prepare_segment(segment) -> Dict[str, Any]:
    # Convert segment to a dictionary and remove the 'tokens' key
    segment_dict = segment._asdict()
    segment_dict.pop("tokens", None)  # Remove 'tokens' if it exists
    return segment_dict
