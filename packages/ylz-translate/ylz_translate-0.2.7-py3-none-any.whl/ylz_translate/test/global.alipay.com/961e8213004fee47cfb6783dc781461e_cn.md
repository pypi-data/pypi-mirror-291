...
* 在“使用非卡支付方式”中的“发起支付流程”部分，增加了对_codeValue_的描述，参考文档：[使用非卡支付方式支付](https://global.alipay.com/docs/ac/cashierpay/noncard_payment?version=v1.40&pageVersion=3)。
* 更新了[notifyPayment](https://global.alipay.com/docs/ac/ams/paymentrn_online)通知的描述，可在“通知”文档中查看：[收银台支付通知](https://global.alipay.com/docs/ac/cashierpay/notifications)。
...
*   更新了[咨询（收银台支付）](https://global.alipay.com/docs/ac/ams/consult_cashier)API响应参数中的参数`PaymentOptions.paymentMethodRegion`的描述。
*   更新了参数`feeAmountValue`的描述。更多详情，请参阅以下文档：  
    *   [收银台支付的结算项目](https://global.alipay.com/docs/ac/cashierpay/settlementitems)
...
*   **收银台支付结算概览**：[结算概览](https://global.alipay.com/docs/ac/cashierpay/settlementsummary)
*   **自动扣款结算项目**：[结算项目](https://global.alipay.com/docs/ac/autodebitpay/settlementitems)
*   **自动扣款结算概览**：[结算概览](https://global.alipay.com/docs/ac/autodebitpay/settlementsummary)
...
请注意，文档中提到的接口和字段是蚂蚁金服支付服务的一部分，这些变更可能影响到使用这些服务的商户或开发者。
*   redirectActionForm
*   orderCodeForm
*   将以下字段从可选改为必填：
*   请求参数：
...
**图片说明**
  ...
  * 图片3 ![Image 3](https://ac.alipay.com/storage/2021/5/20/19b2c126-9442-4f16-8f20-e539b1db482a.png)
  * 图片4 ![Image 4](https://ac.alipay.com/storage/2021/5/20/e9f3f154-dbf0-455f-89f0-b3d4e0c14481.png)
