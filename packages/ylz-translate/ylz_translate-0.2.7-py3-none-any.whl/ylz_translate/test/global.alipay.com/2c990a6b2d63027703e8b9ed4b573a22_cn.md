...
您可以通过点击**+ 创建商户账户**创建新商户账户。创建账户后，您可以通过点击右上角的**设置** ![图片4: image.png](https://yuque.antfin.com/images/lark/0/2023/png/119656509/1703062036421-1dea58a9-ac6d-4864-91fa-7a8bdce64ff7.png) > **商户账户信息**来修改账户信息。
...
1.  **沙箱配置**：设置您的测试环境，确保与Antom的沙箱系统连接。
2.  **沙箱集成**：将您的应用程序或网站与Antom的沙箱接口集成，进行模拟交易。
3.  **沙箱测试**：在测试模式下进行交易测试，验证支付流程的正确性和功能。

完成这些步骤后，您可以确保系统在实际在线支付前运行正常。
### 沙盒配置  
...
2. 集成测试：在 **开发者** > **快速开始** > **集成资源与工具** > **集成测试** 中，可以访问针对各种支付方式的集成测试资源。
...
**注意**: 如果私钥丢失，可以通过点击**替换密钥**来生成新密钥。请务必保管好您的私钥以备后续使用。  
