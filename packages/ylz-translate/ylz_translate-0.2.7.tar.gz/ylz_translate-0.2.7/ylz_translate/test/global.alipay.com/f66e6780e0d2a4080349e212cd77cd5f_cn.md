...
[![ 图片 1：领先中国的第三方在线支付解决方案支付宝](https://ac.alipay.com/storage/2024/3/26/d66c43c0-440d-4c97-9976-f2028a2c8c5e.svg) ![ 图片 2：领先中国的第三方在线支付解决方案支付宝](https://ac.alipay.com/storage/2024/3/26/a48bd336-aea0-4f16-bf83-616eacbb4434.svg)](/docs/)
...
*   在[结算汇总报告](https://global.alipay.com/docs/ac/reconcile/settlement_details)文档的_summaryType_字段中，添加了枚举值`COLLATERAL_WITHHOLDING`、`RESERVE_WITHHOLDING`和`RESERVE_RELEASE`。
*   在[结算明细报告](https://global.alipay.com/docs/ac/reconcile/settlement_details)文档的_transactionType_字段中，添加了枚举值`COLLATERAL_WITHHOLDING`、`RESERVE_WITHHOLDING`和`RESERVE_RELEASE`。
...
* 添加了简易支付产品的[英文版](https://global.alipay.com/docs/ac/easypay_en/overview_en)和[中文版](https://global.alipay.com/docs/ac/easypay/overview)集成指南。
...
*   在[支付（收银台支付）](https://global.alipay.com/docs/ac/ams/payment_cashier) API 的请求参数中，将 _blikCode_ 和 _payerEmail_ 字段作为子参数添加到 _paymentMethodMetaData_ 的 _paymentMethodMetaData_ 字段内。
...
*   在\_paymentMethodType\_字段中添加了枚举值`PAYPAY`。详情请参阅以下文档：
    ...
    *   **自动扣款结算项目**：[结算项目](https://global.alipay.com/docs/ac/autodebitpay/settlementitems)
*   更新了\_settlementAmountValue\_, \_feeAmountValue\_, 和 \_taxFeeAmountValue\_字段的描述。详情请参阅以下文档：
    *   **收银台支付结算项目**：[结算项目](https://global.alipay.com/docs/ac/cashierpay/settlementitems)
    *   **收银台支付结算汇总**：[结算汇总](https://global.alipay.com/docs/ac/cashierpay/settlementsummary)
    *   **自动扣款结算项目**：[结算项目](https://global.alipay.com/docs/ac/autodebitpay/settlementitems)
    *   **自动扣款结算汇总**：[结算汇总](https://global.alipay.com/docs/ac/autodebitpay/settlementsummary)
