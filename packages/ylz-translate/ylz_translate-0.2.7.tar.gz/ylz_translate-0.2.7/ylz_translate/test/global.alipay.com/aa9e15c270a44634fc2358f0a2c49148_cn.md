...
最后，业务注册国家/地区字段已从“欢迎”页面移至“创建新应用”页面。
*   redirectActionForm
*   orderCodeForm
*   将以下字段从可选改为必填：
*   请求参数：
...
*   删除了以下字段：
    ...
    *   响应参数：
        ...
        *   orderCodeForm
*   添加了settlementStrategy字段。
*   修改了order.env和order.env.userAgent字段，从Optional变为Required。
**2021年12月**
-------------
...
请注意，这些条目代表了一个时间序列，其中每个部分都指出了在相应月份中对产品或服务进行的增强、废弃的特性或文档改进。由于没有具体的内容，这里仅提供了标题的中文翻译。如果需要每个部分的具体信息，您需要提供文档的详细内容。
**2021年9月**
