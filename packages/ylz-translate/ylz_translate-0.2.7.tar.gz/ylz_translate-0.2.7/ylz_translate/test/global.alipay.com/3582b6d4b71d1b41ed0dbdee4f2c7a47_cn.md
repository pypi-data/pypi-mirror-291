...
* 新增了参数 _interchangeFeeAmountValue_，_interchangeFeeCurrency_，_schemeFeeAmountValue_，_schemeFeeCurrency_，_AcquirerMarkupFeeAmountValue_ 和 _AcquirerMarkupFeeCurrency_。详情请参考以下文档：
    * [Cashier Payment 的结算项目](https://global.alipay.com/docs/ac/cashierpay/settlementitems)
    * [Cashier Payment 的结算摘要](https://global.alipay.com/docs/ac/cashierpay/settlementsummary)
...
*   在字段`paymentMethodType`中添加了枚举值`PROMPTPAY`。更多详情，请参阅以下文档：  
    *   [收银台支付的交易项目](https://global.alipay.com/docs/ac/cashierpay/transactionitems)
*   **收银台支付结算项目**  
    请参阅：[Settlement Items for Cashier Payment](https://global.alipay.com/docs/ac/cashierpay/settlementitems)
*   **支付方式类型**  
    添加了枚举值 `EASYPAISA` 到字段 _paymentMethodType_。更多详情，请查阅以下文档：
*   **收银台支付交易项目**  
    请参阅：[Transaction Items for Cashier Payment](https://global.alipay.com/docs/ac/cashierpay/transactionitems)
*   **收银台支付结算项目**  
    （重复项，与第一项相同）
*   **自动扣款交易项目**  
    请参阅：[Transaction Items for Auto Debit](https://global.alipay.com/docs/ac/autodebitpay/transactionitems)
*   **自动扣款结算项目**  
    请参阅：[Settlement Items for Auto Debit](https://global.alipay.com/docs/ac/autodebitpay/settlementitems)
### 已废弃  
...
*   删除了以下字段：
    ...
    *   响应参数：
        ...
        *   `orderCodeForm`
*   添加了 `settlementStrategy` 字段。
*   将 `order.env` 和 `order.env.userAgent` 字段从可选改为必需。
**2021年12月**
-------------
