...
订阅更新
关注产品更新，通过电子邮件接收文档更新的通知。您可以通过右侧的“取消订阅”按钮或每封邮件通知中提供的链接取消订阅。  
...
### 文档改进  
*   对收银台支付和自动扣款API请求发送的域名进行了更新。详细信息请参阅[调用API](https://global.alipay.com/docs/ac/ams/api#call_api)。
...
请注意，这些文档链接指向的是蚂蚁金服的全球版英文文档，实际内容需要根据蚂蚁金服的中文版文档平台进行查阅。在中文文档中，您将找到关于如何处理退款逆转以及在收银台支付和自动扣款场景下如何进行结算汇总的详细信息。
### 文档改进  
...
*   在[支付（收银台支付）](https://global.alipay.com/docs/ac/ams/payment_cashier) API 的请求参数中，作为 _paymentMethodMetaData_ 的子参数，添加了 _blikCode_ 和 _payerEmail_ 字段。
...
* 为 [notifyDispute](https://global.alipay.com/docs/ac/ams/notify_dispute) API 的请求参数中的 _disputeJudgedResult_ 添加了描述。
...
*   从以下API中删除了 _orderCodeForm.codeDetails.codeValueType_ 字段：
    ...
    *   [自动扣款支付](https://global.alipay.com/docs/ac/ams/payment_agreement)
*   2021年5月
    *   Alipay Docs全新改版，提升用户体验并采用新的信息架构。新增帮助新用户文档：
    ...
    *   将以下文档移至对应产品文档：
        ...
        *   结算汇总
        *   交易项目
    *   如需查看详情，例如，可以前往收银台支付 > 报表与对账 > 结算项目 ([https://global.alipay.com/docs/ac/cashierpayment/settlementitems\_online](https://global.alipay.com/docs/ac/cashierpayment/settlementitems_online))。
术语更名。以下术语已被重命名：
...
*   5月份发布了新版Alipay Docs。原门户（[https://global.alipay.com/open/doc.htm](https://global.alipay.com/open/doc.htm)）的技术文档已合并到此新站点，以提供更好的用户体验。您可以前往 **文档** > **旧版文档** ([https://global.alipay.com/docs/ac/legacy/legacydoc](https://global.alipay.com/docs/ac/legacy/legacydoc)) 查看详情。
