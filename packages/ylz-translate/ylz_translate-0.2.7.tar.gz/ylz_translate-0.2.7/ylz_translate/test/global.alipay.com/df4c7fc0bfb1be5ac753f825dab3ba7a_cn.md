...
1. **扫码支付**
   参考文档：[快速开始 - 扫码支付](https://global.alipay.com/docs/ac/cashierpay/quickstart)

2. **快捷支付**
   参考文档：[SDK集成指南 - 快捷支付](https://global.alipay.com/docs/ac/easypay_en/sdk)

3. **自动扣款**
   参考文档：[授权指南 - 自动扣款](https://global.alipay.com/docs/ac/autodebit_en/auth)

4. **订阅支付**
   参考文档：[激活指南 - 订阅支付](https://global.alipay.com/docs/ac/subscriptionpay_en/activation)
### 沙盒测试
...
**注意**: 如果私钥丢失，可以通过点击**替换密钥**来生成新密钥。请确保为后续使用妥善保管私钥。  
3\. 获取网关URL和客户端ID: 通过**开发者** > **快速开始** > **集成资源和工具** > **集成资源**获取实时环境的网关URL和客户端ID。  
4. 设置通知URL: 在**开发者** > **快速开始** > **集成资源和工具** > **通知URL**中设置通知URL，以接收Antom的通知。  
...
![图片 14](https://cdn.nlark.com/yuque/0/2024/png/12884741/1712476335776-93755db8-48eb-4a66-b97b-9e10daf5d110.png)  
要查看文档的最新更新，请访问[发行说明](https://global.alipay.com/docs/releasenotes)。  
![图片 15](https://ac.alipay.com/storage/2021/5/20/19b2c126-9442-4f16-8f20-e539b1db482a.png) ![图片 16](https://ac.alipay.com/storage/2021/5/20/e9f3f154-dbf0-455f-89f0-b3d4e0c14481.png)  
