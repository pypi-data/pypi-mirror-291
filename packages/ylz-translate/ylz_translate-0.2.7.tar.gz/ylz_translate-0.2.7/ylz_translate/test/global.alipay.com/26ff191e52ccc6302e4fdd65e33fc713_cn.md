...
蚂蚁国际商家争议处理指南为处理和解决争议提供了指导，详细说明了针对不同支付方式产生的争议的解决程序和操作要求。本指南遵循支付宝+核心规则、卡组织规则以及适用的法律法规的争议解决原则制定。
### 术语和定义  
...
表1：术语定义
### 开始之前  
当发生退款请求时，您会从蚂蚁金服收到一份包含退款信息的通知，即“通知更改”（NoC）。为确保能接收到此通知，请事先[配置接收NoC的地址](https://global.alipay.com/docs/ac/dispute/noc)。
### 了解纠纷处理
在处理纠纷之前，请先了解以下内容：
...
*   处理退款请求。
*   遵循每个退款阶段的[时间限制](https://global.alipay.com/docs/ac/dispute/timeframe)。
