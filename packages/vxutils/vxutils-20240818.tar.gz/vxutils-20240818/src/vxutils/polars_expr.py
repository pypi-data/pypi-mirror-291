...
def Mean(
    ...
    *,
    ...
    if windows is None:
        ...
        expr = expr.rolling_mean(windows, by=over if over else None)
    expr = expr.alias(name) if name else expr
    return expr
...
def Max(
    ...
    *,
    ...
    if windows is None:
        ...
        expr = expr.rolling_max(windows, by=over if over else None)
    expr = expr.alias(name) if name else expr
    return expr
...
def Min(
    ...
    *,
    ...
    if windows is None:
        ...
        expr = expr.rolling_min(windows, by=over if over else None)
    expr = expr.alias(name) if name else expr
    return expr
...
def Std(
    ...
    *,
    ...
    if windows is None:
        ...
        expr = expr.rolling_std(windows, by=over if over else None)
    expr = expr.alias(name) if name else expr
    return expr
...
def Median(
    ...
    *,
    ...
    if windows is None:
        ...
        expr = expr.rolling_median(windows, by=over if over else None)
    expr = expr.alias(name) if name else expr
    return expr
...
def Var(
    ...
    *,
    ...
    if windows is None:
        ...
        expr = expr.rolling_var(windows, by=over if over else None)
    expr = expr.alias(name) if name else expr
    return expr
...
def Sum(
    ...
    *,
    ...
    if windows is None:
        ...
        expr = expr.rolling_sum(windows, by=over if over else None)
    expr = expr.alias(name) if name else expr
    return expr
...
def Quantile(
    ...
    *,
    ...
    if windows is None:
        ...
        expr = expr.rolling_quantile(
            quantile, window_size=windows, by=over if over else None
        )
    expr = expr.alias(name) if name else expr
    return expr
...
def IdxMin(
    ...
    *,
    ...
    if windows is None:
        ...
        expr = rolling(windows, by=over if over else None)
