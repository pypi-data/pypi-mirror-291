...
def run(  # pylint: disable=too-complex
    ...
    process_healthcheck_script_engine.register_script(Script(shutdown_if_process_exited, enabled=True))
    rainbow_script_engine.register_script(Script(gradient_updater, enabled=True))
