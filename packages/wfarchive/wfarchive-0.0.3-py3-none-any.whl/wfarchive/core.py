...
class Archive:
    def __init__(self):
        ...
        self._loose_files_path: str | None = None
        self._alternative_name: str | None = None
    ...
    @classmethod
    def load_from_bytes(cls, s: bytes, name: str | None = None):
        archive =  Archive()
    ...
    @classmethod
    def load_from_fp(cls, fp: SupportsRead[bytes], name: str | None = None):
    ...
    def export_archive(self, path: str | None = None, *, exist_ok: bool = False):
    ...
    @overload
    def export_signed_archive(self, path: str | None = None, *, exist_ok: bool = False, capture_output: Literal[True]) -> CompletedProcess: ...

    @overload
    def export_signed_archive(self, path: str | None = None, *, exist_ok: bool = False, capture_output: Literal[False] = False) -> None: ...

    def export_signed_archive(self, path: str | None = None, *, exist_ok: bool = False, capture_output: bool = False):
        if system() != 'Darwin':
    ...
    def export_loose_files(self, path: str | None = None, *, exist_ok: bool = False):
