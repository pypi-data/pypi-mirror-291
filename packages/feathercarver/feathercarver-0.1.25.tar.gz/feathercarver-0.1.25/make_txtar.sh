...
declare -a files=(
	...
	# Makefile # loc: 3
	README.md # loc: 50
	# make_txtar.sh # loc: 56
	# pyproject.toml # loc: 33
	# requirements-dev.lock # loc: 35
	# requirements.lock # loc: 11
	src/feathercarver/__init__.py # loc: 25
	src/feathercarver/__main__.py # loc: 6
	src/feathercarver/argument_parser.py # loc: 35
	src/feathercarver/directory_processor.py # loc: 23
	src/feathercarver/file_processor.py # loc: 36
	src/feathercarver/link_fixer.py # loc: 82
	src/feathercarver/logger.py # loc: 22
	test.md # loc: 1
	tests/test_link_fixer.py # loc: 179
