...
class float2x2:
    ...
    def to_numpy(self) -> Annotated[ArrayLike, dict(dtype='float32', writable=False, shape=(2, 2))]: ...
...
class float2x4:
    ...
    def to_numpy(self) -> Annotated[ArrayLike, dict(dtype='float32', writable=False, shape=(2, 4))]: ...
...
class float3x3:
    ...
    def to_numpy(self) -> Annotated[ArrayLike, dict(dtype='float32', writable=False, shape=(3, 3))]: ...
...
class float3x4:
    ...
    def to_numpy(self) -> Annotated[ArrayLike, dict(dtype='float32', writable=False, shape=(3, 4))]: ...
...
class float4x4:
    ...
    def to_numpy(self) -> Annotated[ArrayLike, dict(dtype='float32', writable=False, shape=(4, 4))]: ...
