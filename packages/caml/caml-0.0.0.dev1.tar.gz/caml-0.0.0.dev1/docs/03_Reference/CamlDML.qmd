...
`CamlDML(self, df, uuid, y, t, X=None, model_y=HistGradientBoostingRegressor(max_depth=3, max_iter=500), model_t=HistGradientBoostingClassifier(max_depth=3, max_iter=500), discrete_treatment=True, discrete_outcome=False, spark=None)`
...
| Name | Description |
| --- | --- |
| [fit](#caml.CamlDML.fit) | Fits the econometric model to learn the CATE function. |
| [optimize](#caml.CamlDML.optimize) | Optimizes a households treatment based on CATE predictions. Only applicable when |
| [predict](#caml.CamlDML.predict) | Predicts the CATE given feature set. |
| [rank](#caml.CamlDML.rank) | Ranks households based on the those with the highest estimated CATE. |
| [summarize](#caml.CamlDML.summarize) | Provides population summary of treatment effects, including Average Treatment Effects (ATEs) |

### fit { #caml.CamlDML.fit }
...
### optimize { #caml.CamlDML.optimize }
...
### summarize { #caml.CamlDML.summarize }
