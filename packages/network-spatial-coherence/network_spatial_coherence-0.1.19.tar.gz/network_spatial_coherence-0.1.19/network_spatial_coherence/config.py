...
base = {
    "proximity_mode": "experimental",  # Options 1) Simulation: knn, knn_bipartite,  epsilon-ball, epsilon_bipartite, lattice, delaunay_corrected, distance_decay... 2) experimental
    "dim": 2,
    "false_edges_count": 0,
