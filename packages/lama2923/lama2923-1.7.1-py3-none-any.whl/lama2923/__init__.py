...
def llinput(*prompt, sep=" ", end='\n', wend='', max_length=None, min_lenght=None, forceint=False, negativeint=False, forcestr = False, forceinput=False, startswith = ("", False), forcestartswith=[], forceendswith = [], choices = ([], False), blockedchars = r"", availablechars=r"", forceinputlen=0, autocorrect=False, inputcolor=None, promptcolor=None, endcolor=None, wendcolor=None, inputtype="world"):
    ...
    def update_display():
        if any([promptcolor, inputcolor, wendcolor, endcolor]):
            if inputtype == "world":
                ...
                sys.stdout.write('\r' + promptcolor + prompt + Fore.RESET + inputcolor + '*' * len(input_str) + Fore.RESET + wendcolor + wend + Fore.RESET + ' ' * (len(end) + 1))
                sys.stdout.write('\r' + promptcolor + prompt + Fore.RESET + inputcolor + '*' * len(input_str) + Fore.RESET + wendcolor + wend + Fore.RESET )
                sys.stdout.write('\b' * len(wend))
                sys.stdout.flush()
                
            elif inputtype == "password-lastkey":
                try:
                    sys.stdout.write('\r' + promptcolor + prompt + Fore.RESET + inputcolor + '*' * (len(input_str) - 1) + input_str[-1] + Fore.RESET + wendcolor + wend + Fore.RESET + ' ' * (len(end) + 1))
                    sys.stdout.write('\r' + promptcolor + prompt + Fore.RESET + inputcolor + '*' * (len(input_str) - 1) + input_str[-1] + Fore.RESET + wendcolor + wend + Fore.RESET )
                    sys.stdout.write('\b' * len(wend))
                    sys.stdout.flush()
                except:
                    sys.stdout.write('\r' + promptcolor + prompt + Fore.RESET + inputcolor + '*' * len(input_str) + Fore.RESET + wendcolor + wend + Fore.RESET + ' ' * (len(end) + 1))
            ...
            elif inputtype == "password2":
                sys.stdout.write('\r' + promptcolor + prompt + Fore.RESET + inputcolor + ' ' * len(input_str) + Fore.RESET + wendcolor + wend + Fore.RESET + ' ' * (len(end) + 1))
                sys.stdout.write('\r' + promptcolor + prompt + Fore.RESET + inputcolor + ' ' * len(input_str) + Fore.RESET + wendcolor + wend + Fore.RESET )
                sys.stdout.write('\b' * len(wend))
                sys.stdout.flush()
            
            elif inputtype == "password2-lastkey":
                try:
                    sys.stdout.write('\r' + promptcolor + prompt + Fore.RESET + inputcolor + ' ' * ((len(input_str) - 1) + input_str[-1]) + Fore.RESET + wendcolor + wend + Fore.RESET + ' ' * (len(end) + 1))
                    sys.stdout.write('\r' + promptcolor + prompt + Fore.RESET + inputcolor + ' ' * ((len(input_str) - 1) + input_str[-1]) + Fore.RESET + wendcolor + wend + Fore.RESET )
                    sys.stdout.write('\b' * len(wend))
                ...
                raise ValueError("Invalid input type. inputtype must be 'world', 'password', 'password-lastkey', 'password2', 'password2-lastkey'.")
            ...
            if inputtype == "world":
                ...
                sys.stdout.write('\r' + prompt + '*' * len(input_str) + wend + ' ' * (len(end) + 1))
                sys.stdout.write('\r' + prompt + '*' * len(input_str) + wend)
                sys.stdout.write('\b' * len(wend))
                sys.stdout.flush()
            
            elif inputtype == "password-lastkey":
                try:
                    sys.stdout.write('\r' + prompt + '*' * (len(input_str) - 1) + input_str[-1] + wend + ' ' * (len(end) + 1))
                    sys.stdout.write('\r' + prompt + '*' * (len(input_str) - 1) + input_str[-1] + wend)
                    sys.stdout.write('\b' * len(wend))
                    sys.stdout.flush()
                except:
                    sys.stdout.write('\r' + prompt + '*' * len(input_str) + wend + ' ' * (len(end) + 1))
    ...
    if any([promptcolor, inputcolor, wendcolor, endcolor]):
        if inputtype == "world":
            ...
            sys.stdout.write('\r' + promptcolor + prompt + Fore.RESET + inputcolor + '*' * len(input_str) + Fore.RESET + wendcolor + wend + Fore.RESET + endcolor + end + Fore.RESET)
            sys.stdout.flush()
        elif inputtype == "password-lastkey":
            try:
                sys.stdout.write('\r' + promptcolor + prompt + Fore.RESET + inputcolor + '*' * (len(input_str) - 1) + input_str[-1] + Fore.RESET + wendcolor + wend + Fore.RESET + endcolor + end + Fore.RESET)
                sys.stdout.flush()
            except:
                sys.stdout.write('\r' + promptcolor + prompt + Fore.RESET + inputcolor + '*' * len(input_str) + Fore.RESET + wendcolor + wend + Fore.RESET + endcolor + end + Fore.RESET)
                sys.stdout.flush()
        ...
        if inputtype == "world":
            ...
            sys.stdout.write('\r' + prompt + '*' * len(input_str) + wend + end)
            sys.stdout.flush()
        elif inputtype == "password-lastkey":
            try:
                sys.stdout.write('\r' + prompt + '*' * (len(input_str) - 1) + input_str[-1] + wend + end)
                sys.stdout.flush()
            except:
                sys.stdout.write('\r' + prompt + '*' * len(input_str) + wend + end)
                sys.stdout.flush()
