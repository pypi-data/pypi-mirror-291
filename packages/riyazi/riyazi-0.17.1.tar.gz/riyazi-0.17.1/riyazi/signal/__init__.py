...
https://matlab-code.org/signal-processing-projects/
...
- Signal Analysis and visualization -1
- signal generation and preprocessing -23
- Measurement and feature extraction -56
- Transforms, Correlation and Modeling
- Digital and Analog filter
- spectral analysis
- Time-frequency analysis
- vibration analysis
- Ml and Dl for singnal 

# 2 wavelet Toolbox 
- Time frequency analysis - 23
- Discrete multiresolution analysis -94
- Denoising and compression - 20 
- Ml and Dl -17
- filter Banks - 40 

# 3 Audio Toolbox 
- Audio io waveform generation 
- Audio processing algorithm Design 
- Ml and Dl for Audio 
- Measurement and spatial Audio
- simulation, Turning and visualizaiton 
- Musical instrument Digital interface (Ml, Dl) 
- Audio plugin Creation and Hasting

# 4 Dsp System Toolbox 
- signal generation Manipulation and analysis 
- Filter Design and analysis -131
- filter implementation -64
- Transforms and spectral analysis -9
- syatistics and linear algebra -9 
- code generation 

# 5 Phased Array System Toolbox
- Phased Array Design and analysis - 75
- Beamforming and Direction of arival estimation 
- Detection , Range and Doppler Estimation 
- Waveform Desing and signal synthesis

# 6 Radar Toolbox
- Radar System Enfineeering - 100 
- Scenario Generation - 49
- Data synthesis - 22
- Signal and Data processing - 42
