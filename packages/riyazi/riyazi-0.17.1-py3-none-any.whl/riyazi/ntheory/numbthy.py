...
# Author: Md slauddin, <mdslauddin285@gmail.com>
######################################################################################
"""
...
Functions implemented are:
 ...
 __all__ = ['gcd', 'xgcd', 'power_mod', 'inverse_mod', 'is_prime','euler_criterion', 'euler_phi', 'carmichael_lambda',
 			'factor', 'prime_divisors','is_primitive_root', 'sqrtmod', 'TSRsqrtmod', 'isprime', 'isprimeF', 'isprimeE' ,
    		'factorone', 'factors', 'factorPR', 'invmod', 'powmod', 'eulerphi', 'carmichaellambda', 'isprimitive' ]
"""
