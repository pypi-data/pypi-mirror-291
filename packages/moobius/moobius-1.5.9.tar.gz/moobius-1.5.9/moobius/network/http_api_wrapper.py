...
class HTTPAPIWrapper:
    ...
    async def create_channel_group(self, channel_id, group_name, members):
        ...
        Returns:
          The group_id string.
        """
        members = utils.to_char_id_list(members) # Should not be necessary since this function is an internal function.
        utils.assert_strs(*([channel_id, group_name]+members))
