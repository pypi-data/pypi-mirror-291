...
class CreateProjectRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["description", b"description", "folder_id", b"folder_id", "limits", b"limits", "name", b"name", "settings", b"settings"]) -> None: ...
...
class UpdateProjectRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["description", b"description", "limits", b"limits", "name", b"name", "project_id", b"project_id", "settings", b"settings", "update_mask", b"update_mask"]) -> None: ...
...
class ProjectExecutionResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["checkpoint_id", b"checkpoint_id", "output_variables", b"output_variables"]) -> None: ...
