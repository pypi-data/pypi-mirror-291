...
class Dataset(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["code", b"code", "created_at", b"created_at", "created_by_id", b"created_by_id", "data_capsule_id", b"data_capsule_id", "description", b"description", "id", b"id", "labels", b"labels", "mount_path", b"mount_path", "name", b"name", "project_id", b"project_id", "size_gb", b"size_gb", "zone_ids", b"zone_ids"]) -> None: ...
