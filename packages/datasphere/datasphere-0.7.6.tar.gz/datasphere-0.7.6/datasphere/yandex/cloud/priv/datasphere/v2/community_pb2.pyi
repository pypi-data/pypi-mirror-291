...
class Community(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["access_type", b"access_type", "billing_account_id", b"billing_account_id", "channel", b"channel", "created_at", b"created_at", "created_by_id", b"created_by_id", "description", b"description", "id", b"id", "labels", b"labels", "name", b"name", "organization_id", b"organization_id", "status", b"status", "zone_id", b"zone_id"]) -> None: ...
...
class CommunityAccessBinding(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["access_type", b"access_type", "community", b"community"]) -> None: ...
...
class CommunicationChannel(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["id", b"id", "link", b"link", "name", b"name", "type", b"type"]) -> None: ...
