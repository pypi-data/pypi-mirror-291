...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'B\005DSPDSZ\ndatasphere'
  _FILEMETADATA.fields_by_name['project_id']._options = None
  _FILEMETADATA.fields_by_name['project_id']._serialized_options = b'\250\2111\001\312\2111\005<=200'
  _DOWNLOADFILEREQUEST.fields_by_name['project_id']._options = None
  _DOWNLOADFILEREQUEST.fields_by_name['project_id']._serialized_options = b'\250\2111\001\312\2111\005<=200'
  _DOWNLOADFILEREQUEST.fields_by_name['file_path']._options = None
  _DOWNLOADFILEREQUEST.fields_by_name['file_path']._serialized_options = b'\250\2111\001'
