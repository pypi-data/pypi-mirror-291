...
class CloudUserInfo(google.protobuf.message.Message):
    ...
    class CreateCloudRestrictions(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["has_email", b"has_email", "has_login", b"has_login", "has_phone", b"has_phone"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["create_cloud_restrictions", b"create_cloud_restrictions"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["can_create_cloud", b"can_create_cloud", "create_cloud_restrictions", b"create_cloud_restrictions", "is_eula_accepted", b"is_eula_accepted", "is_member_of_cloud", b"is_member_of_cloud"]) -> None: ...
