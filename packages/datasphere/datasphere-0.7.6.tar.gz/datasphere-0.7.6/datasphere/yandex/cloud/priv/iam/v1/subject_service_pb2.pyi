...
class GetOrCreateSubjectRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["attributes", b"attributes", "external_id", b"external_id", "federation_id", b"federation_id", "settings", b"settings", "subject_id", b"subject_id", "subject_type", b"subject_type"]) -> None: ...
...
class GetOrCreateSubjectResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["attributes", b"attributes", "created_at", b"created_at", "external_id", b"external_id", "federation_id", b"federation_id", "id", b"id", "new_subject_created", b"new_subject_created", "settings", b"settings", "subject_type", b"subject_type"]) -> None: ...
...
class MergeSubjectsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["destination_subject_id", b"destination_subject_id", "source_subject_id", b"source_subject_id"]) -> None: ...
...
class SubjectExternalIdentity(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["external_id", b"external_id", "federation_id", b"federation_id"]) -> None: ...
...
class SubjectIdentity(google.protobuf.message.Message):
    ...
    * both subject_id and external_identity are specified - lookup subject by id and external identity (both must match)
    ...
    def HasField(self, field_name: typing_extensions.Literal["external_identity", b"external_identity"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["external_identity", b"external_identity", "subject_id", b"subject_id", "subject_type", b"subject_type"]) -> None: ...
...
class SubjectDefinition(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["attributes_patch", b"attributes_patch", "settings_patch", b"settings_patch"]) -> None: ...
...
class SubjectModificationRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["definition", b"definition", "identity", b"identity"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["definition", b"definition", "identity", b"identity"]) -> None: ...
...
class BulkGetOrCreateSubjectsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["per_federation_quotas", b"per_federation_quotas", "requests", b"requests"]) -> None: ...
...
class BulkGetOrCreateSubjectsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["created_subjects", b"created_subjects", "existing_subjects", b"existing_subjects"]) -> None: ...
...
class BulkGetOrCreateSubjectsMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["subject_ids", b"subject_ids"]) -> None: ...
...
class BulkUpdateSubjectsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["requests", b"requests", "update_mask", b"update_mask"]) -> None: ...
...
class BulkUpdateSubjectsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["updated_subjects", b"updated_subjects"]) -> None: ...
...
class BulkCreateOrUpdateSubjectsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["update_mask", b"update_mask"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["per_federation_quotas", b"per_federation_quotas", "requests", b"requests", "update_mask", b"update_mask"]) -> None: ...
...
class BulkCreateOrUpdateSubjectsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["created_subjects", b"created_subjects", "updated_subjects", b"updated_subjects"]) -> None: ...
...
class BulkDeleteSubjectsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["identities", b"identities"]) -> None: ...
...
class BulkDeleteSubjectsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["deleted_subjects", b"deleted_subjects"]) -> None: ...
...
class BulkMergeSubjectsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["merge_into", b"merge_into"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["identities", b"identities", "merge_into", b"merge_into"]) -> None: ...
...
class BulkMergeSubjectsResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["merged_subject", b"merged_subject"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["merged_subject", b"merged_subject"]) -> None: ...
