...
class CheckProjectPermissionsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["allow_create_temporary_cluster", b"allow_create_temporary_cluster", "allow_use_permanent_cluster", b"allow_use_permanent_cluster"]) -> None: ...
...
class GetSparkConnectorRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["spark_connector_id", b"spark_connector_id"]) -> None: ...
...
class GetSparkConnectorForProjectRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["project_id", b"project_id", "spark_connector_id", b"spark_connector_id"]) -> None: ...
...
class CreateSparkConnectorRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["cluster", b"cluster", "permanent_cluster_id", b"permanent_cluster_id", "temporary_cluster_spec_name", b"temporary_cluster_spec_name"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cluster", b"cluster", "description", b"description", "labels", b"labels", "mode", b"mode", "name", b"name", "permanent_cluster_id", b"permanent_cluster_id", "project_id", b"project_id", "s3_access_key", b"s3_access_key", "s3_secret_key_secret_id", b"s3_secret_key_secret_id", "session_params", b"session_params", "temporary_cluster_spec_name", b"temporary_cluster_spec_name"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["cluster", b"cluster"]) -> typing_extensions.Literal["permanent_cluster_id", "temporary_cluster_spec_name"] | None: ...
...
class UpdateSparkConnectorRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["cluster", b"cluster", "permanent_cluster_id", b"permanent_cluster_id", "temporary_cluster_spec_name", b"temporary_cluster_spec_name", "update_mask", b"update_mask"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cluster", b"cluster", "description", b"description", "labels", b"labels", "mode", b"mode", "name", b"name", "permanent_cluster_id", b"permanent_cluster_id", "s3_access_key", b"s3_access_key", "s3_secret_key_secret_id", b"s3_secret_key_secret_id", "session_params", b"session_params", "spark_connector_id", b"spark_connector_id", "temporary_cluster_spec_name", b"temporary_cluster_spec_name", "update_mask", b"update_mask"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["cluster", b"cluster"]) -> typing_extensions.Literal["permanent_cluster_id", "temporary_cluster_spec_name"] | None: ...
