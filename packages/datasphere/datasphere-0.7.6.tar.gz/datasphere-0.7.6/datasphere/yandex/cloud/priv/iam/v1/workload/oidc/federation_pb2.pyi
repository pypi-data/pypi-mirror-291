...
class Federation(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["audiences", b"audiences", "created_at", b"created_at", "description", b"description", "enabled", b"enabled", "folder_id", b"folder_id", "id", b"id", "issuer", b"issuer", "jwks_url", b"jwks_url", "labels", b"labels", "name", b"name"]) -> None: ...
