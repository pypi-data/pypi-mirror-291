...
class SparkConnector(google.protobuf.message.Message):
    ...
    class PermanentCluster(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["bucket", b"bucket", "folder_id", b"folder_id", "id", b"id", "master_node_host", b"master_node_host", "name", b"name", "status", b"status", "version", b"version"]) -> None: ...
    ...
    class TemporaryCluster(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["folder_id", b"folder_id", "id", b"id", "master_node_host", b"master_node_host", "name", b"name", "spec", b"spec", "status", b"status", "version", b"version"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["cluster", b"cluster", "created_at", b"created_at", "permanent_cluster", b"permanent_cluster", "temporary_cluster", b"temporary_cluster", "updated_at", b"updated_at"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cluster", b"cluster", "created_at", b"created_at", "created_by_id", b"created_by_id", "description", b"description", "id", b"id", "labels", b"labels", "mode", b"mode", "name", b"name", "permanent_cluster", b"permanent_cluster", "project_id", b"project_id", "s3_access_key", b"s3_access_key", "s3_secret_key_secret_id", b"s3_secret_key_secret_id", "session_params", b"session_params", "spark_image_description", b"spark_image_description", "temporary_cluster", b"temporary_cluster", "updated_at", b"updated_at"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["cluster", b"cluster"]) -> typing_extensions.Literal["permanent_cluster", "temporary_cluster"] | None: ...
