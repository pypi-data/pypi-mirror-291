...
class ServiceProviderCertificate(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["not_after", b"not_after", "not_before", b"not_before"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["data", b"data", "federation_id", b"federation_id", "fingerprint", b"fingerprint", "not_after", b"not_after", "not_before", b"not_before"]) -> None: ...
