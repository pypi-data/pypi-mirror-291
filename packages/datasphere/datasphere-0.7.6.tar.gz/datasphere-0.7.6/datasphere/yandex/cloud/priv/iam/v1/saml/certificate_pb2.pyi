...
class Certificate(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "not_after", b"not_after", "not_before", b"not_before"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "data", b"data", "description", b"description", "federation_id", b"federation_id", "fingerprint", b"fingerprint", "id", b"id", "name", b"name", "not_after", b"not_after", "not_before", b"not_before"]) -> None: ...
