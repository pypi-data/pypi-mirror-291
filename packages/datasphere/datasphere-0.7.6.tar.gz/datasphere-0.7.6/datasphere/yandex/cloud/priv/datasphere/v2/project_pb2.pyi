...
class Project(google.protobuf.message.Message):
    ...
    class Settings(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["vm_inactivity_timeout", b"vm_inactivity_timeout"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["data_proc_cluster_id", b"data_proc_cluster_id", "default_dedicated_spec", b"default_dedicated_spec", "default_folder_id", b"default_folder_id", "early_access", b"early_access", "ide", b"ide", "ide_execution_mode", b"ide_execution_mode", "security_group_ids", b"security_group_ids", "service_account_id", b"service_account_id", "stale_exec_timeout_mode", b"stale_exec_timeout_mode", "subnet_id", b"subnet_id", "vm_inactivity_timeout", b"vm_inactivity_timeout"]) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["billing_account_id", b"billing_account_id", "budget_id", b"budget_id", "community_id", b"community_id", "created_at", b"created_at", "created_by_id", b"created_by_id", "description", b"description", "id", b"id", "labels", b"labels", "limits", b"limits", "name", b"name", "settings", b"settings", "zone_id", b"zone_id"]) -> None: ...
...
class InstanceSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cell_type", b"cell_type", "cost", b"cost", "cost_dedicated", b"cost_dedicated", "cpu_count", b"cpu_count", "currency", b"currency", "gpu_count", b"gpu_count", "gpu_type", b"gpu_type", "max_ram_gb", b"max_ram_gb", "min_ram_gb", b"min_ram_gb", "name", b"name"]) -> None: ...
...
class ProjectInstance(google.protobuf.message.Message):
    ...
    class ResourceUsage(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["cpu", b"cpu", "gpu", b"gpu", "gpu_mem_usage", b"gpu_mem_usage", "ram_total", b"ram_total", "ram_usage", b"ram_usage"]) -> None: ...
    ...
    class SparkCluster(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["name", b"name", "status", b"status", "type", b"type", "version", b"version"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "instance_spec", b"instance_spec", "resource_usage", b"resource_usage", "spark_cluster", b"spark_cluster", "spark_connector", b"spark_connector"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cell_type", b"cell_type", "created_at", b"created_at", "environment", b"environment", "id", b"id", "instance_spec", b"instance_spec", "path", b"path", "resource_usage", b"resource_usage", "running_cell_id", b"running_cell_id", "spark_cluster", b"spark_cluster", "spark_connector", b"spark_connector", "state", b"state"]) -> None: ...
