...
class UpdateJobStatusResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cluster_id", b"cluster_id", "job_id", b"job_id", "status", b"status"]) -> None: ...
...
class CreateSupportRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cluster_id", b"cluster_id", "cmd", b"cmd", "timeout", b"timeout"]) -> None: ...
...
class CreateSupportResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cluster_id", b"cluster_id", "cmd", b"cmd", "job_id", b"job_id"]) -> None: ...
