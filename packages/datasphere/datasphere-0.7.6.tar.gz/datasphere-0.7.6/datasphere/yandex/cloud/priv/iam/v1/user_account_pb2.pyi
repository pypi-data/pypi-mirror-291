...
class UserAccount(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["last_authenticated_at", b"last_authenticated_at", "oauth_user_account", b"oauth_user_account", "saml_user_account", b"saml_user_account", "user_account", b"user_account", "yandex_passport_user_account", b"yandex_passport_user_account"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["id", b"id", "last_authenticated_at", b"last_authenticated_at", "oauth_user_account", b"oauth_user_account", "saml_user_account", b"saml_user_account", "user_account", b"user_account", "yandex_passport_user_account", b"yandex_passport_user_account"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["user_account", b"user_account"]) -> typing_extensions.Literal["yandex_passport_user_account", "saml_user_account", "oauth_user_account"] | None: ...
...
class OAuthUserAccount(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["claims", b"claims", "federation_id", b"federation_id"]) -> None: ...
