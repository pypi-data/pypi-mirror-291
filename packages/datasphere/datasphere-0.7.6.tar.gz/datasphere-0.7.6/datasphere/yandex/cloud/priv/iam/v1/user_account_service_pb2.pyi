...
class GetSettingsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["response_json_path", b"response_json_path", "subject_id", b"subject_id"]) -> None: ...
...
class UpdateSettingsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["json_patch", b"json_patch", "response_json_path", b"response_json_path", "subject_id", b"subject_id"]) -> None: ...
...
class PresignUrlRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["parameters", b"parameters", "strings_to_sign", b"strings_to_sign", "subject_id", b"subject_id", "v2_parameters", b"v2_parameters", "v4_parameters", b"v4_parameters"]) -> None: ...
...
class PresignUrlResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["access_key_id", b"access_key_id", "signed_strings", b"signed_strings"]) -> None: ...
...
class SignedString(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["signature", b"signature", "string_to_sign", b"string_to_sign"]) -> None: ...
