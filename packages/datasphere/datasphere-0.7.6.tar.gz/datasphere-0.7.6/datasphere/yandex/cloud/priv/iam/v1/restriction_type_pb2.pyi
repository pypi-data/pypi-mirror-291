...
class RestrictionType(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["block_permissions", b"block_permissions", "id", b"id", "restriction_kind", b"restriction_kind", "type", b"type"]) -> None: ...
