...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _NODEALIAS.fields_by_name['name']._options = None
  _NODEALIAS.fields_by_name['name']._serialized_options = b'\250\2111\001'
  _NODEALIAS.fields_by_name['project_id']._options = None
  _NODEALIAS.fields_by_name['project_id']._serialized_options = b'\250\2111\001'
  _NODEALIAS.fields_by_name['created_at']._options = None
  _NODEALIAS.fields_by_name['created_at']._serialized_options = b'\250\2111\001'
  _NODEALIAS.fields_by_name['created_by_id']._options = None
  _NODEALIAS.fields_by_name['created_by_id']._serialized_options = b'\250\2111\001'
  _NODEALIAS.fields_by_name['backends']._options = None
  _NODEALIAS.fields_by_name['backends']._serialized_options = b'\250\2111\001'
  _NODEALIAS.fields_by_name['folder_id']._options = None
  _NODEALIAS.fields_by_name['folder_id']._serialized_options = b'\250\2111\001'
  _ACLFOLDERENTRY.fields_by_name['folder_id']._options = None
  _ACLFOLDERENTRY.fields_by_name['folder_id']._serialized_options = b'\250\2111\001'
  _HEADER.fields_by_name['name']._options = None
  _HEADER.fields_by_name['name']._serialized_options = b'\250\2111\001'
  _HEADER.fields_by_name['value']._options = None
  _HEADER.fields_by_name['value']._serialized_options = b'\250\2111\001'
  _BACKEND.fields_by_name['node_id']._options = None
  _BACKEND.fields_by_name['node_id']._serialized_options = b'\250\2111\001'
  _BACKEND.fields_by_name['weight']._options = None
  _BACKEND.fields_by_name['weight']._serialized_options = b'\272\2111\0050-100'
  _BACKENDS.fields_by_name['backend']._options = None
  _BACKENDS.fields_by_name['backend']._serialized_options = b'\302\2111\003>=1'
