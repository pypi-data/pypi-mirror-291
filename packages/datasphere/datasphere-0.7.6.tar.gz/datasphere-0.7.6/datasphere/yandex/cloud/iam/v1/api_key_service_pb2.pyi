...
class CreateApiKeyRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["description", b"description", "expires_at", b"expires_at", "scope", b"scope", "service_account_id", b"service_account_id"]) -> None: ...
