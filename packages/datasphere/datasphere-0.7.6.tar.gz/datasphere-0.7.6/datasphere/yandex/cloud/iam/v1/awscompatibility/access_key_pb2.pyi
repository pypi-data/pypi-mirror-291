...
class AccessKey(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "description", b"description", "id", b"id", "key_id", b"key_id", "last_used_at", b"last_used_at", "service_account_id", b"service_account_id"]) -> None: ...
