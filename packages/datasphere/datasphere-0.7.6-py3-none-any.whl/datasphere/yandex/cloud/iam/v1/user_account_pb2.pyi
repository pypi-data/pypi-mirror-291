...
class UserAccount(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["user_account", b"user_account"]) -> typing_extensions.Literal["yandex_passport_user_account", "saml_user_account"] | None: ...
