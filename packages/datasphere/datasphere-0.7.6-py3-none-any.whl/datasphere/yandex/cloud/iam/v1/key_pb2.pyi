...
class Key(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "last_used_at", b"last_used_at", "service_account_id", b"service_account_id", "subject", b"subject", "user_account_id", b"user_account_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "description", b"description", "id", b"id", "key_algorithm", b"key_algorithm", "last_used_at", b"last_used_at", "public_key", b"public_key", "service_account_id", b"service_account_id", "subject", b"subject", "user_account_id", b"user_account_id"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["subject", b"subject"]) -> typing_extensions.Literal["user_account_id", "service_account_id"] | None: ...
