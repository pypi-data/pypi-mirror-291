...
class Healthcheck(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["grpc", b"grpc", "healthcheck", b"healthcheck", "http", b"http", "interval", b"interval", "timeout", b"timeout"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["fails_threshold", b"fails_threshold", "grpc", b"grpc", "healthcheck", b"healthcheck", "healthcheck_port", b"healthcheck_port", "http", b"http", "interval", b"interval", "passes_threshold", b"passes_threshold", "timeout", b"timeout"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["healthcheck", b"healthcheck"]) -> typing_extensions.Literal["http", "grpc"] | None: ...
