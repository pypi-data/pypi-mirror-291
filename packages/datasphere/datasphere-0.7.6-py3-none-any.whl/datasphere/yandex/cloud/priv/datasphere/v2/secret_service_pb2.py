...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CREATESECRETREQUEST.fields_by_name['project_id']._options = None
  _CREATESECRETREQUEST.fields_by_name['project_id']._serialized_options = b'\250\2111\001\312\2111\004<=50'
  _CREATESECRETREQUEST.fields_by_name['name']._options = None
  _CREATESECRETREQUEST.fields_by_name['name']._serialized_options = b'\250\2111\001\262\2111&[a-zA-Z][-_a-zA-Z0-9]{1,61}[a-zA-Z0-9]\312\2111\004<=63'
  _CREATESECRETREQUEST.fields_by_name['description']._options = None
  _CREATESECRETREQUEST.fields_by_name['description']._serialized_options = b'\312\2111\005<=256'
  _CREATESECRETREQUEST.fields_by_name['labels']._options = None
  _CREATESECRETREQUEST.fields_by_name['labels']._serialized_options = b'\262\2111\013[-_0-9a-z]*\302\2111\004<=64\312\2111\004<=63\362\2111\030\022\020[a-z][-_0-9a-z]*\032\0041-63'
  ...
  _UPDATESECRETREQUEST.fields_by_name['secret_id']._serialized_options = b'\250\2111\001'
  _UPDATESECRETREQUEST.fields_by_name['name']._options = None
  _UPDATESECRETREQUEST.fields_by_name['name']._serialized_options = b'\262\2111&[a-zA-Z][-_a-zA-Z0-9]{1,61}[a-zA-Z0-9]\312\2111\004<=63'
  _UPDATESECRETREQUEST.fields_by_name['description']._options = None
  _UPDATESECRETREQUEST.fields_by_name['description']._serialized_options = b'\312\2111\005<=256'
  _UPDATESECRETREQUEST.fields_by_name['labels']._options = None
  _UPDATESECRETREQUEST.fields_by_name['labels']._serialized_options = b'\262\2111\013[-_0-9a-z]*\302\2111\004<=64\312\2111\004<=63\362\2111\030\022\020[a-z][-_0-9a-z]*\032\0041-63'
  _GETSECRETREQUEST.fields_by_name['secret_id']._options = None
  _GETSECRETREQUEST.fields_by_name['secret_id']._serialized_options = b'\250\2111\001\312\2111\004<=50'
  _DELETESECRETREQUEST.fields_by_name['secret_id']._options = None
  _DELETESECRETREQUEST.fields_by_name['secret_id']._serialized_options = b'\250\2111\001\312\2111\004<=50'
  _DECRYPTSECRETREQUEST.fields_by_name['secret_id']._options = None
  _DECRYPTSECRETREQUEST.fields_by_name['secret_id']._serialized_options = b'\250\2111\001\312\2111\004<=50'
  _LISTPROJECTSECRETSREQUEST.fields_by_name['project_id']._options = None
  _LISTPROJECTSECRETSREQUEST.fields_by_name['project_id']._serialized_options = b'\250\2111\001\312\2111\004<=50'
  _LISTSPACESECRETSREQUEST.fields_by_name['space_id']._options = None
  _LISTSPACESECRETSREQUEST.fields_by_name['space_id']._serialized_options = b'\250\2111\001\312\2111\004<=50'
  _SECRETSERVICE.methods_by_name['ListProject']._options = None
  _SECRETSERVICE.methods_by_name['ListProject']._serialized_options = b'\210\002\001'
  _SECRETSERVICE.methods_by_name['ListProjectSecrets']._options = None
  _SECRETSERVICE.methods_by_name['ListProjectSecrets']._serialized_options = b'\210\002\001'
  _SECRETSERVICE.methods_by_name['ListSpace']._options = None
  _SECRETSERVICE.methods_by_name['ListSpace']._serialized_options = b'\210\002\001'
