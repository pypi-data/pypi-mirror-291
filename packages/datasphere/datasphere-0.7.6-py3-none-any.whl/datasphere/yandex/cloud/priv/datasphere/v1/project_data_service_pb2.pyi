...
class FileMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["path", b"path", "project_id", b"project_id", "size_bytes", b"size_bytes"]) -> None: ...
...
class UploadFileRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["chunk", b"chunk", "message", b"message", "metadata", b"metadata"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["chunk", b"chunk", "message", b"message", "metadata", b"metadata"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["message", b"message"]) -> typing_extensions.Literal["metadata", "chunk"] | None: ...
...
class DownloadFileRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["file_path", b"file_path", "project_id", b"project_id"]) -> None: ...
