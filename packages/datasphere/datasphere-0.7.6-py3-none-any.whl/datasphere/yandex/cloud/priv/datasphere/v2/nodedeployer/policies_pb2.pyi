...
class Policies(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["availability_policy", b"availability_policy", "scale_policy", b"scale_policy"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["availability_policy", b"availability_policy", "scale_policy", b"scale_policy"]) -> None: ...
...
class AvailabilityPolicy(google.protobuf.message.Message):
    ...
    class ZoneAvailability(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["max_count", b"max_count", "min_count", b"min_count", "subnet_id", b"subnet_id", "zone_id", b"zone_id"]) -> None: ...
    ...
    class MaintenanceLimit(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["maintenance_limit", b"maintenance_limit"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["maintenance_limit", b"maintenance_limit"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["maintenance_limit", b"maintenance_limit", "zones", b"zones"]) -> None: ...
...
class ScalePolicy(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["policy", b"policy", "sessions_per_instance", b"sessions_per_instance"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["policy", b"policy", "sessions_per_instance", b"sessions_per_instance"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["policy", b"policy"]) -> typing_extensions.Literal["sessions_per_instance"] | None: ...
...
class SessionBasedScalePolicy(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["sessions_per_instance", b"sessions_per_instance"]) -> None: ...
