...
class RestrictionMeta(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["name", b"name", "value_type", b"value_type"]) -> None: ...
...
class Restriction(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["bool_value", b"bool_value", "long_value", b"long_value", "name", b"name", "string_value", b"string_value"]) -> None: ...
...
class GetRestrictionsMetaResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["restrictions_meta", b"restrictions_meta"]) -> None: ...
...
class RestrictionsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["restrictions", b"restrictions"]) -> None: ...
