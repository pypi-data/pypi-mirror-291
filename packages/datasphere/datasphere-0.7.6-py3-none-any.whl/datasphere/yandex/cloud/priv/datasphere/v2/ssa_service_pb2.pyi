...
class GetServiceAccountRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["project_id", b"project_id", "type", b"type"]) -> None: ...
...
class GetServiceAccountResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cloud_id", b"cloud_id", "empty", b"empty", "service_account", b"service_account", "type", b"type"]) -> None: ...
