...
class Project(google.protobuf.message.Message):
    ...
    class Settings(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["data_proc_cluster_id", b"data_proc_cluster_id", "default_folder_id", b"default_folder_id", "ide", b"ide", "ide_execution_mode", b"ide_execution_mode", "security_group_ids", b"security_group_ids", "service_account_id", b"service_account_id", "stale_exec_timeout_mode", b"stale_exec_timeout_mode", "subnet_id", b"subnet_id"]) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "description", b"description", "folder_id", b"folder_id", "id", b"id", "labels", b"labels", "limits", b"limits", "name", b"name", "settings", b"settings"]) -> None: ...
