...
from datasphere.yandex.cloud.priv.iam.v1.transitional import policy_service_pb2 as yandex_dot_cloud_dot_priv_dot_iam_dot_v1_dot_transitional_dot_policy__service__pb2
