...
class ListRefreshTokensForSubjectRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["client_id", b"client_id", "client_instance_id", b"client_instance_id", "filter", b"filter", "page_size", b"page_size", "page_token", b"page_token", "subject_id", b"subject_id"]) -> None: ...
...
class RefreshToken(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["client_id", b"client_id", "client_instance_id", b"client_instance_id", "created_at", b"created_at", "expire_at", b"expire_at", "id", b"id", "last_use_at", b"last_use_at", "protection_level", b"protection_level", "subject_id", b"subject_id"]) -> None: ...
