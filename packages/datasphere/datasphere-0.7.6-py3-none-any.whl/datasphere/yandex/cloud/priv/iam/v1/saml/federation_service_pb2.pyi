...
class ListFederationsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["cloud_id", b"cloud_id", "folder_id", b"folder_id", "scope", b"scope"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cloud_id", b"cloud_id", "filter", b"filter", "folder_id", b"folder_id", "page_size", b"page_size", "page_token", b"page_token", "scope", b"scope"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["scope", b"scope"]) -> typing_extensions.Literal["cloud_id", "folder_id"] | None: ...
