...
class Role(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["category_ids", b"category_ids", "description", b"description", "id", b"id", "is_system", b"is_system", "permission_ids", b"permission_ids"]) -> None: ...
