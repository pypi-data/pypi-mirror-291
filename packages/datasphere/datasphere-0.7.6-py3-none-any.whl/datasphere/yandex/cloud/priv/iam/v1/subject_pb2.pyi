...
class SubjectV2(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["attributes", b"attributes", "created_at", b"created_at", "external_id", b"external_id", "federation_id", b"federation_id", "modified_at", b"modified_at", "settings", b"settings", "subject_id", b"subject_id", "subject_type", b"subject_type"]) -> None: ...
