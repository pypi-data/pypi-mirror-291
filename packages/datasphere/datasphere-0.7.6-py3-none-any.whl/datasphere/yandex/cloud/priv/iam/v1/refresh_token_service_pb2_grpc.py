...
from datasphere.yandex.cloud.priv.iam.v1 import refresh_token_service_pb2 as yandex_dot_cloud_dot_priv_dot_iam_dot_v1_dot_refresh__token__service__pb2
