...
class FederatedCredential(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "external_subject_id", b"external_subject_id", "federation_id", b"federation_id", "id", b"id", "service_account_id", b"service_account_id"]) -> None: ...
