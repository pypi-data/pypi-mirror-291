...
class SetPermissionStagesRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["permission_stage_ids", b"permission_stage_ids", "resource_id", b"resource_id"]) -> None: ...
...
class UpdatePermissionStagesRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["add_permission_stage_ids", b"add_permission_stage_ids", "remove_permission_stage_ids", b"remove_permission_stage_ids", "resource_id", b"resource_id"]) -> None: ...
