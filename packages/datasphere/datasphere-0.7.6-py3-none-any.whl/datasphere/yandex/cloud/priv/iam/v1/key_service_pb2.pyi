...
class ListKeysRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["federated_user_id", b"federated_user_id", "format", b"format", "page_size", b"page_size", "page_token", b"page_token", "service_account_id", b"service_account_id", "user_account_id", b"user_account_id"]) -> None: ...
...
class CreateKeyRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["idle_deletion_period", b"idle_deletion_period"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["description", b"description", "federated_user_id", b"federated_user_id", "format", b"format", "idle_deletion_period", b"idle_deletion_period", "key_algorithm", b"key_algorithm", "key_id", b"key_id", "public_key", b"public_key", "service_account_id", b"service_account_id", "user_account_id", b"user_account_id"]) -> None: ...
...
class UpdateKeyRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["idle_deletion_period", b"idle_deletion_period", "update_mask", b"update_mask"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["description", b"description", "idle_deletion_period", b"idle_deletion_period", "key_id", b"key_id", "update_mask", b"update_mask"]) -> None: ...
