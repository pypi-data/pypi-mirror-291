...
class GetSubclusterRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cluster_id", b"cluster_id", "subcluster_id", b"subcluster_id"]) -> None: ...
...
class GetSubclusterAtRevisionRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cluster_id", b"cluster_id", "revision", b"revision", "subcluster_id", b"subcluster_id"]) -> None: ...
...
class ListSubclustersResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["next_page_token", b"next_page_token", "subclusters", b"subclusters"]) -> None: ...
...
class CreateSubclusterRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["autoscaling_config", b"autoscaling_config", "cluster_id", b"cluster_id", "hosts_count", b"hosts_count", "name", b"name", "resources", b"resources", "role", b"role", "subnet_id", b"subnet_id"]) -> None: ...
...
class UpdateSubclusterRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["autoscaling_config", b"autoscaling_config", "resources", b"resources", "update_mask", b"update_mask"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["assign_public_ip", b"assign_public_ip", "autoscaling_config", b"autoscaling_config", "cluster_id", b"cluster_id", "decommission_timeout", b"decommission_timeout", "hosts_count", b"hosts_count", "name", b"name", "resources", b"resources", "subcluster_id", b"subcluster_id", "update_mask", b"update_mask"]) -> None: ...
...
class DeleteSubclusterRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cluster_id", b"cluster_id", "decommission_timeout", b"decommission_timeout", "subcluster_id", b"subcluster_id"]) -> None: ...
