...
class Project(google.protobuf.message.Message):
    ...
    class Settings(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["data_proc_cluster_id", b"data_proc_cluster_id", "default_folder_id", b"default_folder_id", "early_access", b"early_access", "ide", b"ide", "ide_exec_mode", b"ide_exec_mode", "security_group_ids", b"security_group_ids", "service_account_id", b"service_account_id", "stale_exec_timeout_mode", b"stale_exec_timeout_mode", "subnet_id", b"subnet_id"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "settings", b"settings"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "description", b"description", "disk_size_gb", b"disk_size_gb", "folder_id", b"folder_id", "id", b"id", "labels", b"labels", "name", b"name", "settings", b"settings", "status", b"status", "zone_id", b"zone_id"]) -> None: ...
