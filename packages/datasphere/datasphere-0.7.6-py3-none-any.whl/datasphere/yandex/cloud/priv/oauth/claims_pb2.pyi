...
class SubjectClaims(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["federation", b"federation", "last_authenticated_at", b"last_authenticated_at", "yandex_claims", b"yandex_claims"]) -> builtins.bool: ...
