...
class GenerateAuthIntentRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["target_region_id", b"target_region_id"]) -> None: ...
...
class GenerateAuthIntentResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["auth_intent", b"auth_intent"]) -> None: ...
...
class CheckAuthIntentRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["auth_intent", b"auth_intent", "host", b"host"]) -> None: ...
...
class CheckAuthIntentResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["id_reference", b"id_reference"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["authorize_url", b"authorize_url", "id_reference", b"id_reference"]) -> None: ...
...
class SubjectReference(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["iss", b"iss", "sub", b"sub"]) -> None: ...
...
class AcceptEulaRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["cloud_agreements", b"cloud_agreements"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cloud_agreements", b"cloud_agreements", "cookie_header", b"cookie_header", "host", b"host"]) -> None: ...
...
class AcceptEulaResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["cloud_agreements", b"cloud_agreements"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cloud_agreements", b"cloud_agreements"]) -> None: ...
...
class YandexCloudAgreements(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["deny_notifications", b"deny_notifications", "eula", b"eula", "privacy_policy", b"privacy_policy"]) -> None: ...
...
class CheckSessionRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cookie_header", b"cookie_header", "federation_id", b"federation_id", "host", b"host"]) -> None: ...
...
class CheckSessionResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["cloud_user_info", b"cloud_user_info", "expires_at", b"expires_at", "iam_token", b"iam_token", "passport_session", b"passport_session", "subject_claims", b"subject_claims"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cloud_user_info", b"cloud_user_info", "expires_at", b"expires_at", "iam_token", b"iam_token", "passport_session", b"passport_session", "subject_claims", b"subject_claims"]) -> None: ...
...
class CheckPassportSessionRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["client_id", b"client_id", "cookie_header", b"cookie_header", "host", b"host"]) -> None: ...
...
class CheckPassportSessionResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["iam_token", b"iam_token", "subject_claims", b"subject_claims"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["iam_token", b"iam_token", "subject_claims", b"subject_claims"]) -> None: ...
...
class GetOpenIDConfigurationResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["authorization_endpoint", b"authorization_endpoint", "logout_endpoint", b"logout_endpoint", "revocation_endpoint", b"revocation_endpoint", "token_endpoint", b"token_endpoint", "userinfo_endpoint", b"userinfo_endpoint"]) -> None: ...
...
class CreateSessionRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["access_token", b"access_token", "cookie_header", b"cookie_header", "domain", b"domain"]) -> None: ...
...
class CreateSessionResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["expires_at", b"expires_at", "set_cookie_header", b"set_cookie_header"]) -> None: ...
...
class LogoutRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cookie_header", b"cookie_header", "domain", b"domain"]) -> None: ...
...
class LogoutResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["subject", b"subject", "subject_claims", b"subject_claims"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["set_cookie_header", b"set_cookie_header", "subject", b"subject", "subject_claims", b"subject_claims"]) -> None: ...
...
class AuthorizationRequired(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["authorize_url", b"authorize_url"]) -> None: ...
