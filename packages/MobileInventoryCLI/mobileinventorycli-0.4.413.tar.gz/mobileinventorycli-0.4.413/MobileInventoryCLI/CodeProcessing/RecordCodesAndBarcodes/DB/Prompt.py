...
'''
            ...
            if PRESET_UPC_LEN != None and len(cmd) == PRESET_UPC_LEN:
                try:
                    ...
                    use=Prompt.__init2__(None,func=Mbool,ptext=f"{Back.dark_red_1}{Fore.white}len({len(cmd)})-> A UPCA({cmd}) Code was Entered, use it?{Style.reset}",helpText="yes or no",data="boolean")
                    if use in [True,None]:
                        pass
                    elif use in [False,]:
                        continue
...
'''
            ...
            if PRESET_UPCA11_LEN != None and len(cmd) == PRESET_UPCA11_LEN:
                try:
                    ...
                    use=Prompt.__init2__(None,func=Mbool,ptext=f"{Back.dark_red_1}{Fore.white}len({len(cmd)})-> A UPCA({cmd}) Code was Entered, use it?{Style.reset}",helpText="yes or no",data="boolean_basic")
                    if use in [True,]:
                        code=UPCA11
                    elif use in [None,]:
                        pass
