...
class IdeaDevelopment:
    ...
    def initial_setup(self, files, role):
        ...
        system_prompt = (
            f"You are a senior {role}. Analyze the provided project files and create a detailed core purely technical development and feature plan to achieve the user request that fits with the current project setup. Focus on the following:\n\n"
