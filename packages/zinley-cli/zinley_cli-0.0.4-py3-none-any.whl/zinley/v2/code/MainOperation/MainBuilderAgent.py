...
class MainBuilderAgent:
    ...
    async def get_pipeline_plan(self, session, files, tree):
        """
            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "3. Use pipeline 3 if the project cannot be built, such as HTML/CSS or other similar cases.\n"
    ...
    async def get_pipeline_plans(self, files, tree):
        """
        ...
        async with aiohttp.ClientSession() as session:
            plan = await self.get_pipeline_plan(session, files, all_file_contents)
            return plan
