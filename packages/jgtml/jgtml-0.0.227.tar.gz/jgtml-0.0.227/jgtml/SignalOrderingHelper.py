...
def create_fdb_entry_order(i,signal_bar,current_bar,lots=1,tick_shift=2,quiet=True,valid_gator_mouth_open_in_mouth=False,validate_signal_out_of_mouth=True,t=None,validation_timestamp=None,verbose_level=0):
  ...
  if fdb_sig==1:
    ...
    if not quiet or verbose_level>1:
  ...
  output_script = generate_entry_order_script(lots, entry_rate, stop_rate, i, bs,tlid_id=tlid_id,t=t,validation_timestamp_str=validation_timestamp_str)
  
  o = build_order_result_object(lots, entry_rate, stop_rate, bs, tlid_id, output_script,i,t)
