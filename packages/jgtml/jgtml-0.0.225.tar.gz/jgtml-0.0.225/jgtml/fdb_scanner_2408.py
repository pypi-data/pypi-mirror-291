...
def main():
  ...
  all_signals={}
  all_signals_filepath=_make_cached_filepath("fdb_signals_",tlid.get_minutes(),suffix="_all_signals",ext="json",subdir="signals")
  all_signals_filepath_bash=all_signals_filepath.replace(".json",".sh")
  print("BashSignalsDropPath:",all_signals_filepath_bash)
  ...
  for i in instruments:
    ...
    for t in timeframes:
      ...
      o=create_fdb_entry_order(i,signal_bar,current_bar,lots=lots,t=t,
                                          ...
                                          valid_sig_out_mouth=valid_sig_out_mouth,validation_timestamp=validation_timestamp,quiet=quiet,verbose_level=verbose_level)
      if o is not None:
        sh=o["sh"]
        #output_string+="\n"
        #output_string+="\n----\n"
