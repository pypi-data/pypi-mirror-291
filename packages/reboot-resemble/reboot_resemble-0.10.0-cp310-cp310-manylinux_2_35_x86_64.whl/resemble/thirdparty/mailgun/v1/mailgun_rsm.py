...
import resemble.thirdparty.mailgun.v1.mailgun_pb2
import resemble.thirdparty.mailgun.v1.mailgun_pb2_grpc
...
from resemble.thirdparty.mailgun.v1.mailgun_pb2 import (
    SendRequest,
    SendResponse,
    SendTaskRequest,
    SendTaskResponse,
...
class MessageServicerMiddleware(resemble.aio.internals.middleware.Middleware):
    ...
    def __init__(
        ...
        *,
        ...
        self.request_type_by_method_name: dict[str, type[google.protobuf.message.Message]] = {
            'Send': resemble.thirdparty.mailgun.v1.mailgun_pb2.SendRequest,
            'SendTask': resemble.thirdparty.mailgun.v1.mailgun_pb2.SendTaskRequest,
        }
        ...
        if self._token_verifier is not None and self._authorizer is None:
            raise RuntimeError(
                ...
                f"'resemble.thirdparty.mailgun.v1.Message'"
            )


    def add_to_server(self, server: grpc.aio.Server) -> None:
        resemble.thirdparty.mailgun.v1.mailgun_pb2_grpc.add_MessageInterfaceServicer_to_server(
            self, server
        )
    ...
    async def react_mutate(
        ...
        if method == 'Send':
            request = resemble.thirdparty.mailgun.v1.mailgun_pb2.SendRequest()
            ...
            while True:
                ...
                stub = resemble.thirdparty.mailgun.v1.mailgun_pb2_grpc.MessageInterfaceStub(
            ...
            request = resemble.thirdparty.mailgun.v1.mailgun_pb2.SendTaskRequest()
            request.ParseFromString(request_bytes)
        ...
        *,
        ...
        if 'Send' == task.method_name:
            if only_validate:
                ...
                return resemble.thirdparty.mailgun.v1.mailgun_pb2.SendResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (MessageWorkflowStub(
                            ...
                            typing.cast(resemble.thirdparty.mailgun.v1.mailgun_pb2.SendRequest, task.request),
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return resemble.thirdparty.mailgun.v1.mailgun_pb2.SendTaskResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (MessageWorkflowStub(
                            ...
                            typing.cast(resemble.thirdparty.mailgun.v1.mailgun_pb2.SendTaskRequest, task.request),
                            bearer_token=__internal_magic_token__,
                            idempotency=resemble.aio.idempotency.Idempotency(
                                alias=f'Task {task.task_id.task_uuid}',
                            ),
    ...
    async def __Send(
        ...
        state: resemble.thirdparty.mailgun.v1.mailgun_pb2.Message,
        request: resemble.thirdparty.mailgun.v1.mailgun_pb2.SendRequest,
        *,
        validating_effects: bool,
    ) -> Message.SendEffects:
        try:
            ...
            assert_type(
                response,
                [
                    resemble.thirdparty.mailgun.v1.mailgun_pb2.SendResponse,
                ],
            )
            ...
            if isinstance(aborted, resemble.aio.aborted.SystemAborted):
                ...
                if not NODEJS:
                    logger.warning(
                        f"Unhandled (in 'resemble.thirdparty.mailgun.v1.Message.Send') {aborted}; propagating as 'Unknown'\n" +
                ...
                raise resemble.aio.aborted.SystemAborted(
                    ...
                    # information.
                    message=f"unhandled (in 'resemble.thirdparty.mailgun.v1.Message.Send') {aborted}"
                )
            else:
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'resemble.thirdparty.mailgun.v1.Message.Send') {aborted}"
                        )
                elif (
            ...
            if not NODEJS:
                logger.warning(
                    f"Unhandled (in 'resemble.thirdparty.mailgun.v1.Message.Send') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
            ...
            raise resemble.aio.aborted.SystemAborted(
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'resemble.thirdparty.mailgun.v1.Message.Send') {type(exception).__name__}: {exception}"
            )
    ...
    async def _Send(
        ...
        *,
        ...
        if idempotent_mutation is not None:
            response = resemble.thirdparty.mailgun.v1.mailgun_pb2.SendResponse()
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                await self._maybe_authorize(
                    method_name=
                    'resemble.thirdparty.mailgun.v1.Message.Send',
    ...
    async def _schedule_Send(
        ...
        *,
        ...
        headers: resemble.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[resemble.aio.contexts.WriterContext, resemble.thirdparty.mailgun.v1.mailgun_pb2.SendResponse]:
    ...
    async def Send(
        ...
        if authoritative_consensus != self.consensus_id:
            ...
            stub = resemble.thirdparty.mailgun.v1.mailgun_pb2_grpc.MessageInterfaceStub(channel)
            call = stub.Send(
                request=request,
        ...
        *,
        ...
        try:
            ...
            assert_type(
                response,
                [
                    resemble.thirdparty.mailgun.v1.mailgun_pb2.SendTaskResponse,
                ],
            )
            # TODO: retrying a control loop might cause an effect
            # validation retry to either "hang" or "do more
            ...
            if isinstance(aborted, resemble.aio.aborted.SystemAborted):
                ...
                if not NODEJS:
                    logger.warning(
                        f"Unhandled (in 'resemble.thirdparty.mailgun.v1.Message.SendTask') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(traceback.format_exception(aborted))
                    )
                raise resemble.aio.aborted.SystemAborted(
                    resemble.v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'resemble.thirdparty.mailgun.v1.Message.SendTask') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'resemble.thirdparty.mailgun.v1.Message.SendTask') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if not NODEJS:
                logger.warning(
                    f"Unhandled (in 'resemble.thirdparty.mailgun.v1.Message.SendTask') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
                    ''.join(traceback.format_exception(exception))
                )
            raise resemble.aio.aborted.SystemAborted(
                resemble.v1alpha1.errors_pb2.Unknown(),
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'resemble.thirdparty.mailgun.v1.Message.SendTask') {type(exception).__name__}: {exception}"
            )
    ...
    async def _SendTask(
        ...
        *,
        ...
        if idempotent_mutation is not None:
            response = resemble.thirdparty.mailgun.v1.mailgun_pb2.SendTaskResponse()
            response.ParseFromString(idempotent_mutation.response)
            return response
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                await self._maybe_authorize(
                    method_name=
                    'resemble.thirdparty.mailgun.v1.Message.SendTask',
                    headers=context._headers,
                    auth=context.auth,
                    state=state,
                    request=request,
    ...
    async def _schedule_SendTask(
        ...
        *,
        ...
        headers: resemble.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[resemble.aio.contexts.WriterContext, resemble.thirdparty.mailgun.v1.mailgun_pb2.SendTaskResponse]:
        context: resemble.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            context_type=resemble.aio.contexts.WriterContext,
        )
...
class _MessageStub(resemble.aio.stubs.Stub):
    ...
    __service_name__ = resemble.aio.types.ServiceName('resemble.thirdparty.mailgun.v1.MessageInterface')
    ...
    def __init__(
        ...
        *,
        ...
        self._stub = resemble.thirdparty.mailgun.v1.mailgun_pb2_grpc.MessageInterfaceStub(channel)
        ...
        *,
        ...
        with self._idempotency_manager.idempotently(
            ...
            async with self._call(
                ...
                unary=True,
                reader=False,
                response_type=resemble.thirdparty.mailgun.v1.mailgun_pb2.SendResponse,
                aborted_type=Message.SendAborted,
                metadata=metadata,
        ...
        *,
        ...
        with self._idempotency_manager.idempotently(
            ...
            async with self._call(
                ...
                unary=True,
                reader=False,
                response_type=resemble.thirdparty.mailgun.v1.mailgun_pb2.SendTaskResponse,
                aborted_type=Message.SendTaskAborted,
                metadata=metadata,
                idempotency_key=idempotency_key,
                bearer_token=bearer_token,
...
MessageStateType: typing.TypeAlias = resemble.thirdparty.mailgun.v1.mailgun_pb2.Message
MessageRequestTypes: typing.TypeAlias = \
        resemble.thirdparty.mailgun.v1.mailgun_pb2.SendRequest \
        | resemble.thirdparty.mailgun.v1.mailgun_pb2.SendTaskRequest
...
class MessageAuthorizer(
    ...
    async def authorize(
        ...
        *,
        ...
        if method_name == 'resemble.thirdparty.mailgun.v1.Message.Send':
            return await self.Send(
                context,
                typing.cast(resemble.thirdparty.mailgun.v1.mailgun_pb2.SendRequest, request),
            )
        elif method_name == 'resemble.thirdparty.mailgun.v1.Message.SendTask':
            return await self.SendTask(
                context,
                typing.cast(resemble.thirdparty.mailgun.v1.mailgun_pb2.Message, state),
                typing.cast(resemble.thirdparty.mailgun.v1.mailgun_pb2.SendTaskRequest, request),
            )
        else:
...
class MessageServicer(resemble.aio.servicers.Servicer):
    ...
    __service_name__ = resemble.aio.types.ServiceName('resemble.thirdparty.mailgun.v1.MessageInterface')
    __state_type_name__ = resemble.aio.types.StateTypeName('resemble.thirdparty.mailgun.v1.Message')
    __state_type__ = resemble.thirdparty.mailgun.v1.mailgun_pb2.Message
    __file_descriptor__ = resemble.thirdparty.mailgun.v1.mailgun_pb2.DESCRIPTOR
    ...
    class Effects(resemble.aio.state_managers.Effects):
        def __init__(
            ...
            *,
            ...
            assert_type(state, [resemble.thirdparty.mailgun.v1.mailgun_pb2.Message])
    ...
    class SendEffects(Effects):
        def __init__(
            ...
            *,
            ...
            assert_type(state, [resemble.thirdparty.mailgun.v1.mailgun_pb2.Message])
            assert_type(response, [resemble.thirdparty.mailgun.v1.mailgun_pb2.SendResponse])
    ...
    class SendTaskEffects(Effects):
        def __init__(
            ...
            *,
            ...
            assert_type(state, [resemble.thirdparty.mailgun.v1.mailgun_pb2.Message])
            assert_type(response, [resemble.thirdparty.mailgun.v1.mailgun_pb2.SendTaskResponse])
    ...
    ) -> resemble.thirdparty.mailgun.v1.mailgun_pb2.Message:
...
class Message:
    ...
    State: typing.TypeAlias = resemble.thirdparty.mailgun.v1.mailgun_pb2.Message
    ...
    class SendFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, resemble.thirdparty.mailgun.v1.mailgun_pb2.SendResponse]:
            """Awaits for task to finish and returns it's response."""

            async def wait_for_task() -> resemble.thirdparty.mailgun.v1.mailgun_pb2.SendResponse:
                ...
                try:
                    ...
                    if (
                        ...
                        raise resemble.aio.aborted.SystemAborted(
                            ...
                            "but expecting type 'resemble.thirdparty.mailgun.v1.mailgun_pb2.SendResponse'; "
    ...
    class SendTaskFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, resemble.thirdparty.mailgun.v1.mailgun_pb2.SendTaskResponse]:
            """Awaits for task to finish and returns it's response."""

            async def wait_for_task() -> resemble.thirdparty.mailgun.v1.mailgun_pb2.SendTaskResponse:
                channel = self._channel_manager.get_channel_from_state_type_name(
                    self._task_id.state_type,
                    resemble.aio.types.StateRef(self._task_id.state_ref),
                )
                ...
                try:
                    ...
                    if (
                        ...
                        raise resemble.aio.aborted.SystemAborted(
                            ...
                            f"task with UUID {str(uuid.UUID(bytes=self._task_id.task_uuid))} "
                            f"has a response of type '{response_or_error.TypeName()}' "
                            "but expecting type 'resemble.thirdparty.mailgun.v1.mailgun_pb2.SendTaskResponse'; "
                            "are you waiting on a task of the correct method?",
                        ) from None
    ...
    class WeakReference(typing.Generic[Message_ScheduleTypeVar]):
        ...
        def reactively(self):
            return Message.WeakReference._Reactively(
                service_name=resemble.aio.types.ServiceName('resemble.thirdparty.mailgun.v1.MessageInterface'),
                state_ref=self._state_ref,
                bearer_token=self._bearer_token,
            )
        ...
        class _Idempotently(typing.Generic[Message_IdempotentlyScheduleTypeVar]):
            ...
            async def SendTask(
                ...
                __options__: resemble.aio.call.Options = resemble.aio.call.Options(),
                *,
                send_request: typing.Optional[resemble.thirdparty.mailgun.v1.mailgun_pb2.SendRequest] = None,
            ) -> resemble.thirdparty.mailgun.v1.mailgun_pb2.SendTaskResponse:
                if __options__.idempotency is not None:
                    raise RuntimeError(
                        'Found redundant idempotency in `Options`'
        ...
        class _Schedule:
            ...
            def __init__(
                self,
                tasks: typing.Callable[[resemble.aio.contexts.TransactionContext | resemble.aio.contexts.WorkflowContext | resemble.aio.external.ExternalContext], MessageTasksStub],
                *,
                when: typing.Optional[datetime | timedelta] = None,
                idempotency: typing.Optional[resemble.aio.idempotency.Idempotency] = None,
            ) -> None:
                ...
                *,
                ...
                if send_request is not None and not isinstance(
                    ...
                    raise TypeError(
                        ...
                        f"'resemble.thirdparty.mailgun.v1.mailgun_pb2.SendTaskRequest': field 'send_request' is not "
                        f"of required type 'resemble.thirdparty.mailgun.v1.mailgun_pb2.SendRequest'"
                    )
                ...
                if isinstance(__context__, resemble.aio.contexts.TransactionContext):
                    return resemble.aio.tasks.TaskEffect(
                        service_name=resemble.aio.types.ServiceName(
                            'resemble.thirdparty.mailgun.v1.MessageInterface'
                        ),
    ...
    async def _Send(
        ...
        *,
    ...
    ) -> tuple[Message.WeakReference, resemble.thirdparty.mailgun.v1.mailgun_pb2.SendResponse]:
        if recipient is not None and not isinstance(
            ...
            raise TypeError(
                f"Can not construct protobuf message of type "
                f"'resemble.thirdparty.mailgun.v1.mailgun_pb2.SendRequest': field 'recipient' is not "
        ...
        if sender is not None and not isinstance(
            ...
            raise TypeError(
                f"Can not construct protobuf message of type "
                f"'resemble.thirdparty.mailgun.v1.mailgun_pb2.SendRequest': field 'sender' is not "
                f"of required type 'str'"
            )
        if subject is not None and not isinstance(
            ...
            raise TypeError(
                f"Can not construct protobuf message of type "
                f"'resemble.thirdparty.mailgun.v1.mailgun_pb2.SendRequest': field 'subject' is not "
                f"of required type 'str'"
            )
        if domain is not None and not isinstance(
            ...
            raise TypeError(
                f"Can not construct protobuf message of type "
                f"'resemble.thirdparty.mailgun.v1.mailgun_pb2.SendRequest': field 'domain' is not "
                f"of required type 'str'"
            )
        if text is not None and not isinstance(
            ...
            raise TypeError(
                f"Can not construct protobuf message of type "
                f"'resemble.thirdparty.mailgun.v1.mailgun_pb2.SendRequest': field 'text' is not "
                f"of required type 'str'"
            )
        if html is not None and not isinstance(
            ...
            raise TypeError(
                f"Can not construct protobuf message of type "
                f"'resemble.thirdparty.mailgun.v1.mailgun_pb2.SendRequest': field 'html' is not "
                f"of required type 'str'"
            )
        # TODO: mypy-protobuf declares that
        # `google.protobuf.message.Message` constructor arguments are
