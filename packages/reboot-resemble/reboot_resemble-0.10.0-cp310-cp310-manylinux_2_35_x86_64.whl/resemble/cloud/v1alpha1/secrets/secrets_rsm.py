...
class Secret:
    ...
    class WeakReference(typing.Generic[Secret_ScheduleTypeVar]):
        ...
        class _Schedule:
            ...
            def __init__(
                self,
                tasks: typing.Callable[[resemble.aio.contexts.TransactionContext | resemble.aio.contexts.WorkflowContext | resemble.aio.external.ExternalContext], SecretTasksStub],
                *,
                when: typing.Optional[datetime | timedelta] = None,
                idempotency: typing.Optional[resemble.aio.idempotency.Idempotency] = None,
            ) -> None:
