...
class APIKeyServicerMiddleware(resemble.aio.internals.middleware.Middleware):
    ...
    async def react_mutate(
        ...
        if method == 'Create':
            ...
            while True:
                ...
                stub = resemble.cloud.v1alpha1.auth.auth_pb2_grpc.APIKeyInterfaceStub(
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (APIKeyWorkflowStub(
                            ...
                            typing.cast(resemble.cloud.v1alpha1.auth.auth_pb2.CreateRequest, task.request),
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (APIKeyWorkflowStub(
                            ...
                            typing.cast(resemble.cloud.v1alpha1.auth.auth_pb2.RevokeRequest, task.request),
                            bearer_token=__internal_magic_token__,
                            idempotency=resemble.aio.idempotency.Idempotency(
                                alias=f'Task {task.task_id.task_uuid}',
                            ),
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (APIKeyWorkflowStub(
                            ...
                            typing.cast(resemble.cloud.v1alpha1.auth.auth_pb2.AuthenticateRequest, task.request),
                            bearer_token=__internal_magic_token__,
                        ))
    ...
    async def _schedule_Create(
        ...
        *,
        ...
        headers: resemble.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[resemble.aio.contexts.WriterContext, resemble.cloud.v1alpha1.auth.auth_pb2.CreateResponse]:
    ...
    async def Create(
        ...
        if authoritative_consensus != self.consensus_id:
            ...
            stub = resemble.cloud.v1alpha1.auth.auth_pb2_grpc.APIKeyInterfaceStub(channel)
            call = stub.Create(
                request=request,
    ...
    async def _schedule_Revoke(
        ...
        *,
        ...
        headers: resemble.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[resemble.aio.contexts.WriterContext, resemble.cloud.v1alpha1.auth.auth_pb2.RevokeResponse]:
        context: resemble.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            context_type=resemble.aio.contexts.WriterContext,
        )
    ...
    async def _schedule_Authenticate(
        ...
        *,
        ...
        headers: resemble.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[resemble.aio.contexts.WriterContext, resemble.cloud.v1alpha1.auth.auth_pb2.AuthenticateResponse]:
        context: resemble.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            context_type=resemble.aio.contexts.WriterContext,
        )
...
class _APIKeyStub(resemble.aio.stubs.Stub):

    __service_name__ = resemble.aio.types.ServiceName('resemble.cloud.v1alpha1.auth.APIKeyInterface')
...
APIKeyStateType: typing.TypeAlias = resemble.cloud.v1alpha1.auth.auth_pb2.APIKey
        ...
        *,
        ...
        if method_name == 'resemble.cloud.v1alpha1.auth.APIKey.Create':
            return await self.Create(
                context,
                typing.cast(resemble.cloud.v1alpha1.auth.auth_pb2.CreateRequest, request),
            )
        elif method_name == 'resemble.cloud.v1alpha1.auth.APIKey.Revoke':
            return await self.Revoke(
                context,
                typing.cast(resemble.cloud.v1alpha1.auth.auth_pb2.APIKey, state),
                typing.cast(resemble.cloud.v1alpha1.auth.auth_pb2.RevokeRequest, request),
            )
        elif method_name == 'resemble.cloud.v1alpha1.auth.APIKey.Authenticate':
            return await self.Authenticate(
                context,
                typing.cast(resemble.cloud.v1alpha1.auth.auth_pb2.APIKey, state),
                typing.cast(resemble.cloud.v1alpha1.auth.auth_pb2.AuthenticateRequest, request),
            )
        else:
...
class APIKeyServicer(resemble.aio.servicers.Servicer):
    Authorizer: typing.TypeAlias = APIKeyAuthorizer

    __service_name__ = resemble.aio.types.ServiceName('resemble.cloud.v1alpha1.auth.APIKeyInterface')
    __state_type_name__ = resemble.aio.types.StateTypeName('resemble.cloud.v1alpha1.auth.APIKey')
...
class APIKey:
    ...
    State: typing.TypeAlias = resemble.cloud.v1alpha1.auth.auth_pb2.APIKey
    ...
    class CreateFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, resemble.cloud.v1alpha1.auth.auth_pb2.CreateResponse]:
    ...
    class RevokeFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, resemble.cloud.v1alpha1.auth.auth_pb2.RevokeResponse]:
            """Awaits for task to finish and returns it's response."""
    ...
    class AuthenticateFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, resemble.cloud.v1alpha1.auth.auth_pb2.AuthenticateResponse]:
            """Awaits for task to finish and returns it's response."""
    ...
    class WeakReference(typing.Generic[APIKey_ScheduleTypeVar]):
        ...
        class _Reactively:
            ...
            ) -> typing.AsyncIterator[resemble.cloud.v1alpha1.auth.auth_pb2.AuthenticateResponse]:
        ...
        def reactively(self):
            return APIKey.WeakReference._Reactively(
                service_name=resemble.aio.types.ServiceName('resemble.cloud.v1alpha1.auth.APIKeyInterface'),
                state_ref=self._state_ref,
                bearer_token=self._bearer_token,
            )
        ...
        class _Schedule:
            ...
            def __init__(
                self,
                tasks: typing.Callable[[resemble.aio.contexts.TransactionContext | resemble.aio.contexts.WorkflowContext | resemble.aio.external.ExternalContext], APIKeyTasksStub],
                *,
                when: typing.Optional[datetime | timedelta] = None,
                idempotency: typing.Optional[resemble.aio.idempotency.Idempotency] = None,
            ) -> None:
            ...
            async def Revoke(
                ...
                __context__: resemble.aio.contexts.TransactionContext | resemble.aio.contexts.WorkflowContext | resemble.aio.external.ExternalContext,
                __options__: typing.Optional[resemble.aio.call.Options] = None,
            ) -> resemble.aio.tasks.TaskEffect | APIKey.RevokeFuture:
                # TODO: mypy-protobuf declares that
                # `google.protobuf.message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                request = resemble.cloud.v1alpha1.auth.auth_pb2.RevokeRequest(
                ...
                if isinstance(__context__, resemble.aio.contexts.TransactionContext):
                    return resemble.aio.tasks.TaskEffect(
                        service_name=resemble.aio.types.ServiceName(
                            'resemble.cloud.v1alpha1.auth.APIKeyInterface'
                        ),
            ...
            async def Authenticate(
                ...
                *,
                secret: typing.Optional[str] = None,
            ) -> resemble.aio.tasks.TaskEffect | APIKey.AuthenticateFuture:
