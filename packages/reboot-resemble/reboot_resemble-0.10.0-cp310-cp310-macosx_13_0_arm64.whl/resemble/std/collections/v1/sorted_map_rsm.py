...
import resemble.std.collections.v1.sorted_map_pb2
import resemble.std.collections.v1.sorted_map_pb2_grpc
import resemble.v1alpha1.options_pb2
# Additionally re-export all messages and enums from the pb2 module.
from resemble.std.collections.v1.sorted_map_pb2 import (
    Entry,
    InsertRequest,
    InsertResponse,
    RangeRequest,
...
class SortedMapServicerMiddleware(resemble.aio.internals.middleware.Middleware):
    ...
    def __init__(
        ...
        *,
        ...
        self.request_type_by_method_name: dict[str, type[google.protobuf.message.Message]] = {
            'Insert': resemble.std.collections.v1.sorted_map_pb2.InsertRequest,
            'Remove': resemble.std.collections.v1.sorted_map_pb2.RemoveRequest,
            'Range': resemble.std.collections.v1.sorted_map_pb2.RangeRequest,
        }
        ...
        if self._token_verifier is not None and self._authorizer is None:
            raise RuntimeError(
                ...
                f"'resemble.std.collections.v1.SortedMap'"
            )


    def add_to_server(self, server: grpc.aio.Server) -> None:
        resemble.std.collections.v1.sorted_map_pb2_grpc.add_SortedMapInterfaceServicer_to_server(
            self, server
        )
    ...
    async def react_query(
        ...
        if method == 'Insert':
            ...
            try:
                ...
                request = resemble.std.collections.v1.sorted_map_pb2.RangeRequest()
                ...
                async with self._state_manager.reactively(
                    ...
                    async for (state, idempotency_keys) in states:
                        ...
                        await self._maybe_authorize(
                            method_name=
                            'resemble.std.collections.v1.SortedMap.Range',
                            headers=headers,
                            auth=context.auth,
                            state=state,
                            request=request,
    ...
    async def react_mutate(
        ...
        if method == 'Insert':
            request = resemble.std.collections.v1.sorted_map_pb2.InsertRequest()
            request.ParseFromString(request_bytes)
            ...
            while True:
                ...
                stub = resemble.std.collections.v1.sorted_map_pb2_grpc.SortedMapInterfaceStub(
            ...
            request = resemble.std.collections.v1.sorted_map_pb2.RemoveRequest()
            request.ParseFromString(request_bytes)
        ...
        *,
        ...
        if 'Insert' == task.method_name:
            if only_validate:
                ...
                return resemble.std.collections.v1.sorted_map_pb2.InsertResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (SortedMapWorkflowStub(
                            ...
                            typing.cast(resemble.std.collections.v1.sorted_map_pb2.InsertRequest, task.request),
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return resemble.std.collections.v1.sorted_map_pb2.RemoveResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (SortedMapWorkflowStub(
                            ...
                            typing.cast(resemble.std.collections.v1.sorted_map_pb2.RemoveRequest, task.request),
                            bearer_token=__internal_magic_token__,
                            idempotency=resemble.aio.idempotency.Idempotency(
                                alias=f'Task {task.task_id.task_uuid}',
                            ),
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return resemble.std.collections.v1.sorted_map_pb2.RangeResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (SortedMapWorkflowStub(
                            ...
                            typing.cast(resemble.std.collections.v1.sorted_map_pb2.RangeRequest, task.request),
                            bearer_token=__internal_magic_token__,
                        ))
    ...
    async def __Insert(
        ...
        state: resemble.std.collections.v1.sorted_map_pb2.SortedMap,
        request: resemble.std.collections.v1.sorted_map_pb2.InsertRequest,
        *,
        validating_effects: bool,
        ...
        try:
            ...
            assert_type(
                response,
                [
                    resemble.std.collections.v1.sorted_map_pb2.InsertResponse,
                ],
            )
            ...
            if isinstance(aborted, resemble.aio.aborted.SystemAborted):
                ...
                if not NODEJS:
                    logger.warning(
                        f"Unhandled (in 'resemble.std.collections.v1.SortedMap.Insert') {aborted}; propagating as 'Unknown'\n" +
                ...
                raise resemble.aio.aborted.SystemAborted(
                    ...
                    # information.
                    message=f"unhandled (in 'resemble.std.collections.v1.SortedMap.Insert') {aborted}"
                )
            else:
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'resemble.std.collections.v1.SortedMap.Insert') {aborted}"
                        )
                elif (
            ...
            if not NODEJS:
                logger.warning(
                    f"Unhandled (in 'resemble.std.collections.v1.SortedMap.Insert') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
            ...
            raise resemble.aio.aborted.SystemAborted(
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'resemble.std.collections.v1.SortedMap.Insert') {type(exception).__name__}: {exception}"
            )
    ...
    async def _Insert(
        ...
        *,
        ...
        if idempotent_mutation is not None:
            response = resemble.std.collections.v1.sorted_map_pb2.InsertResponse()
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                await self._maybe_authorize(
                    method_name=
                    'resemble.std.collections.v1.SortedMap.Insert',
    ...
    async def _schedule_Insert(
        ...
        *,
        ...
        headers: resemble.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[resemble.aio.contexts.WriterContext, resemble.std.collections.v1.sorted_map_pb2.InsertResponse]:
    ...
    async def Insert(
        ...
        if authoritative_consensus != self.consensus_id:
            ...
            stub = resemble.std.collections.v1.sorted_map_pb2_grpc.SortedMapInterfaceStub(channel)
            call = stub.Insert(
                request=request,
        ...
        *,
        ...
        try:
            ...
            assert_type(
                response,
                [
                    resemble.std.collections.v1.sorted_map_pb2.RemoveResponse,
                ],
            )
            # TODO: retrying a control loop might cause an effect
            # validation retry to either "hang" or "do more
            ...
            if isinstance(aborted, resemble.aio.aborted.SystemAborted):
                ...
                if not NODEJS:
                    logger.warning(
                        f"Unhandled (in 'resemble.std.collections.v1.SortedMap.Remove') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(traceback.format_exception(aborted))
                    )
                raise resemble.aio.aborted.SystemAborted(
                    resemble.v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'resemble.std.collections.v1.SortedMap.Remove') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'resemble.std.collections.v1.SortedMap.Remove') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if not NODEJS:
                logger.warning(
                    f"Unhandled (in 'resemble.std.collections.v1.SortedMap.Remove') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
                    ''.join(traceback.format_exception(exception))
                )
            raise resemble.aio.aborted.SystemAborted(
                resemble.v1alpha1.errors_pb2.Unknown(),
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'resemble.std.collections.v1.SortedMap.Remove') {type(exception).__name__}: {exception}"
            )
    ...
    async def _Remove(
        ...
        *,
        ...
        if idempotent_mutation is not None:
            response = resemble.std.collections.v1.sorted_map_pb2.RemoveResponse()
            response.ParseFromString(idempotent_mutation.response)
            return response
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                await self._maybe_authorize(
                    method_name=
                    'resemble.std.collections.v1.SortedMap.Remove',
                    headers=context._headers,
                    auth=context.auth,
                    state=state,
                    request=request,
    ...
    async def _schedule_Remove(
        ...
        *,
        ...
        headers: resemble.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[resemble.aio.contexts.WriterContext, resemble.std.collections.v1.sorted_map_pb2.RemoveResponse]:
        context: resemble.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            context_type=resemble.aio.contexts.WriterContext,
        )
    ...
    async def __Range(
        ...
        *,
        validating_effects: bool,
    ) -> resemble.std.collections.v1.sorted_map_pb2.RangeResponse:
        try:
            response = (
            ...
            if isinstance(aborted, resemble.aio.aborted.SystemAborted):
                ...
                if not NODEJS:
                    logger.warning(
                        f"Unhandled (in 'resemble.std.collections.v1.SortedMap.Range') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(traceback.format_exception(aborted))
                    )
                raise resemble.aio.aborted.SystemAborted(
                    resemble.v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'resemble.std.collections.v1.SortedMap.Range') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'resemble.std.collections.v1.SortedMap.Range') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if not NODEJS:
                logger.warning(
                    f"Unhandled (in 'resemble.std.collections.v1.SortedMap.Range') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
                    ''.join(traceback.format_exception(exception))
                )
            raise resemble.aio.aborted.SystemAborted(
                resemble.v1alpha1.errors_pb2.Unknown(),
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'resemble.std.collections.v1.SortedMap.Range') {type(exception).__name__}: {exception}"
            )
    ...
    async def _schedule_Range(
        ...
        *,
        ...
        headers: resemble.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[resemble.aio.contexts.WriterContext, resemble.std.collections.v1.sorted_map_pb2.RangeResponse]:
        context: resemble.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            context_type=resemble.aio.contexts.WriterContext,
        )
        response = resemble.std.collections.v1.sorted_map_pb2.RangeResponse()
...
class _SortedMapStub(resemble.aio.stubs.Stub):

    __service_name__ = resemble.aio.types.ServiceName('resemble.std.collections.v1.SortedMapInterface')
    ...
    def __init__(
        ...
        *,
        ...
        self._stub = resemble.std.collections.v1.sorted_map_pb2_grpc.SortedMapInterfaceStub(channel)
    ...
    async def Range(
        ...
        *,
        ...
        async with self._call(
            ...
            unary=True,
            reader=True,
            response_type=resemble.std.collections.v1.sorted_map_pb2.RangeResponse,
            aborted_type=SortedMap.RangeAborted,
            metadata=metadata,
            bearer_token=bearer_token,
        ) as call:
        ...
        *,
        ...
        with self._idempotency_manager.idempotently(
            ...
            async with self._call(
                ...
                unary=True,
                reader=False,
                response_type=resemble.std.collections.v1.sorted_map_pb2.InsertResponse,
                aborted_type=SortedMap.InsertAborted,
                metadata=metadata,
        ...
        *,
        ...
        with self._idempotency_manager.idempotently(
            ...
            async with self._call(
                ...
                unary=True,
                reader=False,
                response_type=resemble.std.collections.v1.sorted_map_pb2.RemoveResponse,
                aborted_type=SortedMap.RemoveAborted,
                metadata=metadata,
                idempotency_key=idempotency_key,
                bearer_token=bearer_token,
...
SortedMapStateType: typing.TypeAlias = resemble.std.collections.v1.sorted_map_pb2.SortedMap
SortedMapRequestTypes: typing.TypeAlias = \
        resemble.std.collections.v1.sorted_map_pb2.InsertRequest \
        | resemble.std.collections.v1.sorted_map_pb2.RemoveRequest \
        | resemble.std.collections.v1.sorted_map_pb2.RangeRequest
...
class SortedMapAuthorizer(
    ...
    async def authorize(
        ...
        *,
        ...
        if method_name == 'resemble.std.collections.v1.SortedMap.Insert':
            return await self.Insert(
                context,
                typing.cast(resemble.std.collections.v1.sorted_map_pb2.SortedMap, state),
                typing.cast(resemble.std.collections.v1.sorted_map_pb2.InsertRequest, request),
            )
        elif method_name == 'resemble.std.collections.v1.SortedMap.Remove':
            return await self.Remove(
                context,
                typing.cast(resemble.std.collections.v1.sorted_map_pb2.SortedMap, state),
                typing.cast(resemble.std.collections.v1.sorted_map_pb2.RemoveRequest, request),
            )
        elif method_name == 'resemble.std.collections.v1.SortedMap.Range':
            return await self.Range(
                context,
                typing.cast(resemble.std.collections.v1.sorted_map_pb2.SortedMap, state),
                typing.cast(resemble.std.collections.v1.sorted_map_pb2.RangeRequest, request),
            )
        else:
...
class SortedMapServicer(resemble.aio.servicers.Servicer):
    Authorizer: typing.TypeAlias = SortedMapAuthorizer

    __service_name__ = resemble.aio.types.ServiceName('resemble.std.collections.v1.SortedMapInterface')
    __state_type_name__ = resemble.aio.types.StateTypeName('resemble.std.collections.v1.SortedMap')
    __state_type__ = resemble.std.collections.v1.sorted_map_pb2.SortedMap
    __file_descriptor__ = resemble.std.collections.v1.sorted_map_pb2.DESCRIPTOR
    ...
    class Effects(resemble.aio.state_managers.Effects):
        def __init__(
            ...
            *,
            ...
            assert_type(state, [resemble.std.collections.v1.sorted_map_pb2.SortedMap])
    ...
    class InsertEffects(Effects):
        def __init__(
            ...
            *,
            ...
            assert_type(state, [resemble.std.collections.v1.sorted_map_pb2.SortedMap])
            assert_type(response, [resemble.std.collections.v1.sorted_map_pb2.InsertResponse])
    ...
    class RemoveEffects(Effects):
        def __init__(
            ...
            *,
            ...
            assert_type(state, [resemble.std.collections.v1.sorted_map_pb2.SortedMap])
            assert_type(response, [resemble.std.collections.v1.sorted_map_pb2.RemoveResponse])
    ...
    ) -> resemble.std.collections.v1.sorted_map_pb2.SortedMap:
...
class SortedMap:
    ...
    State: typing.TypeAlias = resemble.std.collections.v1.sorted_map_pb2.SortedMap
    ...
    class InsertFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, resemble.std.collections.v1.sorted_map_pb2.InsertResponse]:
            """Awaits for task to finish and returns it's response."""

            async def wait_for_task() -> resemble.std.collections.v1.sorted_map_pb2.InsertResponse:
                ...
                try:
                    ...
                    if (
                        ...
                        raise resemble.aio.aborted.SystemAborted(
                            ...
                            "but expecting type 'resemble.std.collections.v1.sorted_map_pb2.InsertResponse'; "
    ...
    class RemoveFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, resemble.std.collections.v1.sorted_map_pb2.RemoveResponse]:
            """Awaits for task to finish and returns it's response."""

            async def wait_for_task() -> resemble.std.collections.v1.sorted_map_pb2.RemoveResponse:
                channel = self._channel_manager.get_channel_from_state_type_name(
                    self._task_id.state_type,
                    resemble.aio.types.StateRef(self._task_id.state_ref),
                )
                ...
                try:
                    ...
                    if (
                        ...
                        raise resemble.aio.aborted.SystemAborted(
                            ...
                            f"task with UUID {str(uuid.UUID(bytes=self._task_id.task_uuid))} "
                            f"has a response of type '{response_or_error.TypeName()}' "
                            "but expecting type 'resemble.std.collections.v1.sorted_map_pb2.RemoveResponse'; "
                            "are you waiting on a task of the correct method?",
                        ) from None
    ...
    class RangeFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, resemble.std.collections.v1.sorted_map_pb2.RangeResponse]:
            """Awaits for task to finish and returns it's response."""

            async def wait_for_task() -> resemble.std.collections.v1.sorted_map_pb2.RangeResponse:
                channel = self._channel_manager.get_channel_from_state_type_name(
                    self._task_id.state_type,
                    resemble.aio.types.StateRef(self._task_id.state_ref),
                )
                ...
                try:
                    ...
                    if (
                        ...
                        raise resemble.aio.aborted.SystemAborted(
                            ...
                            f"task with UUID {str(uuid.UUID(bytes=self._task_id.task_uuid))} "
                            f"has a response of type '{response_or_error.TypeName()}' "
                            "but expecting type 'resemble.std.collections.v1.sorted_map_pb2.RangeResponse'; "
                            "are you waiting on a task of the correct method?",
                        ) from None
    ...
    class WeakReference(typing.Generic[SortedMap_ScheduleTypeVar]):
        ...
        class _Reactively:
            ...
            ) -> typing.AsyncIterator[resemble.std.collections.v1.sorted_map_pb2.RangeResponse]:
        ...
        def reactively(self):
            return SortedMap.WeakReference._Reactively(
                service_name=resemble.aio.types.ServiceName('resemble.std.collections.v1.SortedMapInterface'),
                state_ref=self._state_ref,
                bearer_token=self._bearer_token,
            )
        ...
        class _Schedule:
            ...
            def __init__(
                self,
                tasks: typing.Callable[[resemble.aio.contexts.TransactionContext | resemble.aio.contexts.WorkflowContext | resemble.aio.external.ExternalContext], SortedMapTasksStub],
                *,
                when: typing.Optional[datetime | timedelta] = None,
                idempotency: typing.Optional[resemble.aio.idempotency.Idempotency] = None,
            ) -> None:
            ...
            async def Insert(
                ...
                *,
                entries: typing.Optional[dict[str, bytes]] = None,
            ) -> resemble.aio.tasks.TaskEffect | SortedMap.InsertFuture:
                if entries is not None and not isinstance(
                    ...
                    raise TypeError(
                        ...
                        f"'resemble.std.collections.v1.sorted_map_pb2.InsertRequest': field 'entries' is not "
                ...
                if isinstance(__context__, resemble.aio.contexts.TransactionContext):
                    return resemble.aio.tasks.TaskEffect(
                        service_name=resemble.aio.types.ServiceName(
                            'resemble.std.collections.v1.SortedMapInterface'
                        ),
            ...
            async def Remove(
                ...
                *,
                keys: typing.Optional[list[str]] = None,
            ) -> resemble.aio.tasks.TaskEffect | SortedMap.RemoveFuture:
                if keys is not None and not isinstance(
                    ...
                    raise TypeError(
                        f"Can not construct protobuf message of type "
                        f"'resemble.std.collections.v1.sorted_map_pb2.RemoveRequest': field 'keys' is not "
            ...
            async def Range(
                ...
                *,
                ...
                end_key: typing.Optional[str] = None,
                limit: typing.Optional[int] = None,
            ) -> resemble.aio.tasks.TaskEffect | SortedMap.RangeFuture:
                if start_key is not None and not isinstance(
                    ...
                    raise TypeError(
                        f"Can not construct protobuf message of type "
                        f"'resemble.std.collections.v1.sorted_map_pb2.RangeRequest': field 'start_key' is not "
                ...
                if end_key is not None and not isinstance(
                    ...
                    raise TypeError(
                        f"Can not construct protobuf message of type "
                        f"'resemble.std.collections.v1.sorted_map_pb2.RangeRequest': field 'end_key' is not "
                        f"of required type 'str'"
                    )
                if limit is not None and not isinstance(
                    ...
                    raise TypeError(
                        f"Can not construct protobuf message of type "
                        f"'resemble.std.collections.v1.sorted_map_pb2.RangeRequest': field 'limit' is not "
    ...
    async def _Insert(
        ...
        *,
        ...
        entries: typing.Optional[dict[str, bytes]] = None,
    ) -> tuple[SortedMap.WeakReference, resemble.std.collections.v1.sorted_map_pb2.InsertResponse]:
        if entries is not None and not isinstance(
            entries,
            dict,
        ):
    ...
    async def _Remove(
        ...
        *,
        ...
        __idempotency__: typing.Optional[resemble.aio.idempotency.Idempotency] = None,
        keys: typing.Optional[list[str]] = None,
    ) -> tuple[SortedMap.WeakReference, resemble.std.collections.v1.sorted_map_pb2.RemoveResponse]:
        if keys is not None and not isinstance(
            keys,
            list,
        ):
