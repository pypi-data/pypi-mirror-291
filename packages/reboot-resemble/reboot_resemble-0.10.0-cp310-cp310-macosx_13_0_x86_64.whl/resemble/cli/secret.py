...
from resemble.cli.cloud import add_cloud_options, cloud_external_context
...
def register_secret(parser: ArgumentParser):
    ...
    add_common_args(parser.subcommand('secret delete'))


async def secret_write(args) -> None:
    """Implementation of the 'secret write' subcommand."""
...
async def secret_delete(args) -> None:
    """Implementation of the 'secret delete' subcommand."""
