...
from resemble.aio.secrets import (
...
from resemble.thirdparty.mailgun.settings import (
    MAILGUN_API_KEY_SECRET_NAME,
    MAILGUN_EVENT_API_CONSISTENCY_DELAY_SEC,
)
from resemble.thirdparty.mailgun.v1.mailgun_rsm import (
    Message,
    SendRequest,
    SendResponse,
    SendTaskRequest,
...
class _AbstractMessageServicer(Message.Interface):
    ...
    def __init__(self):
        ...
        self._secrets = Secrets()
        if on_kubernetes() and isinstance(
