...
class ApplicationServicerMiddleware(resemble.aio.internals.middleware.Middleware):
    ...
    async def react_mutate(
        ...
        if method == 'Create':
            ...
            while True:
                ...
                stub = resemble.cloud.v1alpha1.application.application_pb2_grpc.ApplicationInterfaceStub(
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (ApplicationWorkflowStub(
                            ...
                            typing.cast(resemble.cloud.v1alpha1.application.application_pb2.CreateRequest, task.request),
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (ApplicationWorkflowStub(
                            ...
                            typing.cast(resemble.cloud.v1alpha1.application.application_pb2.UpRequest, task.request),
                            bearer_token=__internal_magic_token__,
                            idempotency=resemble.aio.idempotency.Idempotency(
                                alias=f'Task {task.task_id.task_uuid}',
                            ),
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (ApplicationWorkflowStub(
                            ...
                            typing.cast(resemble.cloud.v1alpha1.application.application_pb2.DownRequest, task.request),
                            bearer_token=__internal_magic_token__,
                            idempotency=resemble.aio.idempotency.Idempotency(
                                alias=f'Task {task.task_id.task_uuid}',
                            ),
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (ApplicationWorkflowStub(
                            ...
                            typing.cast(resemble.cloud.v1alpha1.application.application_pb2.DownTaskRequest, task.request),
                            bearer_token=__internal_magic_token__,
                            idempotency=resemble.aio.idempotency.Idempotency(
                                alias=f'Task {task.task_id.task_uuid}',
                            ),
    ...
    async def _schedule_Create(
        ...
        *,
        ...
        headers: resemble.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[resemble.aio.contexts.WriterContext, resemble.cloud.v1alpha1.application.application_pb2.CreateResponse]:
    ...
    async def Create(
        ...
        if authoritative_consensus != self.consensus_id:
            ...
            stub = resemble.cloud.v1alpha1.application.application_pb2_grpc.ApplicationInterfaceStub(channel)
            call = stub.Create(
                request=request,
    ...
    async def _schedule_Up(
        ...
        *,
        ...
        headers: resemble.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[resemble.aio.contexts.WriterContext, resemble.cloud.v1alpha1.application.application_pb2.UpResponse]:
        context: resemble.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            context_type=resemble.aio.contexts.WriterContext,
        )
    ...
    async def _schedule_UpTask(
        ...
        *,
        ...
        headers: resemble.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[resemble.aio.contexts.WriterContext, resemble.cloud.v1alpha1.application.application_pb2.UpTaskResponse]:
        context: resemble.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            context_type=resemble.aio.contexts.WriterContext,
        )
    ...
    async def _schedule_Down(
        ...
        *,
        ...
        headers: resemble.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[resemble.aio.contexts.WriterContext, resemble.cloud.v1alpha1.application.application_pb2.DownResponse]:
        context: resemble.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            context_type=resemble.aio.contexts.WriterContext,
        )
    ...
    async def _schedule_DownTask(
        ...
        *,
        ...
        headers: resemble.aio.headers.Headers,
        grpc_context: grpc.aio.ServicerContext,
    ) -> tuple[resemble.aio.contexts.WriterContext, resemble.cloud.v1alpha1.application.application_pb2.DownTaskResponse]:
        context: resemble.aio.contexts.WriterContext = self.create_context(
            headers=headers,
            context_type=resemble.aio.contexts.WriterContext,
        )
...
class _ApplicationStub(resemble.aio.stubs.Stub):

    __service_name__ = resemble.aio.types.ServiceName('resemble.cloud.v1alpha1.application.ApplicationInterface')
...
ApplicationStateType: typing.TypeAlias = resemble.cloud.v1alpha1.application.application_pb2.Application
        ...
        *,
        ...
        if method_name == 'resemble.cloud.v1alpha1.application.Application.Create':
            return await self.Create(
                context,
                typing.cast(resemble.cloud.v1alpha1.application.application_pb2.CreateRequest, request),
            )
        elif method_name == 'resemble.cloud.v1alpha1.application.Application.Up':
            return await self.Up(
                context,
                typing.cast(resemble.cloud.v1alpha1.application.application_pb2.Application, state),
                typing.cast(resemble.cloud.v1alpha1.application.application_pb2.UpRequest, request),
            )
            ...
            return await self.Down(
                context,
                typing.cast(resemble.cloud.v1alpha1.application.application_pb2.Application, state),
                typing.cast(resemble.cloud.v1alpha1.application.application_pb2.DownRequest, request),
            )
        elif method_name == 'resemble.cloud.v1alpha1.application.Application.DownTask':
            return await self.DownTask(
                context,
                typing.cast(resemble.cloud.v1alpha1.application.application_pb2.Application, state),
                typing.cast(resemble.cloud.v1alpha1.application.application_pb2.DownTaskRequest, request),
            )
        else:
...
class ApplicationServicer(resemble.aio.servicers.Servicer):
    Authorizer: typing.TypeAlias = ApplicationAuthorizer

    __service_name__ = resemble.aio.types.ServiceName('resemble.cloud.v1alpha1.application.ApplicationInterface')
    __state_type_name__ = resemble.aio.types.StateTypeName('resemble.cloud.v1alpha1.application.Application')
...
class Application:
    ...
    State: typing.TypeAlias = resemble.cloud.v1alpha1.application.application_pb2.Application
    ...
    class CreateFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, resemble.cloud.v1alpha1.application.application_pb2.CreateResponse]:
    ...
    class UpFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, resemble.cloud.v1alpha1.application.application_pb2.UpResponse]:
            """Awaits for task to finish and returns it's response."""
    ...
    class UpTaskFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, resemble.cloud.v1alpha1.application.application_pb2.UpTaskResponse]:
            """Awaits for task to finish and returns it's response."""
    ...
    class DownFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, resemble.cloud.v1alpha1.application.application_pb2.DownResponse]:
            """Awaits for task to finish and returns it's response."""
    ...
    class DownTaskFuture:
        ...
        def __await__(self) -> typing.Generator[None, None, resemble.cloud.v1alpha1.application.application_pb2.DownTaskResponse]:
            """Awaits for task to finish and returns it's response."""
    ...
    class WeakReference(typing.Generic[Application_ScheduleTypeVar]):
        ...
        def reactively(self):
            return Application.WeakReference._Reactively(
                service_name=resemble.aio.types.ServiceName('resemble.cloud.v1alpha1.application.ApplicationInterface'),
                state_ref=self._state_ref,
                bearer_token=self._bearer_token,
            )
        ...
        class _Schedule:
            ...
            def __init__(
                self,
                tasks: typing.Callable[[resemble.aio.contexts.TransactionContext | resemble.aio.contexts.WorkflowContext | resemble.aio.external.ExternalContext], ApplicationTasksStub],
                *,
                when: typing.Optional[datetime | timedelta] = None,
                idempotency: typing.Optional[resemble.aio.idempotency.Idempotency] = None,
            ) -> None:
            ...
            async def Up(
                ...
                *,
                container_image_name: typing.Optional[str] = None,
            ) -> resemble.aio.tasks.TaskEffect | Application.UpFuture:
                ...
                if isinstance(__context__, resemble.aio.contexts.TransactionContext):
                    return resemble.aio.tasks.TaskEffect(
                        service_name=resemble.aio.types.ServiceName(
                            'resemble.cloud.v1alpha1.application.ApplicationInterface'
                        ),
            ...
            async def UpTask(
                ...
                *,
                container_image_name: typing.Optional[str] = None,
            ) -> resemble.aio.tasks.TaskEffect | Application.UpTaskFuture:
                if container_image_name is not None and not isinstance(
                    container_image_name,
                    str,
                ):
            ...
            async def Down(
                ...
                __context__: resemble.aio.contexts.TransactionContext | resemble.aio.contexts.WorkflowContext | resemble.aio.external.ExternalContext,
                __options__: typing.Optional[resemble.aio.call.Options] = None,
            ) -> resemble.aio.tasks.TaskEffect | Application.DownFuture:
                # TODO: mypy-protobuf declares that
                # `google.protobuf.message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                request = resemble.cloud.v1alpha1.application.application_pb2.DownRequest(
            ...
            async def DownTask(
                ...
                __context__: resemble.aio.contexts.TransactionContext | resemble.aio.contexts.WorkflowContext | resemble.aio.external.ExternalContext,
                __options__: typing.Optional[resemble.aio.call.Options] = None,
            ) -> resemble.aio.tasks.TaskEffect | Application.DownTaskFuture:
                # TODO: mypy-protobuf declares that
                # `google.protobuf.message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                request = resemble.cloud.v1alpha1.application.application_pb2.DownTaskRequest(
