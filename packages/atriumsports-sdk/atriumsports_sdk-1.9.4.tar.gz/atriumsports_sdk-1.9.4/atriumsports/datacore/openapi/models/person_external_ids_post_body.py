...
class PersonExternalIdsPostBody(BaseModel):
    """
    ...
    __properties = ["personExternalId", "personId", "source", "sourceType", "sourceExternalId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PersonExternalIdsPostBody:
        """Create an instance of PersonExternalIdsPostBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PersonExternalIdsPostBody:
        """Create an instance of PersonExternalIdsPostBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PersonExternalIdsPostBody.parse_obj(obj)

        _obj = PersonExternalIdsPostBody.parse_obj(
            {
