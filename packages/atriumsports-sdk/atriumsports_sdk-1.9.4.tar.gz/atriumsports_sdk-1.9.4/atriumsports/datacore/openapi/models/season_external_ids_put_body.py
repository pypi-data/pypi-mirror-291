...
class SeasonExternalIdsPutBody(BaseModel):
    """
    ...
    __properties = ["seasonId", "source", "sourceType", "sourceExternalId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SeasonExternalIdsPutBody:
        """Create an instance of SeasonExternalIdsPutBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SeasonExternalIdsPutBody:
        """Create an instance of SeasonExternalIdsPutBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SeasonExternalIdsPutBody.parse_obj(obj)

        _obj = SeasonExternalIdsPutBody.parse_obj(
            {
