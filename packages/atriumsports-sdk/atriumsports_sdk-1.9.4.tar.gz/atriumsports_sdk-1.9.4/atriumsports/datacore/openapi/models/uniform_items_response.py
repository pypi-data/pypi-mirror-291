...
class UniformItemsResponse(BaseModel):
    """
    ...
    data: Optional[conlist(UniformItemsModel)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UniformItemsResponse:
        """Create an instance of UniformItemsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UniformItemsResponse:
        """Create an instance of UniformItemsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UniformItemsResponse.parse_obj(obj)

        _obj = UniformItemsResponse.parse_obj(
            {
                ...
                "data": [UniformItemsModel.from_dict(_item) for _item in obj.get("data")]
