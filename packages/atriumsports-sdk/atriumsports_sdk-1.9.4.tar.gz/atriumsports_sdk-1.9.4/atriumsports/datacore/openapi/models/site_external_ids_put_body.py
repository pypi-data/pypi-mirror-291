...
class SiteExternalIdsPutBody(BaseModel):
    """
    ...
    __properties = ["siteId", "source", "sourceType", "sourceExternalId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SiteExternalIdsPutBody:
        """Create an instance of SiteExternalIdsPutBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SiteExternalIdsPutBody:
        """Create an instance of SiteExternalIdsPutBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SiteExternalIdsPutBody.parse_obj(obj)

        _obj = SiteExternalIdsPutBody.parse_obj(
            {
