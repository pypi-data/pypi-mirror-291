...
class PersonExternalIdsPutBody(BaseModel):
    """
    ...
    __properties = ["personId", "source", "sourceType", "sourceExternalId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PersonExternalIdsPutBody:
        """Create an instance of PersonExternalIdsPutBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PersonExternalIdsPutBody:
        """Create an instance of PersonExternalIdsPutBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PersonExternalIdsPutBody.parse_obj(obj)

        _obj = PersonExternalIdsPutBody.parse_obj(
            {
