...
class DivisionExternalIdsPutBody(BaseModel):
    """
    ...
    __properties = ["divisionId", "source", "sourceType", "sourceExternalId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DivisionExternalIdsPutBody:
        """Create an instance of DivisionExternalIdsPutBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DivisionExternalIdsPutBody:
        """Create an instance of DivisionExternalIdsPutBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DivisionExternalIdsPutBody.parse_obj(obj)

        _obj = DivisionExternalIdsPutBody.parse_obj(
            {
