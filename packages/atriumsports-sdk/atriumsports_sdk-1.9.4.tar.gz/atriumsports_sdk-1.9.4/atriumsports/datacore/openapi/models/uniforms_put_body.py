...
class UniformsPutBody(BaseModel):
    ...
    __properties = ["baseType", "baseId", "nameLocal", "nameLatin", "dateFrom", "dateTo", "externalId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UniformsPutBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UniformsPutBody:
        """Create an instance of UniformsPutBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UniformsPutBody.parse_obj(obj)

        _obj = UniformsPutBody.parse_obj(
            {
