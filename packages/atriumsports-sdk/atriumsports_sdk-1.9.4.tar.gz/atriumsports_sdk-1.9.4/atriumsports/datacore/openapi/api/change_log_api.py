...
class ChangeLogApi:
    ...
    def change_log_list(
        ...
        **kwargs
        ...
        >>> thread = api.change_log_list(organization_id, sport, added, change_type, child_type, external, fields, hide_null, include, limit, offset, primary_id, primary_type, async_req=True)
        >>> result = thread.get()
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the change_log_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
