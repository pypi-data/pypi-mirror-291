...
class SeasonEntityBaseStatisticsApi:
    ...
    def sebs_delete_all(
        ...
        **kwargs
        ...
        >>> thread = api.sebs_delete_all(organization_id, season_id, sport, competitor_type, entity_id, external, fields, fixture_type, force_delete, hide_null, include, async_req=True)
        >>> result = thread.get()
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the sebs_delete_all_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
    ...
    def sebs_insert_update(
        ...
        **kwargs
        ...
        >>> thread = api.sebs_insert_update(organization_id, sport, season_entity_base_statistics_post_body, external, fields, hide_null, include, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the sebs_insert_update_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        try:
    ...
    def sebs_list(
        ...
        **kwargs
        ...
        >>> thread = api.sebs_list(organization_id, season_id, sport, added, competitor_type, entity_id, external, fields, fixture_type, hide_null, include, limit, offset, representing, representing_country, updated, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the sebs_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        try:
    ...
    def sebs_list_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.sebs_list_with_http_info(organization_id, season_id, sport, added, competitor_type, entity_id, external, fields, fixture_type, hide_null, include, limit, offset, representing, representing_country, updated, async_req=True)
        >>> result = thread.get()
