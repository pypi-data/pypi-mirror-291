...
class SeasonLeadersApi:
    ...
    def sl_list(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the sl_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
    ...
    def sl_list_summary(
        ...
        **kwargs
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the sl_list_summary_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        try:
