...
class VideoStreamsAvailableApi:
    ...
    def video_stream_outputs_fixture_list(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the video_stream_outputs_fixture_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
    ...
    def video_stream_outputs_org_list(
        ...
        **kwargs
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the video_stream_outputs_org_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        try:
    ...
    def video_stream_outputs_orggroup_list(
        ...
        **kwargs
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the video_stream_outputs_orggroup_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        try:
