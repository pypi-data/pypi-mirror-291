...
class SeasonPersonBaseStatisticsApi:
    ...
    def spbs_list(
        ...
        **kwargs
        ...
        >>> thread = api.spbs_list(organization_id, season_id, sport, added, competitor_type, entity_id, external, fields, fixture_type, hide_null, include, limit, offset, person_id, representing, representing_country, updated, async_req=True)
        >>> result = thread.get()
    ...
    def spbs_list_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.spbs_list_with_http_info(organization_id, season_id, sport, added, competitor_type, entity_id, external, fields, fixture_type, hide_null, include, limit, offset, person_id, representing, representing_country, updated, async_req=True)
        >>> result = thread.get()
