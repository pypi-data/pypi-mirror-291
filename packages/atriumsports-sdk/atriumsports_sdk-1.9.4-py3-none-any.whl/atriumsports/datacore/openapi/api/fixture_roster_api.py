...
class FixtureRosterApi:
    ...
    def fixture_roster_delete(
        ...
        **kwargs
        ...
        >>> thread = api.fixture_roster_delete(fixture_id, organization_id, person_id, sport, external, fields, force_delete, hide_null, include, async_req=True)
        >>> result = thread.get()
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the fixture_roster_delete_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
        ...
        **kwargs
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method fixture_roster_delete" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def fixture_roster_delete_all(
        ...
        **kwargs
        ...
        >>> thread = api.fixture_roster_delete_all(fixture_id, organization_id, sport, external, fields, force_delete, hide_null, include, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the fixture_roster_delete_all_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        try:
    ...
    def fixture_roster_delete_all_with_http_info(
        ...
        **kwargs
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method fixture_roster_delete_all" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
    ...
    def fixture_roster_detail(
        ...
        **kwargs
        ...
        >>> thread = api.fixture_roster_detail(fixture_id, organization_id, person_id, sport, external, fields, hide_null, include, limit, offset, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the fixture_roster_detail_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        try:
    ...
    def fixture_roster_insert_update(
        ...
        **kwargs
        ...
        >>> thread = api.fixture_roster_insert_update(fixture_id, organization_id, sport, fixture_roster_post_body, external, fields, hide_null, include, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the fixture_roster_insert_update_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        try:
    ...
    def fixture_roster_insert_update_base_route(
        ...
        **kwargs
        ...
        """Create/Update a fixture roster base route  # noqa: E501

        Depending on the data, Add a new fixture roster entry or update an existing one, with fixtureId in the payload  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.fixture_roster_insert_update_base_route(organization_id, sport, fixture_roster_post_body, external, fields, hide_null, include, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the fixture_roster_insert_update_base_route_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        try:
            return self.fixture_roster_insert_update_base_route_with_http_info(
                organization_id, sport, fixture_roster_post_body, external, fields, hide_null, include, **kwargs
            )  # noqa: E501
        except Exception as e:
    ...
    def fixture_roster_insert_update_base_route_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.fixture_roster_insert_update_base_route_with_http_info(organization_id, sport, fixture_roster_post_body, external, fields, hide_null, include, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method fixture_roster_insert_update_base_route" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
        ...
        return self.api_client.call_api(
            "/{sport}/o/{organizationId}/fixtures/roster",
            "POST",
            _path_params,
            _query_params,
            _header_params,
    ...
    def fixture_roster_list(
        ...
        **kwargs
        ...
        >>> thread = api.fixture_roster_list(fixture_id, organization_id, sport, added, external, fields, hide_null, include, limit, offset, updated, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the fixture_roster_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        try:
    ...
    def fixture_roster_list_by_entity(
        ...
        **kwargs
        ...
        >>> thread = api.fixture_roster_list_by_entity(entity_id, fixture_id, organization_id, sport, added, external, fields, hide_null, include, limit, offset, updated, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the fixture_roster_list_by_entity_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        try:
