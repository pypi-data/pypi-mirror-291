...
class VideoStreamInputsApi:
    ...
    def video_stream_inputs_fixture_list(
        ...
        **kwargs
        ...
        >>> thread = api.video_stream_inputs_fixture_list(fixture_id, organization_id, sport, added, external, feed_type, fields, hide_null, include, limit, locale, offset, provider, source_number, updated, video_input_id, async_req=True)
        >>> result = thread.get()
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the video_stream_inputs_fixture_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
    ...
    def video_stream_inputs_list(
        ...
        **kwargs
        ...
        >>> thread = api.video_stream_inputs_list(master_venue_id, sport, added, competition_id, external, feed_type, fields, fixture_id, from_time_local, from_time_utc, hide_null, include, limit, locale, offset, provider, season_id, source_number, to_time_local, to_time_utc, updated, venue_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the video_stream_inputs_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        try:
    ...
    def video_stream_inputs_org_list(
        ...
        **kwargs
        ...
        >>> thread = api.video_stream_inputs_org_list(organization_id, sport, added, competition_id, external, feed_type, fields, fixture_id, from_time_local, from_time_utc, hide_null, include, limit, locale, offset, provider, season_id, source_number, to_time_local, to_time_utc, updated, venue_id, video_input_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the video_stream_inputs_org_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        try:
