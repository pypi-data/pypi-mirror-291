...
class EntityFixtureHistoryApi:
    ...
    def gamelog_listentity(
        ...
        **kwargs
        ...
        >>> thread = api.gamelog_listentity(entity_id, organization_id, season_id, sport, added, external, fields, fixture_type, hide_null, home_away, include, limit, offset, updated, win_loss, async_req=True)
        >>> result = thread.get()
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the gamelog_listentity_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
