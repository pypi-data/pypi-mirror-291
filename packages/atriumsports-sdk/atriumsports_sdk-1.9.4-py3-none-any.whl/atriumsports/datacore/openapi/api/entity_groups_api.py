...
class EntityGroupsApi:
    ...
    def entity_group_delete(
        ...
        **kwargs
        ...
        >>> thread = api.entity_group_delete(entity_group_id, organization_id, sport, external, fields, force_delete, hide_null, include, async_req=True)
        >>> result = thread.get()
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the entity_group_delete_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
    ...
    def entity_group_detail(
        ...
        **kwargs
        ...
        >>> thread = api.entity_group_detail(entity_group_id, organization_id, sport, external, fields, hide_null, include, limit, offset, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the entity_group_detail_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        try:
    ...
    def entity_group_insert(
        ...
        **kwargs
        ...
        >>> thread = api.entity_group_insert(organization_id, sport, entity_group_post_body, external, fields, hide_null, include, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the entity_group_insert_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        try:
    ...
    def entity_group_list(
        ...
        **kwargs
        ...
        >>> thread = api.entity_group_list(organization_id, sport, added, external, fields, hide_null, include, limit, name_full_latin_contains, name_full_local_contains, offset, sort_by, status, updated, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the entity_group_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        try:
    ...
    def entity_group_list_with_http_info(
        ...
        **kwargs
        ...
        >>> thread = api.entity_group_list_with_http_info(organization_id, sport, added, external, fields, hide_null, include, limit, name_full_latin_contains, name_full_local_contains, offset, sort_by, status, updated, async_req=True)
        >>> result = thread.get()
    ...
    def entity_group_update(
        ...
        **kwargs
        ...
        >>> thread = api.entity_group_update(entity_group_id, organization_id, sport, entity_group_put_body, external, fields, hide_null, include, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the entity_group_update_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        try:
