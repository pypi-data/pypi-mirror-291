...
class VenueExternalIdsPutBody(BaseModel):
    """
    ...
    __properties = ["venueId", "source", "sourceType", "sourceExternalId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VenueExternalIdsPutBody:
        """Create an instance of VenueExternalIdsPutBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VenueExternalIdsPutBody:
        """Create an instance of VenueExternalIdsPutBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VenueExternalIdsPutBody.parse_obj(obj)

        _obj = VenueExternalIdsPutBody.parse_obj(
            {
