...
class CareerPersonRepresentationalStatisticsResponse(BaseModel):
    """
    ...
    data: Optional[conlist(CareerPersonRepresentationalStatisticsModel)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CareerPersonRepresentationalStatisticsResponse:
        """Create an instance of CareerPersonRepresentationalStatisticsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CareerPersonRepresentationalStatisticsResponse:
        """Create an instance of CareerPersonRepresentationalStatisticsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CareerPersonRepresentationalStatisticsResponse.parse_obj(obj)

        _obj = CareerPersonRepresentationalStatisticsResponse.parse_obj(
            {
                ...
                "data": [CareerPersonRepresentationalStatisticsModel.from_dict(_item) for _item in obj.get("data")]
