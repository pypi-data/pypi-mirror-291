...
class ConferenceExternalIdsPostBody(BaseModel):
    """
    ...
    __properties = ["conferenceExternalId", "conferenceId", "source", "sourceType", "sourceExternalId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConferenceExternalIdsPostBody:
        """Create an instance of ConferenceExternalIdsPostBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConferenceExternalIdsPostBody:
        """Create an instance of ConferenceExternalIdsPostBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConferenceExternalIdsPostBody.parse_obj(obj)

        _obj = ConferenceExternalIdsPostBody.parse_obj(
            {
