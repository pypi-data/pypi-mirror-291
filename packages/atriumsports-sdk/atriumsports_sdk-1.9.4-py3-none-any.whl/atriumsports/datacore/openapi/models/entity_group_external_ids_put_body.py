...
class EntityGroupExternalIdsPutBody(BaseModel):
    """
    ...
    __properties = ["entityGroupId", "source", "sourceType", "sourceExternalId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EntityGroupExternalIdsPutBody:
        """Create an instance of EntityGroupExternalIdsPutBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EntityGroupExternalIdsPutBody:
        """Create an instance of EntityGroupExternalIdsPutBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EntityGroupExternalIdsPutBody.parse_obj(obj)

        _obj = EntityGroupExternalIdsPutBody.parse_obj(
            {
