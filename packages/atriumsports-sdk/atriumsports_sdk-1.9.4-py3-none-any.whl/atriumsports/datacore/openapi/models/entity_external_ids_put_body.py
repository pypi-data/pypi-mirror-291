...
class EntityExternalIdsPutBody(BaseModel):
    """
    ...
    __properties = ["entityId", "source", "sourceType", "sourceExternalId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EntityExternalIdsPutBody:
        """Create an instance of EntityExternalIdsPutBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EntityExternalIdsPutBody:
        """Create an instance of EntityExternalIdsPutBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EntityExternalIdsPutBody.parse_obj(obj)

        _obj = EntityExternalIdsPutBody.parse_obj(
            {
