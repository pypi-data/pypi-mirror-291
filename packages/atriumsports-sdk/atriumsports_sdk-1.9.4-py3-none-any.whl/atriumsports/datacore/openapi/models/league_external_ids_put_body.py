...
class LeagueExternalIdsPutBody(BaseModel):
    """
    ...
    __properties = ["leagueId", "source", "sourceType", "sourceExternalId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LeagueExternalIdsPutBody:
        """Create an instance of LeagueExternalIdsPutBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LeagueExternalIdsPutBody:
        """Create an instance of LeagueExternalIdsPutBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LeagueExternalIdsPutBody.parse_obj(obj)

        _obj = LeagueExternalIdsPutBody.parse_obj(
            {
