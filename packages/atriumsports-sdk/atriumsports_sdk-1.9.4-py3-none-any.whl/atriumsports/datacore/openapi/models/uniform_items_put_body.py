...
class UniformItemsPutBody(BaseModel):
    """
    UniformItemsPutBody
    """
    ...
    __properties = ["uniformId", "itemType", "nameLocal", "nameLatin", "colors"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UniformItemsPutBody:
        """Create an instance of UniformItemsPutBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UniformItemsPutBody:
        """Create an instance of UniformItemsPutBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UniformItemsPutBody.parse_obj(obj)

        _obj = UniformItemsPutBody.parse_obj(
            {
