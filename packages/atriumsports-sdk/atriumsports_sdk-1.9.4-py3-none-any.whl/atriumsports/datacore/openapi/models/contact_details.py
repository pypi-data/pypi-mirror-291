...
class ContactDetails(BaseModel):
    """
    Public contact fields  # noqa: E501
    """
    ...
    def to_dict(self):
        ...
        if self.fax is None and "fax" in self.__fields_set__:
            _dict["fax"] = None
        ...
        # and __fields_set__ contains the field
        if self.phone_secondary is None and "phone_secondary" in self.__fields_set__:
