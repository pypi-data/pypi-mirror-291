...
class FixturePBPEventPostBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixturePBPEventPostBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FixturePBPEventPostBody:
        """Create an instance of FixturePBPEventPostBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FixturePBPEventPostBody.parse_obj(obj)

        _obj = FixturePBPEventPostBody.parse_obj(
            {
