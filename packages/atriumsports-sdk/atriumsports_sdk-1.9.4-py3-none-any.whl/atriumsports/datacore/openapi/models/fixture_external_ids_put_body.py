...
class FixtureExternalIdsPutBody(BaseModel):
    """
    ...
    __properties = ["fixtureId", "source", "sourceType", "sourceExternalId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FixtureExternalIdsPutBody:
        """Create an instance of FixtureExternalIdsPutBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FixtureExternalIdsPutBody:
        """Create an instance of FixtureExternalIdsPutBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FixtureExternalIdsPutBody.parse_obj(obj)

        _obj = FixtureExternalIdsPutBody.parse_obj(
            {
