...
import traceback
from .object import ContractData, MyAccountData, ErrorData, MyPositionData, MyTradeData, MyOrderData, MyBookData, MyTickData, MyRawTickData, QuoteData
from .constant import (
...
class BaseMarketApi(LoggerBase):
    ...
    def query_quotes(self, vt_symbols: list[str]) -> Union[RetCode, list[QuoteData]]:
        pass
