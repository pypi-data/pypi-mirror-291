...
def fix_channel(trace: Trace, channel: str = None, directory_structure: str = None) -> str:
...
class NewTrace:
    def __init__(self, trace: Trace, directory_structure: str = None, station: str = None,
