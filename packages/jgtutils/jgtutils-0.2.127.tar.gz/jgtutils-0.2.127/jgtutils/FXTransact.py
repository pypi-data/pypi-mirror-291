...
class FXTransactWrapper:
    ...
    def find_matching_trade(self,order):
        for trade in self.trades:
            if (trade['instrument'] == order['instrument'] and
                ...
                print("Matching trade found by instrument, entry_rate, stop_rate, and lots:", trade)
                return trade
            #open_order_id
            if trade['open_order_id'] == order['OrderID']:
                print("Matching trade found by open_order_id:", trade)
                return trade
        return None
