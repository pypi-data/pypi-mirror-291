...
def get_timeframes():
    return _get_iterable_timeframes_from_args()
...
def get_instruments():
    return _get_iterable_instruments_from_args()
...
def __timeframes_post_parse()->argparse.Namespace:
    ...
    if _timeframes is not None and not isinstance(_timeframes, list) :
        _timeframes=_parse_timeframes_helper(_timeframes)
...
def _parse_timeframes_helper(timeframes):
...
def __instruments_post_parse()->argparse.Namespace:
    ...
    if _instruments is not None and not isinstance(_instruments, list) :
        _instruments=_parse_instruments_helper(_instruments)
...
def _parse_instruments_helper(instruments):
