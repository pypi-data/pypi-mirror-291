...
def update_jgt_on_existing_yaml_file(target_filepath,_settings=None,keys=None,custom_path=None,target_key='jgt'):
    jgt_yaml_content=dump_as_yaml_output(_settings,keys,custom_path)
    content_to_update = yaml.load(target_filepath)
    content_to_update[target_key] = jgt_yaml_content
    #write back to file
    with open(target_filepath, 'w') as f:
        yaml.dump(content_to_update, f)
