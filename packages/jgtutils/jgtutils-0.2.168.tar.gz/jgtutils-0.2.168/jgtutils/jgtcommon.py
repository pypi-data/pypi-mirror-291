...
def get_timeframes(default_timeframes):
    _timeframes=args.timeframes if args.tflag else default_timeframes if not args.timeframe else [args.timeframe]
    return _timeframes
...
def get_instruments(default_instruments):
    _instruments=args.instruments if args.iflag else default_instruments if not args.instrument else [args.instrument]
    return _instruments
