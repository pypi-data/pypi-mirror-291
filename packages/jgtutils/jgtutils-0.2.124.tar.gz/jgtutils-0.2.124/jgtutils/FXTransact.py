...
class FXTrade:
    ...
    @staticmethod
    def topath(trade_id,ext="json",use_local=True,fn=None):
        fn=FXTrade.mkfn(trade_id,ext,fn)
        return _mkfn_cfxdata_filepath(fn,use_local=use_local)
    
    @staticmethod
    def frompath(fpath:str):
        try:
    ...
    @staticmethod
    def fromid(trade_id,use_local=True):
        fpath=FXTrade.topath(trade_id,use_local=use_local)
        return FXTrade.frompath(fpath)
...
class FXTransactWrapper:
    ...
    @staticmethod
    def read(filename:str=None,use_local=True):
