...
from jgtos import mk_fn_data_filepath
from jgtcliconstants import JGTFX_DATA_SUBDIR
def mk_fn_fxdata_filepath(fn):
    return mk_fn_data_filepath( fn,JGTFX_DATA_SUBDIR)
