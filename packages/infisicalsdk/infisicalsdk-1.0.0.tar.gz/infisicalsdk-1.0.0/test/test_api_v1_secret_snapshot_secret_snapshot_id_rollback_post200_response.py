...
from openapi_client.models.api_v1_secret_snapshot_secret_snapshot_id_rollback_post200_response import ApiV1SecretSnapshotSecretSnapshotIdRollbackPost200Response  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ApiV1SecretSnapshotSecretSnapshotIdRollbackPost200Response:
        ...
        if include_optional:
            return ApiV1SecretSnapshotSecretSnapshotIdRollbackPost200Response(
                secret_snapshot = openapi_client.models._api_v1_workspace__workspace_id__secret_snapshots_get_200_response_secret_snapshots_inner._api_v1_workspace__workspaceId__secret_snapshots_get_200_response_secretSnapshots_inner(
                    id = '', 
                    env_id = '', 
                    folder_id = '', 
                    parent_folder_id = '', 
