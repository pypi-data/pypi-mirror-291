...
from openapi_client.models.api_v1_integration_auth_integration_options_get200_response import ApiV1IntegrationAuthIntegrationOptionsGet200Response  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ApiV1IntegrationAuthIntegrationOptionsGet200Response:
        ...
        if include_optional:
            return ApiV1IntegrationAuthIntegrationOptionsGet200Response(
                integration_options = [
                    openapi_client.models._api_v1_integration_auth_integration_options_get_200_response_integration_options_inner._api_v1_integration_auth_integration_options_get_200_response_integrationOptions_inner(
                        name = '', 
                        slug = '', 
                        client_slug = '', 
                        image = '', 
