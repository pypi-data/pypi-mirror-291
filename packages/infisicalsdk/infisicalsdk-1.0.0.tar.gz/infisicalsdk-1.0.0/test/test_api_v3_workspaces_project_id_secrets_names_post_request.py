...
from openapi_client.models.api_v3_workspaces_project_id_secrets_names_post_request import ApiV3WorkspacesProjectIdSecretsNamesPostRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ApiV3WorkspacesProjectIdSecretsNamesPostRequest:
        ...
        if include_optional:
            return ApiV3WorkspacesProjectIdSecretsNamesPostRequest(
                secrets_to_update = [
                    openapi_client.models._api_v3_workspaces__project_id__secrets_names_post_request_secrets_to_update_inner._api_v3_workspaces__projectId__secrets_names_post_request_secretsToUpdate_inner(
                        secret_name = '', 
                        secret_id = '', )
                    ]
            )
