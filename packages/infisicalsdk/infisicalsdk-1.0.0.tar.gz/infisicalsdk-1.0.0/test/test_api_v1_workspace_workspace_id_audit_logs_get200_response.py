...
from openapi_client.models.api_v1_workspace_workspace_id_audit_logs_get200_response import ApiV1WorkspaceWorkspaceIdAuditLogsGet200Response  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ApiV1WorkspaceWorkspaceIdAuditLogsGet200Response:
        ...
        if include_optional:
            return ApiV1WorkspaceWorkspaceIdAuditLogsGet200Response(
                audit_logs = [
                    openapi_client.models._api_v1_workspace__workspace_id__audit_logs_get_200_response_audit_logs_inner._api_v1_workspace__workspaceId__audit_logs_get_200_response_auditLogs_inner(
                        id = '', 
                        ip_address = '', 
                        user_agent = '', 
                        user_agent_type = '', 
