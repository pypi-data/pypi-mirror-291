...
from openapi_client.models.api_v1_integration_integration_id_patch_request import ApiV1IntegrationIntegrationIdPatchRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ApiV1IntegrationIntegrationIdPatchRequest:
        ...
        if include_optional:
            return ApiV1IntegrationIntegrationIdPatchRequest(
                ...
                owner = '',
                environment = '',
                metadata = openapi_client.models._api_v1_integration__integration_id__patch_request_metadata._api_v1_integration__integrationId__patch_request_metadata(
                    secret_prefix = '', 
                    secret_suffix = '', 
                    initial_sync_behavior = '', 
                    mapping_behavior = 'one-to-one', 
                    should_auto_redeploy = True, 
                    secret_gcp_label = openapi_client.models._api_v1_integration_post_request_metadata_secret_gcp_label._api_v1_integration_post_request_metadata_secretGCPLabel(
                        label_name = '', 
                        label_value = '', ), 
                    secret_aws_tag = [
                        openapi_client.models._api_v1_audit_log_streams__id__get_200_response_audit_log_stream_headers_inner._api_v1_audit_log_streams__id__get_200_response_auditLogStream_headers_inner(
                            key = '', 
                            value = '', )
                        ], 
                    kms_key_id = '', 
