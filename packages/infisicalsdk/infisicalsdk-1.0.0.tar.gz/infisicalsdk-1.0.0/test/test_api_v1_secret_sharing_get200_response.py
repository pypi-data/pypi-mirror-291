...
from openapi_client.models.api_v1_secret_sharing_get200_response import ApiV1SecretSharingGet200Response  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ApiV1SecretSharingGet200Response:
        ...
        if include_optional:
            return ApiV1SecretSharingGet200Response(
                secrets = [
                    openapi_client.models._api_v1_secret_sharing_get_200_response_secrets_inner._api_v1_secret_sharing_get_200_response_secrets_inner(
                        id = '', 
                        encrypted_value = '', 
                        iv = '', 
                        tag = '', 
