...
from openapi_client.models.api_v1_workspace_workspace_id_memberships_post_request import ApiV1WorkspaceWorkspaceIdMembershipsPostRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ApiV1WorkspaceWorkspaceIdMembershipsPostRequest:
        ...
        if include_optional:
            return ApiV1WorkspaceWorkspaceIdMembershipsPostRequest(
                members = [
                    openapi_client.models._api_v1_workspace__workspace_id__memberships_post_request_members_inner._api_v1_workspace__workspaceId__memberships_post_request_members_inner(
                        org_membership_id = '', 
