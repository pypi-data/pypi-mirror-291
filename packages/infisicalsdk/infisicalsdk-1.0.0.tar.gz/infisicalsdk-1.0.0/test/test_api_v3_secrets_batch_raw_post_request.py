...
from openapi_client.models.api_v3_secrets_batch_raw_post_request import ApiV3SecretsBatchRawPostRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ApiV3SecretsBatchRawPostRequest:
        ...
        if include_optional:
            return ApiV3SecretsBatchRawPostRequest(
                ...
                secret_path = '/',
                secrets = [
                    openapi_client.models._api_v3_secrets_batch_raw_post_request_secrets_inner._api_v3_secrets_batch_raw_post_request_secrets_inner(
                        secret_key = '', 
                        secret_value = '', 
                        secret_comment = '', 
