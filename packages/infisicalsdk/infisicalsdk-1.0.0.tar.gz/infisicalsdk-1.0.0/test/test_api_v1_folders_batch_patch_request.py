...
from openapi_client.models.api_v1_folders_batch_patch_request import ApiV1FoldersBatchPatchRequest  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ApiV1FoldersBatchPatchRequest:
        ...
        if include_optional:
            return ApiV1FoldersBatchPatchRequest(
                project_slug = '',
                folders = [
                    openapi_client.models._api_v1_folders_batch_patch_request_folders_inner._api_v1_folders_batch_patch_request_folders_inner(
                        id = '', 
                        environment = '', 
                        name = '', 
                        path = '/', )
