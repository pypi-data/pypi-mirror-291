...
class CreateGameRequest(BaseModel):
    ...
    CreateGameRequest
    """ # noqa: E501
    player_id1: StrictStr = Field(description="The ID of the player who creates the game")
    player_id2: Optional[StrictStr] = Field(default=None, description="The ID of the player who can join the game (optional)")
    ...
    __properties: ClassVar[List[str]] = ["player_id1", "player_id2", "vertex_count", "edges"]
