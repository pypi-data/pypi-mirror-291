...
*griffe-public-redundant-aliases* follows the **sponsorware** release strategy, which means
...
*griffe-public-redundant-aliases Insiders* is a private fork of *griffe-public-redundant-aliases*, hosted as
...
repository.
  ...
  [^1]:
    ...
    existing features that must be supported by *griffe-public-redundant-aliases*.
...
*griffe-public-redundant-aliases* and released for general availability, making them available
...
The biggest bottleneck in Open Source is time.[^3]
  ...
  [^3]:
    ...
    The sponsorware model ensures that if you decide to use *griffe-public-redundant-aliases*,
...
<small>
  ...
  your profile and avatar to show your support for *griffe-public-redundant-aliases*.
...
to use *griffe-public-redundant-aliases* locally without having access to Insiders.
Is this still possible?

Yes. Insiders is compatible with *griffe-public-redundant-aliases*. Almost all new features
...
Yes. Whether you're an individual or a company, you may use *griffe-public-redundant-aliases
Insiders* precisely under the same terms as *griffe-public-redundant-aliases*, which are given
