...
*griffe-public-redundant-aliases Insiders* is a compatible drop-in replacement for *griffe-public-redundant-aliases*,
...
*griffe-public-redundant-aliases Insiders* can be installed with `pip` [using SSH][using ssh]:

```bash
pip install git+ssh://git@github.com/pawamoy-insiders/griffe-public-redundant-aliases.git
```
...
```bash
pip install git+https://${GH_TOKEN}@github.com/pawamoy-insiders/griffe-public-redundant-aliases.git
```
...
Of course, you can use *griffe-public-redundant-aliases Insiders* directly using Git:

```
git clone git@github.com:pawamoy-insiders/griffe-public-redundant-aliases
```

When cloning with Git, the package must be installed:

```
pip install -e griffe-public-redundant-aliases
```

## Upgrading

When upgrading Insiders, you should always check the version of *griffe-public-redundant-aliases*
