...
def alteryxFlattenSchema(df, jsonParsedColumnName):
    spark = ScalaUtil.getAbiLib().spark
    result = spark.sparkContext._jvm.io.prophecy.alteryx.SparkFunctions.alteryxFlattenSchema(df._jdf, jsonParsedColumnName, spark._jsparkSession)
