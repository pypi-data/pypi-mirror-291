% pbskids-dl(SECTION) | User Commands
%
% "August 16 2024"
...
pbskids-dl - program to do something

# SYNOPSIS

**pbskids-dl** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**pbskids-dl** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **pbskids-dl** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**pbskids-dl** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    pbskids-dl. See **foo.conf**(5) for further details.
...
**pbskids-dl** provides some return codes, that can be used in scripts:
...
NexusSfan <nexussfan@nexussfan-Devuan>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 NexusSfan
