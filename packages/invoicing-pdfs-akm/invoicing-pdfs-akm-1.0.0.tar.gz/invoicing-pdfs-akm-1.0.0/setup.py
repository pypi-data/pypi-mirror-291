...
setup(
  name = 'invoicing-pdfs-akm',         #* Your package will have this name
  packages = ['invoicing-pdfs-akm'],   #* Name the package again
  ...
  author = 'Anuja K Merwade',                   # Your name
  author_email = 'meruanu97@gmail.com',  # Your email
