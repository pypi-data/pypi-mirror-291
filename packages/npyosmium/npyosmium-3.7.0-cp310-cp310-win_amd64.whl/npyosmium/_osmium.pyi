...
class NodeLocationsForWays:
    def __init__(self, locations: npyosmium.index.LocationTable) -> None: ...
...
class MergeInputReader:
    ...
    def apply_to_reader(self, reader: npyosmium.io.Reader, writer: npyosmium.io.Writer, with_history: bool = ...) -> None: ...
...
class SimpleWriter:
    @overload
    def __init__(self, filename: str, bufsz: int, header: npyosmium.io.Header) -> None: ...
    @overload
    def __init__(self, filename: str, bufsz: int) -> None: ...
    @overload
    def __init__(self, filename: str) -> None: ...
    def add_node(self, node: object) -> None: ...
    def add_locations(self, locations: object, first_id: int) -> None: ...
    def add_relation(self, relation: object) -> None: ...
    def add_way(self, way: object) -> None: ...
    def close(self) -> None: ...

@overload
def apply(reader: npyosmium.io.Reader, handler: BaseHandler) -> None: ...
@overload
def apply(reader: npyosmium.io.Reader, node_handler: NodeLocationsForWays) -> None: ...
@overload
def apply(reader: npyosmium.io.Reader, node_handler: NodeLocationsForWays, handler: BaseHandler) -> None: ...
