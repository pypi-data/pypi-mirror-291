...
class NodeRefList:
    ...
    def get(self, parent: BufferProxyProtocol, idx: int) -> npyosmium.osm.types.NodeRef: ...
...
class TagContainerProtocol(BufferProxyProtocol):
    ...
    def tags_next(self, it: CTagListIterator) -> npyosmium.osm.types.Tag: ...
...
class COSMRelation(COSMObject):
    ...
    def members_next(self, it: CRelationMemberListIterator) -> npyosmium.osm.types.RelationMember: ...
