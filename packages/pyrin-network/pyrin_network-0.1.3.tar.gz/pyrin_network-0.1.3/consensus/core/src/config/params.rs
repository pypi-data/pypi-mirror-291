...
impl Params {
    ...
    pub fn is_nearly_synced(&self, sink_timestamp: u64, sink_daa_score: u64) -> bool {
        if self.net.is_mainnet() {
            ...
            true // TODO:
            // let max_expected_duration_without_blocks_in_milliseconds = self.target_time_per_block * MainnetHardforkBps::get_bps(sink_daa_score) * NEW_DIFFICULTY_WINDOW_DURATION / 3; // = DAA duration in milliseconds / bps / 3
...
pub const MAINNET_PARAMS: Params = Params {
    ...
    // hf_activation_daa_score: 1491211 + 150,
