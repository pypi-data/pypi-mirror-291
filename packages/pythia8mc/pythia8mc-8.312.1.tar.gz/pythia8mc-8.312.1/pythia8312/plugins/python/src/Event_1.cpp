...
void bind_Pythia8_Event_1(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // Pythia8::StringBreaks file:Pythia8/Event.h line:409
		pybind11::class_<Pythia8::StringBreaks, std::shared_ptr<Pythia8::StringBreaks>> cl(M("Pythia8"), "StringBreaks", "");
		pybind11::handle cl_type = cl;

		cl.def( pybind11::init( [](){ return new Pythia8::StringBreaks(); } ) );
		cl.def( pybind11::init( [](Pythia8::StringBreaks const &o){ return new Pythia8::StringBreaks(o); } ) );
		cl.def("setEnds", (void (Pythia8::StringBreaks::*)(int, int)) &Pythia8::StringBreaks::setEnds, "C++: Pythia8::StringBreaks::setEnds(int, int) --> void", pybind11::arg("iPosIn"), pybind11::arg("iNegIn"));
		cl.def("posEnd", (int (Pythia8::StringBreaks::*)()) &Pythia8::StringBreaks::posEnd, "C++: Pythia8::StringBreaks::posEnd() --> int");
		cl.def("negEnd", (int (Pythia8::StringBreaks::*)()) &Pythia8::StringBreaks::negEnd, "C++: Pythia8::StringBreaks::negEnd() --> int");
		cl.def("clear", (void (Pythia8::StringBreaks::*)()) &Pythia8::StringBreaks::clear, "C++: Pythia8::StringBreaks::clear() --> void");
		cl.def("add", (void (Pythia8::StringBreaks::*)(int)) &Pythia8::StringBreaks::add, "C++: Pythia8::StringBreaks::add(int) --> void", pybind11::arg("id"));
		cl.def("nId", (const class std::map<int, int, struct std::less<int>, class std::allocator<struct std::pair<const int, int> > > & (Pythia8::StringBreaks::*)()) &Pythia8::StringBreaks::nId, "C++: Pythia8::StringBreaks::nId() --> const class std::map<int, int, struct std::less<int>, class std::allocator<struct std::pair<const int, int> > > &", pybind11::return_value_policy::reference);
		cl.def("nId", (int (Pythia8::StringBreaks::*)(int) const) &Pythia8::StringBreaks::nId, "C++: Pythia8::StringBreaks::nId(int) const --> int", pybind11::arg("id"));
		cl.def("nAll", (int (Pythia8::StringBreaks::*)() const) &Pythia8::StringBreaks::nAll, "C++: Pythia8::StringBreaks::nAll() const --> int");
		cl.def("nQuark", (int (Pythia8::StringBreaks::*)() const) &Pythia8::StringBreaks::nQuark, "C++: Pythia8::StringBreaks::nQuark() const --> int");
		cl.def("nDiquark", (int (Pythia8::StringBreaks::*)() const) &Pythia8::StringBreaks::nDiquark, "C++: Pythia8::StringBreaks::nDiquark() const --> int");
		cl.def("assign", (class Pythia8::StringBreaks & (Pythia8::StringBreaks::*)(const class Pythia8::StringBreaks &)) &Pythia8::StringBreaks::operator=, "C++: Pythia8::StringBreaks::operator=(const class Pythia8::StringBreaks &) --> class Pythia8::StringBreaks &", pybind11::return_value_policy::reference, pybind11::arg(""));
	}
	{ // Pythia8::Event file:Pythia8/Event.h line:453
		...
		cl.def("addStringBreaks", (void (Pythia8::Event::*)(class Pythia8::StringBreaks &)) &Pythia8::Event::addStringBreaks, "C++: Pythia8::Event::addStringBreaks(class Pythia8::StringBreaks &) --> void", pybind11::arg("sbIn"));
		cl.def("clearStringBreaks", (void (Pythia8::Event::*)()) &Pythia8::Event::clearStringBreaks, "C++: Pythia8::Event::clearStringBreaks() --> void");
		cl.def("getStringBreaks", (const class std::vector<class Pythia8::StringBreaks, class std::allocator<class Pythia8::StringBreaks> > & (Pythia8::Event::*)() const) &Pythia8::Event::getStringBreaks, "C++: Pythia8::Event::getStringBreaks() const --> const class std::vector<class Pythia8::StringBreaks, class std::allocator<class Pythia8::StringBreaks> > &", pybind11::return_value_policy::reference);
