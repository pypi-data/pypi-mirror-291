...
// Pythia8::WeightsMerging file:Pythia8/Weights.h line:235
...
// Pythia8::WeightsLHEF file:Pythia8/Weights.h line:313
...
// Pythia8::WeightsFragmentation file:Pythia8/Weights.h line:353
...
void bind_Pythia8_Weights(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // Pythia8::WeightsFragmentation file:Pythia8/Weights.h line:353
		...
		cl.def("assign", (class Pythia8::WeightsFragmentation & (Pythia8::WeightsFragmentation::*)(const class Pythia8::WeightsFragmentation &)) &Pythia8::WeightsFragmentation::operator=, "C++: Pythia8::WeightsFragmentation::operator=(const class Pythia8::WeightsFragmentation &) --> class Pythia8::WeightsFragmentation &", pybind11::return_value_policy::reference, pybind11::arg(""));
	}
	{ // Pythia8::WeightContainer file:Pythia8/Weights.h line:394
		...
		cl.def_readwrite("weightsFragmentation", &Pythia8::WeightContainer::weightsFragmentation);
		...
		cl.def("assign", (class Pythia8::WeightContainer & (Pythia8::WeightContainer::*)(const class Pythia8::WeightContainer &)) &Pythia8::WeightContainer::operator=, "C++: Pythia8::WeightContainer::operator=(const class Pythia8::WeightContainer &) --> class Pythia8::WeightContainer &", pybind11::return_value_policy::reference, pybind11::arg(""));
	}
}
