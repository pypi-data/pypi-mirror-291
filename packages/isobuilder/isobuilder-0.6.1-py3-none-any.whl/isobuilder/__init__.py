...
class IsoBuilder:
    ...
    def write_custom_files(self) -> None:
        ...
        partman_early_command = PARTMAN_EARLY_COMMAND.format(disk_id=self.disk_id)
        partman_early_command_path = self._dirs.build_dir / "dnsops" / "partman_early_command"
        partman_early_command_path.write_text(partman_early_command)
        partman_early_command_path.chmod(0o555)
