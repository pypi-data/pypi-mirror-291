...
class module(Namespace):
    # Value of None will set the output to stdout
    file_handle: Optional[io.IOBase] = None
...
def _close_handler():
    ...
    if module.file_handle not in ignore_fds and not module.file_handle.closed:
