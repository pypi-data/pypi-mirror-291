...
def aitPOST(access_token_response, directory_path=None, file_type=None, project=None, file_name=None, Proxy=None, archive=True, verbose=False):
    """
    ...
    archive (bool, optional): Flag to indicate if files should be archived after upload. Defaults to True.
    verbose (bool, optional): Flag to indicate if print statements should be executed. Defaults to False.

    Returns:
    list: A list of successfully uploaded file names.
    """
