...
class Column:
	def __init__(self,name:str,type:Callable,default_value:Any="",auto_increment:bool=False,increment_by:int|float=1) -> None:
		self.__name:str = name
		self.__type:Callable = type
		self.__default_value:Any = default_value
		self.__auto_increment:bool = auto_increment
		self.__increment_by:int|float = increment_by
	...
	@property
	def IncrementBy(self) -> int|float:
