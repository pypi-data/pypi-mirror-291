...
setuptools.setup(
    name=name,  # 包名
    version="0.0.0",  # 包版本号，便于维护版本,保证每次发布都是版本都是唯一的
    author="Sandmeyer",  # 作者，可以写自己的姓名
    author_email="sandmx.work@gmail.com",  # 作者联系方式，可写自己的邮箱地址
    description="A package used to create and import your plugs",  # 包的简述
    long_description=long_description,  # 包的详细介绍，一般在README.md文件内
    long_description_content_type="text/markdown",
    url="https://github.com/SandmX/pluglib",  # 自己项目地址，比如github的项目地址
