...
class Pystrector:
    ...
    Manages Strions.
    """
    structs_dir_path: str = "../staticfiles/c_structures/clean_structures/"
    ...
    def _get_base_types_dict() -> dict[str, int]:
        with open('../staticfiles/c_vars_size.yaml') as f:
            return yaml.safe_load(f)

    def _read_c_files(self) -> None:
        """ Create data types from dir """
        path = Path(self.structs_dir_path)
