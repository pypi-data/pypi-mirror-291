...
class ColumnarDataSourceBase(object):
    ...
    def GetEnumerator(self) -> "System.Collections.Generic.IEnumerator[Ansys.Mechanical.Table.ColumnarDataImportDefinition]":
        pass
    ...
    def UseColumn(self, index: "System.Int32", variableType: "Ansys.Mechanical.DataModel.MechanicalEnums.Table.VariableType", variableClassification: "Ansys.Mechanical.DataModel.MechanicalEnums.Table.VariableClassification", unit: "System.String", name: "System.String") -> "Ansys.Mechanical.Table.ColumnarDataSourceBase":
        """
...
class FixedWidthImportSettings(object):
    ...
    @property
    def ColumnWidths(self) -> typing.Optional["System.Object"]:
        """
