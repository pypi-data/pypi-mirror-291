...
class DirectionalHeatFlux(object):
    """
    ...
    @property
    def ThermalResultType(self) -> typing.Optional["Ansys.Mechanical.DataModel.Enums.TotalOrDirectional"]:
        """
...
class DirectionalThermalHeatFlux(object):
    """
...
class FluidHeatConductionRate(object):
    """
...
class FluidHeatTransportRate(object):
    """
...
class TemperatureResult(object):
    """
