...
class DataModelObjectCategory(Enum):
    ...
    TopologySuppressControl = 770
    CompositeFailureCriteria = 776
...
class SweepAxisymmetricFallBackMeshType(Enum):
    """
...
class ApplicationSourceEnum(Enum):
    """
...
class CrackSurfaceLoadApplyTo(Enum):
    """
    Specifies the CrackSurfaceLoadApplyTo.
    """

    InitialAndNewCrackFaces = 1
    NewCrackFacesOnly = 0
...
class TopoLocalDesignRestrictionNature(Enum):
    """
...
import ansys.mechanical.stubs.v242.Ansys.Mechanical.DataModel.Enums.GeometryImportPreference as GeometryImportPreference
import ansys.mechanical.stubs.v242.Ansys.Mechanical.DataModel.Enums.ExternalModel as ExternalModel
