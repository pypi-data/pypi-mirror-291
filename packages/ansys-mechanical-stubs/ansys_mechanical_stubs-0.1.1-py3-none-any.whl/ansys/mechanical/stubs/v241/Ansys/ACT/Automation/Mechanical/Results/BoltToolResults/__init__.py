...
class BoltTool(object):
    """
    Defines a BoltTool.
    """

    @property
    def InternalObject(self) -> typing.Optional["Ansys.Common.Interop.DSObjectsAuto.IDSBoltToolAuto"]:
        """
    ...
    def AddAdjustment(self) -> "Ansys.ACT.Automation.Mechanical.Results.BoltToolResults.BoltAdjustment":
        """
        Creates a new BoltAdjustment
        """
        pass

    def AddWorkingLoad(self) -> "Ansys.ACT.Automation.Mechanical.Results.BoltToolResults.BoltWorkingLoad":
        """
...
class BoltAdjustment(object):
    ...
    @property
    def BoltResultType(self) -> typing.Optional["Ansys.Mechanical.DataModel.Enums.ResultType"]:
        """
