...
class GeometryRayCastSettings(object):
    ...
    @property
    def HitFaces(self) -> typing.Optional["System.Boolean"]:
        """
    ...
    @property
    def HitEdges(self) -> typing.Optional["System.Boolean"]:
        """
    ...
    @property
    def HitVertices(self) -> typing.Optional["System.Boolean"]:
        """
    ...
    @property
    def HitBodies(self) -> typing.Optional["System.Boolean"]:
        """
    ...
    @property
    def MaxHits(self) -> typing.Optional["System.UInt32"]:
        """
...
class SelectionHelper(object):
    ...
    @classmethod
    def CreateVector3D(cls, selection: "Ansys.ACT.Interfaces.Common.ISelectionInfo", reversed: "System.Boolean") -> "Ansys.ACT.Math.Vector3D":
        """
    ...
    @classmethod
    def CastRayOnGeometry(cls, castVector: "Ansys.Mechanical.Math.BoundVector", settings: "Ansys.Mechanical.Selection.GeometryRayCastSettings") -> "System.Collections.Generic.IEnumerable[Ansys.Mechanical.Selection.GeometryRayCastHit]":
        """
