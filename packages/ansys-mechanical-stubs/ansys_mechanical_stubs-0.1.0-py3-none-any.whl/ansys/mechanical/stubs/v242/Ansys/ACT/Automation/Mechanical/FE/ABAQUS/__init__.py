...
class AbaqusKeywordArgumentColl(object):
    ...
    @property
    def Items(self) -> typing.Optional["System.Collections.Generic.IReadOnlyList[Ansys.ACT.Automation.Mechanical.FE.ABAQUS.AbaqusKeywordArgument]"]:
        """
...
class AbaqusKeywordArgument(object):
    ...
    @property
    def Key(self) -> typing.Optional["System.String"]:
        """
    ...
    @property
    def Value(self) -> typing.Optional["System.String"]:
        """
...
class AbaqusKeywordDataLineColl(object):
    ...
    @property
    def Items(self) -> typing.Optional["System.Collections.Generic.IReadOnlyList[Ansys.ACT.Automation.Mechanical.FE.ABAQUS.AbaqusKeywordDataLine]"]:
        """
...
class AbaqusKeywordDataLine(object):
    ...
    @property
    def Items(self) -> typing.Optional["System.Collections.Generic.IReadOnlyList[System.String]"]:
        """
