...
class GasketResult(object):
    ...
    @property
    def GasketResultType(self) -> typing.Optional["Ansys.Mechanical.DataModel.Enums.GasketResultType"]:
        """
...
class NormalGasketPressure(object):
    """
...
class NormalGasketTotalClosure(object):
    """
...
class ShearGasketPressure(object):
    """
...
class ShearGasketTotalClosure(object):
    """
