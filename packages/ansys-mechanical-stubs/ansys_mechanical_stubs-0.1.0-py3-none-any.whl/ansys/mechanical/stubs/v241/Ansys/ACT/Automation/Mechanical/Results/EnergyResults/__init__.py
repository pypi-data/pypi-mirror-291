...
class ElementalStrainEnergy(object):
    """
...
class StabilizationEnergy(object):
    """
...
class StructuralStrainEnergy(object):
    """
...
class ThermalStrainEnergy(object):
    """
