...
class ContactToolResult(object):
    """
    ...
    @property
    def ContactResultType(self) -> typing.Optional["Ansys.Mechanical.DataModel.Enums.ContactResultType"]:
        """
...
class ContactFluidPressure(object):
    """
...
class ContactFrictionalStress(object):
    """
...
class ContactPenetration(object):
    """
...
class ContactSlidingDistance(object):
    """
