...
class CompilationResultProto final :
 ...
 public:
  ...
  // .xla.cpu.CompilationResultProto.ObjFileKind obj_file_kind = 5;
  void clear_obj_file_kind();
  ::xla::cpu::CompilationResultProto_ObjFileKind obj_file_kind() const;
  void set_obj_file_kind(::xla::cpu::CompilationResultProto_ObjFileKind value);
  private:
  ::xla::cpu::CompilationResultProto_ObjFileKind _internal_obj_file_kind() const;
  void _internal_set_obj_file_kind(::xla::cpu::CompilationResultProto_ObjFileKind value);
  public:
...
// .xla.cpu.CompilationResultProto.ObjFileKind obj_file_kind = 5;
inline void CompilationResultProto::clear_obj_file_kind() {
  _impl_.obj_file_kind_ = 0;
}
inline ::xla::cpu::CompilationResultProto_ObjFileKind CompilationResultProto::_internal_obj_file_kind() const {
  return static_cast< ::xla::cpu::CompilationResultProto_ObjFileKind >(_impl_.obj_file_kind_);
}
inline ::xla::cpu::CompilationResultProto_ObjFileKind CompilationResultProto::obj_file_kind() const {
  // @@protoc_insertion_point(field_get:xla.cpu.CompilationResultProto.obj_file_kind)
  return _internal_obj_file_kind();
}
inline void CompilationResultProto::_internal_set_obj_file_kind(::xla::cpu::CompilationResultProto_ObjFileKind value) {
  
  _impl_.obj_file_kind_ = value;
}
inline void CompilationResultProto::set_obj_file_kind(::xla::cpu::CompilationResultProto_ObjFileKind value) {
  _internal_set_obj_file_kind(value);
  // @@protoc_insertion_point(field_set:xla.cpu.CompilationResultProto.obj_file_kind)
}
