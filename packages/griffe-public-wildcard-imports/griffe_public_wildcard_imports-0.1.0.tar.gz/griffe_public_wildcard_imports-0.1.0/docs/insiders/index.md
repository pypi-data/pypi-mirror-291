...
*griffe-public-wildcard-imports* follows the **sponsorware** release strategy, which means
...
*griffe-public-wildcard-imports Insiders* is a private fork of *griffe-public-wildcard-imports*, hosted as
...
repository.
  ...
  [^1]:
    ...
    existing features that must be supported by *griffe-public-wildcard-imports*.
...
*griffe-public-wildcard-imports* and released for general availability, making them available
...
The biggest bottleneck in Open Source is time.[^3]
  ...
  [^3]:
    ...
    The sponsorware model ensures that if you decide to use *griffe-public-wildcard-imports*,
...
<small>
  ...
  your profile and avatar to show your support for *griffe-public-wildcard-imports*.
...
to use *griffe-public-wildcard-imports* locally without having access to Insiders.
Is this still possible?

Yes. Insiders is compatible with *griffe-public-wildcard-imports*. Almost all new features
...
Yes. Whether you're an individual or a company, you may use *griffe-public-wildcard-imports
Insiders* precisely under the same terms as *griffe-public-wildcard-imports*, which are given
