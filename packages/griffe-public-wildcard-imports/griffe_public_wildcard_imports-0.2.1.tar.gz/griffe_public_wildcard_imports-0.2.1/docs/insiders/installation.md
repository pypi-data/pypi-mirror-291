...
*griffe-public-wildcard-imports Insiders* is a compatible drop-in replacement for *griffe-public-wildcard-imports*,
...
*griffe-public-wildcard-imports Insiders* can be installed with `pip` [using SSH][using ssh]:

```bash
pip install git+ssh://git@github.com/pawamoy-insiders/griffe-public-wildcard-imports.git
```
...
```bash
pip install git+https://${GH_TOKEN}@github.com/pawamoy-insiders/griffe-public-wildcard-imports.git
```
...
Of course, you can use *griffe-public-wildcard-imports Insiders* directly using Git:

```
git clone git@github.com:pawamoy-insiders/griffe-public-wildcard-imports
```

When cloning with Git, the package must be installed:

```
pip install -e griffe-public-wildcard-imports
```

## Upgrading

When upgrading Insiders, you should always check the version of *griffe-public-wildcard-imports*
