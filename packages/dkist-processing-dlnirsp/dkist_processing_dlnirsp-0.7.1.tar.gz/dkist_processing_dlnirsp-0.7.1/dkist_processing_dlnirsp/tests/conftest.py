...
class RawRampHeaders(DlnirspHeaders):
    def __init__(
        ...
        num_NDR_per_ramp = num_line1 + num_read + num_line2
        ...
        self.num_line1 = num_line1
        self.num_read = num_read
        self.num_line2 = num_line2

        if num_line2 == 0:
            cam_read_sequence = f"{num_line1}line,{num_read}read"
        else:
            cam_read_sequence = f"{num_line1}line,{num_read}read,{num_line2}line"
...
class AbortedRampHeaders(RawRampHeaders):
    def __init__(
        ...
        self.add_constant_key("DLN__049", num_line1 + num_read + num_line2)
