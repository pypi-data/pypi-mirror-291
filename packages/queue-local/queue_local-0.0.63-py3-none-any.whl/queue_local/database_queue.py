...
class DatabaseQueue(OurQueue, GenericCRUD, metaclass=MetaLogger, object=queue_logger_object):
    ...
    def get(self, *, action_ids: tuple = (), custom_condition: str = "", data_dict: dict = None, queue_dict: dict = None) -> dict:
        """
        ...
        if queue_item:
            ...
            self.update_by_column_and_value(column_value=queue_item[self.queue_item_id_column_name], data_dict=update_queue_dict)
