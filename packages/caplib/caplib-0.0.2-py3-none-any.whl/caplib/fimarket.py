...
def create_vanilla_bond_template(inst_name, bond_type, issue_date, settlement_days, start_date, maturity,
    ...
    '''    
    if (bond_type==FLOATING_COUPON_BOND):
    ...
    p_template = dqCreateProtoVanillaBondTemplate(inst_name.upper(), bond_type, 
                                                  settlement_days, p_leg_definition, 
                                                  ex_cpn_period, ex_cpn_calendar, 
                                                  ex_cpn_day_convention, ex_cpn_eom, 
                                                  issue_date, rate, maturity, issue_price, start_date,
                                                  notional_type,
                                                  recovery_rate)
...
def create_zero_cpn_bond_template(inst_name, issue_date, settlement_days, start_date, maturity,
    ...
    return create_vanilla_bond_template(inst_name, ZERO_COUPON_BOND, issue_date, settlement_days, start_date, maturity,
                                        ...
                                        create_period(0, DAYS), '', INVALID_BUSINESS_DAY_CONVENTION, False,
                                        CONST_NOTIONAL,
                                        recovery_rate)
...
def create_fixed_cpn_bond_template(inst_name, issue_date, settlement_days, start_date, maturity,
                                   ...
                                   ex_cpn_period = create_period(0, DAYS), ex_cpn_calendar='', ex_cpn_day_convention=INVALID_BUSINESS_DAY_CONVENTION, ex_cpn_eom=False,
                                   notional_type = CONST_NOTIONAL,
                                   recovery_rate = 0.0):
    '''
...
def create_std_bond_template(inst_name, bond_type, settlement_days, maturity,
    ...
    '''    
    return create_vanilla_bond_template(inst_name, bond_type, create_date(), settlement_days, create_date(), maturity,
                                        0.0, currency, 100.0,                                 
                                        day_count,
                                        calendar, frequency, interest_day_convention, stub_policy, broken_period_type,
                                        pay_day_offset, pay_day_convention,
