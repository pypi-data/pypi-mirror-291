...
class TestIrMarket(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.cny_shibor_3m_swap_template = create_ir_vanilla_swap_template('cny_shibor_3m', 1,
                                                                           ...
                                                                           SPOTSTART)
        self.fr_007_fixings = create_time_series([create_date(2022, 3, 22), create_date(2022,3,23)], [0.026, 0.027])
        self.shibor_3m_fixings = create_time_series([create_date(2022, 3, 22), create_date(2022,3,23)], [0.031, 0.032])
    ...
    def test_create_default_ibor_index(self):
        test = create_ibor_index('shibor_3m', to_period('3m'), 'CNY', ['CAL_CFETS'], 1)
    ...
    def test_build_depo(self):
        ...
        start = create_date(2022,3,25)
        maturity = create_date(2022,6,25)
    ...
    def test_build_fra(self):
        ...
        start = create_date(2022,6,25)
        maturity = create_date(2022,9,25)
    ...
    def test_build_ir_vanilla_swap(self):
        ...
        leg_fixings = create_leg_fixings([['shibor_3m', self.shibor_3m_fixings]])
        test = build_ir_vanilla_instrument(PAY, 0.035, 0.0, create_date(2022,3,25), create_date(2025,3,25), self.cny_shibor_3m_swap_template, 3000000.0, leg_fixings)
