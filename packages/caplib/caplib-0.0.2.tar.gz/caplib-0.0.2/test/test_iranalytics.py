...
class TestIrAnalytics(unittest.TestCase):
    def setUp(self):
        ...
        create_ibor_index('shibor_3m', to_period('3m'), 'CNY', ['CAL_CFETS'], 1,
    ...
    def test_create_ir_mkt_data_set(self):
        ...
        cny_shibor_3m = create_ir_yield_curve(self.as_of_date, 'CNY',
                                              [create_date(2022, 3, 10), create_date(2025, 3, 10)], [0.02, 0.025])
    ...
    def test_ir_vanilla_instrument_pricer(self):
        ...
        shibor_3m_fixings = create_time_series([create_date(2022, 3, 3), create_date(2022, 3, 4)],
                                               [0.1, 0.3],
                                               TimeSeries.Mode.TS_FORWARD_MODE, 'shibor_3m')
        leg_fixings = create_leg_fixings([['shibor_3m', shibor_3m_fixings]])
        swap = build_ir_vanilla_instrument(PAY, 0.05, 0.0,
                                           create_date(2022, 3, 7), create_date(2023, 3, 7),
    ...
    def test_ir_cross_ccy_curve_builder(self):
        ...
        fx_spot = create_fx_spot_rate(foreign_exchange_rate, create_date(2022, 3, 9), create_date(2022, 3, 9))
