...
class RotatingMachine(_message.Message):
    ...
    p: float
    q: float
    def __init__(self, rce: _Optional[_Union[_RegulatingCondEq_pb2.RegulatingCondEq, _Mapping]] = ..., ratedPowerFactor: _Optional[float] = ..., ratedS: _Optional[float] = ..., ratedU: _Optional[float] = ..., p: _Optional[float] = ..., q: _Optional[float] = ...) -> None: ...
