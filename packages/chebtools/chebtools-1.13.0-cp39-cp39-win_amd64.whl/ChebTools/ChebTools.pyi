...
def Clenshaw2DEigencomplex(cmat: Annotated[ArrayLike, dict(dtype='complex128', writable=False, shape=(None, None), order='None')], x: float, y: float) -> "std::complex<double>": ...
...
def dyadic_splitting(N: int, func: Callable[[float], float], xmin: float, xmax: float, M: int, tol: float, max_refine_passes: int = 8, callback: Optional[Callable[[int, Sequence[ChebyshevExpansion]], None]] = None) -> list[ChebyshevExpansion]: ...
...
def evaluation_speed_test(arg0: ChebyshevExpansion, arg1: Annotated[ArrayLike, dict(dtype='float64', shape=(None), order='C')], arg2: int, /) -> "std::map<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,double,std::less<std::basic_string<char,std::char_traits<char>,std::allocator<char> > >,std::allocator<std::pair<std::basic_string<char,std::char_traits<char>,std::allocator<char> > const ,double> > >": ...
