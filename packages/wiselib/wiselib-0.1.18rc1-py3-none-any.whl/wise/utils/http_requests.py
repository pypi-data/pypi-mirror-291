...
class HTTPClientWithMonitoring:
    ...
    def request(self, method: str, url: str, _api_name: str | None, **kwargs):
        start = time_now()
        success = "false"
    ...
    def get(self, url: str, _api_name: str | None, **kwargs):
        return self.request("GET", url, _api_name=_api_name, **kwargs)

    def post(self, url: str, _api_name: str | None, **kwargs):
        return self.request("POST", url, _api_name=_api_name, **kwargs)

    def put(self, url: str, _api_name: str | None, **kwargs):
        return self.request("PUT", url, _api_name=_api_name, **kwargs)

    def patch(self, url: str, _api_name: str | None, **kwargs):
        return self.request("PATCH", url, _api_name=_api_name, **kwargs)

    def delete(self, url: str, _api_name: str | None, **kwargs):
