...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'bellek.hf.datasets.utils': { 'bellek.hf.datasets.utils.chunk_random_dataset': ( 'hf.datasets.utils.html#chunk_random_dataset',
            ...
            'bellek.musique.qa': { 'bellek.musique.qa.answer_question_cot': ('musique.qa.html#answer_question_cot', 'bellek/musique/qa.py'),
                                   'bellek.musique.qa.answer_question_cot_fs': ( 'musique.qa.html#answer_question_cot_fs',
                                                                                 'bellek/musique/qa.py'),
                                   'bellek.musique.qa.answer_question_cte': ('musique.qa.html#answer_question_cte', 'bellek/musique/qa.py'),
                                   'bellek.musique.qa.answer_question_standard': ( 'musique.qa.html#answer_question_standard',
                                                                                   'bellek/musique/qa.py')},
