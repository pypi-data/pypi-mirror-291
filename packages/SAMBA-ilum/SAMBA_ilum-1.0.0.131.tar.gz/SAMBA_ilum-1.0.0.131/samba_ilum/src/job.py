...
job.write(f' \n') 
job.write(f'tasks=( "xyz-scan" "xy-scan" "z-scan" "a-scan" "relax" "scf" "bands" "dos" "bader" "scf.SO" "bands.SO" "dos.SO" "bader.SO" ) \n')
job.write(f' \n')
...
job.write(f'                     if [[ "$k" != "xyz-scan" && "$k" != "xy-scan" && "$k" != "z-scan" "$k" "$k" != "a-scan" ]];  then \n')
job.write(f'                        cp $dir0/$i/$j/POSCAR  $dir0/$i/$k/POSCAR \n')
job.write(f'                        cp $dir0/$i/$j/CONTCAR  $dir0/$i/$k/CONTCAR \n')
job.write(f'                     fi \n')
job.write(f'                  fi \n')
