...
#------------------------------------------------------------------
MT1_00 = tfile[:,18].astype(int);  MT2_00 = tfile[:,22].astype(int)
MT1_01 = tfile[:,19].astype(int);  MT2_01 = tfile[:,23].astype(int)
MT1_10 = tfile[:,20].astype(int);  MT2_10 = tfile[:,24].astype(int)
MT1_10 = tfile[:,21].astype(int);  MT2_10 = tfile[:,25].astype(int)
...
if (n_Lattice == 3):
   ...
   #----------------------------------------------------------------
   MT3_00 = tfile[:,26].astype(int)
   MT3_01 = tfile[:,27].astype(int)
   MT3_10 = tfile[:,28].astype(int)
   MT3_10 = tfile[:,29].astype(int)
...
if (n_structures != 0):
   ...
   for i in range(n_structures):
       ...
       poscar_new.write(f' | MTrans_1 = {MT1_00[i]}_{MT1_01[i]}_{MT1_10[i]}_{MT1_10[i]}')
       poscar_new.write(f' | MTrans_2 = {MT2_00[i]}_{MT2_01[i]}_{MT2_10[i]}_{MT2_10[i]}')
       if (n_Lattice == 3): poscar_new.write(f' | MTrans_3 = {MT3_00[i]}_{MT3_01[i]}_{MT3_10[i]}_{MT3_10[i]}')
