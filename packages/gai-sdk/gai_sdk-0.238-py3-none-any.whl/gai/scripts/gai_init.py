...
def init(force=False):
    console=Console()
    console.print(f"packaged gai.yml path:[yellow]{get_packaged_gai_config_path()}[/]")
    ...
    source = Path(__file__).parent.parent.parent.parent.parent/ "gai" / "gai.yml"
    dest = Path("~/.gai").expanduser()
    console.print(f"Copying [yellow]{source}[/] to [yellow]{dest}[/]")
