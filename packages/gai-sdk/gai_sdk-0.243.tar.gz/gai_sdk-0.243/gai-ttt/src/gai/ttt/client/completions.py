...
class Completions:
    ...
    def _generate_dict(self, messages:list, max_new_tokens:int, temperature:float=None, top_p:float=None, top_k:float=None, json_schema:dict=None, tools:list=None, tool_choice:str=None):
    ...
    def _stream_dict(self, messages:list, max_new_tokens:int, temperature:float=None, top_p:float=None, top_k:float=None, json_schema:dict=None, tools:list=None, tool_choice:str=None):
        if isinstance(messages, str):
            messages = chat_string_to_list(messages)
    ...
    """
    def create(self, messages:list, stream:bool, max_new_tokens:int, temperature:float=None, top_p:float=None, top_k:float=None, json_schema:dict=None, tools:list=None, tool_choice:str=None):

        if not stream:
            response = self._generate_dict(messages, max_new_tokens, temperature, top_p, top_k, json_schema, tools, tool_choice)
            return response
        return (chunk for chunk in self._stream_dict(messages, max_new_tokens, temperature, top_p, top_k, json_schema, tools, tool_choice))
