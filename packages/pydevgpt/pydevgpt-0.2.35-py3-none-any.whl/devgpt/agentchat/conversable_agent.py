...
from devgpt.agentchat.chat import _post_process_carryover_item
from devgpt.exception_utils import InvalidCarryOverType, SenderRequired
...
class ConversableAgent(LLMAgent):
        ...
        if isinstance(llm_config, dict):
            try:
                ...
                raise TypeError(
                    ...
                    " Refer to the docs for more details: https://khulnasoft.github.io/devgpt/docs/topics/llm_configuration#adding-http-client-in-llm_config-for-proxy"
                ) from e
    ...
    def generate_oai_reply(
        ...
        """Generate a reply using devgpt.oai."""
    ...
    async def a_generate_oai_reply(
        ...
        """Generate a reply using devgpt.oai asynchronously."""
        iostream = IOStream.get_default()
        ...
        *,
        ...
        Args:
            ...
            api_style: (literal): the API style for function call.
                ...
                See [Azure OpenAI documentation](https://learn.khulnasoft.com/en-us/azure/ai-services/openai/how-to/function-calling?tabs=python) for details.
