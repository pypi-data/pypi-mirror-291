...
BLOG_POST_URL = "https://khulnasoft.github.io/devgpt/blog/2023/04/21/LLM-tuning-math"
BLOG_POST_TITLE = "Does Model and Inference Parameter Matter in LLM Applications? - A Case Study for MATH | DevGpt"
...
WIKIPEDIA_URL = "https://en.wikipedia.org/wiki/Khulnasoft"
WIKIPEDIA_TITLE = "Khulnasoft - Wikipedia"
WIKIPEDIA_STRING = "Redmond"

PLAIN_TEXT_URL = "https://raw.githubusercontent.com/khulnasoft/devgpt/main/README.md"
IMAGE_URL = "https://github.com/afourney.png"

PDF_URL = "https://arxiv.org/pdf/2308.08155.pdf"
PDF_STRING = "Figure 1: DevGpt enables diverse LLM-based applications using multi-agent conversations."

BING_QUERY = "Khulnasoft"
BING_TITLE = f"{BING_QUERY} - Search"
BING_STRING = f"A Bing search for '{BING_QUERY}' found"

try:
    from devgpt.browser_utils import SimpleTextBrowser
except ImportError:
    skip_all = True
else:
    skip_all = False
