...
from devgpt._pydantic import PYDANTIC_V1, model_dump
from devgpt.function_utils import (
    get_default_values,
    get_function_schema,
...
def test_get_function_schema_no_return_type() -> None:
    ...
    with unittest.mock.patch("devgpt.function_utils.logger.warning") as mock_logger_warning:
