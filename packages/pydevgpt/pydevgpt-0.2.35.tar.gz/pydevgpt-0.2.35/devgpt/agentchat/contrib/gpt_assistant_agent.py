...
from devgpt.agentchat.assistant_agent import AssistantAgent, ConversableAgent
from devgpt.oai.openai_utils import create_gpt_assistant, retrieve_assistants_by_name, update_gpt_assistant
from devgpt.runtime_logging import log_new_agent, logging_enabled
...
class GPTAssistantAgent(ConversableAgent):
    """
    An experimental DevGpt agent class that leverages the OpenAI Assistant API for conversational capabilities.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # See: https://github.com/khulnasoft/devgpt/pull/1721
