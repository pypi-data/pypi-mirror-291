...
assistant = devgpt.AssistantAgent("assistant", llm_config={"config_list": config_list})
...
class AnthropicClient:
    ...
    def create(self, params: Dict[str, Any]) -> Completion:
        ...
        # Convert DevGpt messages to Anthropic messages
        ...
        # Convert output back to DevGpt response format
