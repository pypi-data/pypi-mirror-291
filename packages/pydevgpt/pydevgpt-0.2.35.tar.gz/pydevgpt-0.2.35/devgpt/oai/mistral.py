...
from devgpt.oai.client_utils import should_hide_tools, validate_parameter
...
def tool_def_to_mistral(tool_definitions: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    """Converts DevGpt tool definition to a mistral tool format"""

    mistral_tools = []

    for devgpt_tool in tool_definitions:
        mistral_tool = {
            "type": "function",
            "function": Function(
                name=devgpt_tool["function"]["name"],
                description=devgpt_tool["function"]["description"],
                parameters=devgpt_tool["function"]["parameters"],
            ),
        }
