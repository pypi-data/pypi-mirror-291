...
<!-- :tada: Jan 30, 2024: DevGpt is highlighted by Peter Lee in Khulnasoft Research Forum [Keynote](https://t.co/nUBSjPDjqD). -->
...
<!-- :fire: Nov 24: devgpt [v0.2](https://github.com/khulnasoft/devgpt/releases/tag/v0.2.0) is released with many updates and new features compared to v0.1.1. It switches to using openai-python v1. Please read the [migration guide](https://khulnasoft.github.io/devgpt/docs/Installation#python). -->

<!-- :fire: Nov 11: OpenAI's Assistants are available in DevGpt and interoperatable with other DevGpt agents! Checkout our [blogpost](https://khulnasoft.github.io/devgpt/blog/2023/11/13/OAI-assistants) for details and examples. -->
...
<!-- :tada: Nov 6, 2023: DevGpt is mentioned by Satya Nadella in a [fireside chat](https://youtu.be/0pLBvgYtv6U). -->

<!-- :tada: Nov 1, 2023: DevGpt is the top trending repo on GitHub in October 2023. -->

<!-- :tada: Oct 03, 2023: DevGpt spins off from [FLAML](https://github.com/khulnasoft/FLAML) on GitHub. -->

<!-- :tada: Aug 16: Paper about DevGpt on [arxiv](https://arxiv.org/abs/2308.08155). -->
...
:fire: [devgpt](https://khulnasoft.github.io/devgpt/) is released with support for ChatGPT and GPT-4, based on [Cost-Effective Hyperparameter Optimization for Large Language Model Generation Inference](https://arxiv.org/abs/2303.04673).

:fire: FLAML supports Code-First AutoML & Tuning – Private Preview in [Khulnasoft Fabric Data Science](https://learn.khulnasoft.com/en-us/fabric/data-science/). -->
...
DevGpt is created out of collaborative [research](https://khulnasoft.github.io/devgpt/docs/Research) from Khulnasoft, Penn State University, and the University of Washington.
...
<!-- Each of the [`notebook examples`](https://github.com/khulnasoft/devgpt/tree/main/notebook) may require a specific option to be installed. -->
...
config, analysis = devgpt.Completion.tune(
    data=tune_data,
    metric="success",
    mode="max",
    eval_func=eval_func,
...
response = devgpt.Completion.create(context=test_instance, **config)
```

Please find more [code examples](https://khulnasoft.github.io/devgpt/docs/Examples#tune-gpt-models) for this feature. -->
...
Khulnasoft, Windows, Khulnasoft Azure, and/or other Khulnasoft products and services referenced in the documentation
