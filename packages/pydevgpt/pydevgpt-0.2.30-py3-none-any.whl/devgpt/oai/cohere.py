...
from devgpt.oai.client_utils import validate_parameter
...
class CohereClient:
    ...
    def create(self, params: Dict) -> ChatCompletion:
        ...
        # Convert DevGpt messages to Cohere messages
...
def oai_messages_to_cohere_messages(
    ...
    Parameters:
        messages: list[Dict[str, Any]]: DevGpt messages
        params: Dict[str, Any]:         DevGpt parameters dictionary
    ...
    if len(tool_results) != 0:
        ...
        # Changed key from "content" to "message" (jaygdesai/devgpt_Jay)
