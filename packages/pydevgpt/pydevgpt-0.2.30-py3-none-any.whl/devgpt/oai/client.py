...
from devgpt.cache import Cache
from devgpt.io.base import IOStream
from devgpt.logger.logger_utils import get_current_ts
from devgpt.oai.openai_utils import OAI_PRICE1K, get_key, is_valid_api_key
from devgpt.runtime_logging import log_chat_completion, log_new_client, log_new_wrapper, logging_enabled
...
try:
    ...
    ERROR: Optional[ImportError] = ImportError("Please install openai>=1 and diskcache to use devgpt.OpenAIWrapper.")
    OpenAI = object
    AzureOpenAI = object
else:
