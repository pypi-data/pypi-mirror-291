...
try:
    ...
    # The devgpt.Completion class requires openai<1
    ERROR = AssertionError("(Deprecated) The devgpt.Completion class requires openai<1 and diskcache. ")
...
class Completion(openai_Completion):
    ...
    def tune(
        ...
        **config,
        ...
        """
        logger.warning(
            "tuning via Completion.tune is deprecated in devgpt v0.2 and openai>=1. "
        ...
        **config,
        ...
        Args:
            context (Dict, Optional): The context to instantiate the prompt.
                ...
                More examples can be found at [templating](https://khulnasoft.github.io/devgpt/docs/Use-Cases/enhanced_inference#templating).
        ...
        """
        logger.warning(
            "Completion.create is deprecated in devgpt v0.2 and openai>=1. "
            "The new openai requires initiating a client for inference. "
            "Please refer to https://khulnasoft.github.io/devgpt/docs/Use-Cases/enhanced_inference#api-unification"
        )
        if ERROR:
            raise ERROR
    ...
    def start_logging(
        ...
        """
        logger.warning(
            "logging via Completion.start_logging is deprecated in devgpt v0.2. "
