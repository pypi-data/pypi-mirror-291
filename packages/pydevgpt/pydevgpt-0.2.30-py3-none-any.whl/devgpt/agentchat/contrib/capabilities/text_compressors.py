...
class LLMLingua:
    ...
    def __init__(
        ...
        prompt_compressor_kwargs: Dict = dict(
            model_name="khulnasoft/llmlingua-2-bert-base-multilingual-cased-meetingbank",
            use_llmlingua2=True,
            device_map="cpu",
        ),
        ...
        Args:
            prompt_compressor_kwargs (dict): A dictionary of keyword arguments for the PromptCompressor. Defaults to a
                dictionary with model_name set to "khulnasoft/llmlingua-2-bert-base-multilingual-cased-meetingbank",
