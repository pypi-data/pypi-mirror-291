...
from devgpt import Agent, ConversableAgent, code_utils
from devgpt.agentchat.contrib import img_utils
from devgpt.agentchat.contrib.capabilities.agent_capability import AgentCapability
from devgpt.agentchat.contrib.text_analyzer_agent import TextAnalyzerAgent
from devgpt.cache import AbstractCache
...
class ImageGeneration(AgentCapability):
    ...
    Example:
        ```python
        import devgpt
        from devgpt.agentchat.contrib.capabilities.image_generation import ImageGeneration

        # Assuming you have llm configs configured for the LLMs you want to use and Dalle.
        # Create the agent
        agent = devgpt.ConversableAgent(
