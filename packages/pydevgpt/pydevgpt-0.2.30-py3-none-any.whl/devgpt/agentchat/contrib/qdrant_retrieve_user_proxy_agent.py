...
from devgpt.agentchat.contrib.vectordb.utils import (
    chroma_results_to_query_results,
    filter_results_by_distance,
    get_logger,
)
from devgpt.retrieve_utils import TEXT_FORMATS, get_files_from_dir, split_files_to_chunks
        ...
        Args:
            ...
            retrieve_config (dict or None): config for the retrieve agent.
                ...
                - collection_name (Optional, str): the name of the collection.
                    If key not provided, a default name `devgpt-docs` will be used.
                ...
                - custom_text_split_function (Optional, Callable): a custom function to split a string into a list of strings.
                    Default is None, will use the default function in `devgpt.retrieve_utils.split_text_to_chunks`.
                - custom_text_types (Optional, List[str]): a list of file types to be processed. Default is `devgpt.retrieve_utils.TEXT_FORMATS`.
