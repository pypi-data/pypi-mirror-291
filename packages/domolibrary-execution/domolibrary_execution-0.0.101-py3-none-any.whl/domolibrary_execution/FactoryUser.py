...
async def modify_config_calc_domo_role(
    ...
    **kwargs,
    ...
    try:
        domo_role = await dmrh.calc_role(current_role_id = domo_user.role_id, new_role_name = domo_role.name, auth = config.auth, debug_prn = True)
...
async def upsert_user(
    ...
    **kwargs,
    ...
    if modify_config_fn:
        ...
        user_display_name = config.display_name
