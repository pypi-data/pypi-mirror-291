...
shot_relation = "/api/project/%s/%s/%s/relation/asset/list" #%(project_idx,which,which_idx)
shot_last_version_list = '/api/shots/last_version/list'
...
# track_shot_task_list = '/api/project/%s/episode/%s/track/shot/task/read' #%(project_idx,episode_idx)
track_shot_task_list = '/api/project/%s/episode/%s/sequence/%s/track/shot/task/read' #%(project_idx,episode_idx,sequence_idx)
track_asset_task_list = '/api/project/%s/asset_category/%s/track/asset/task/read' #%(project_idx,category_idx)
