...
if importlib.util.find_spec("starlette.middleware.sessions") is not None:
                ...
                with gradio.Row():
                    ...
                    try:
                        ...
                        token = gradio.Textbox(
                            type="password", label="OAuth Token", interactive=True
                        )
                        export_button_hf.click(
                            fn=self._export_data_hf_with_token,
