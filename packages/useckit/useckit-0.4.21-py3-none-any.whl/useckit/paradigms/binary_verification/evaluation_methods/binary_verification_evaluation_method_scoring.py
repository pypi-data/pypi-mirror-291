...
class BinaryScoringVerification(VerificationBaseEvaluationMethod):
    ...
    def _calculate_proba_based_predictions(self, verification_graph: list[dict]) -> pd.DataFrame:
        """TODO remove this WIP comment.

        Eingabe: ein Graph namens "results". Er enthält für OVR N-Klassen und für OVO N!(N-1) whatever Eingaben.
        Jeder Eintrag ist außerdem eine Prediction.

        1. Mergen
        2. Entpacken
        3. Auswerten
        3a. Bei WS: auswerten mit Major Vote
        """
