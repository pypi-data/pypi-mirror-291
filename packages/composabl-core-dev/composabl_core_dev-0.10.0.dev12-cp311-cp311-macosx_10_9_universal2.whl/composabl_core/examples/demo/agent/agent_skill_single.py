...
from composabl_core import Skill
...
skill1 = Skill("teacher-skill-dictionary", TeacherSpaceDictionary)
skill2 = Skill("teacher-skill-dictionary2", TeacherSpaceDictionary)
skill_group = SkillGroup(skill1, skill2)

agent_skill_group = Agent()
agent_skill_group.add_sensors(sensors_dict["dictionary"])
agent_skill_group.add_skill(skill1)
agent_skill_group.add_skill_group(skill_group)
