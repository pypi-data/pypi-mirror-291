...
class Evaluator:
    ...
    def evaluate(self, source_tests:str=None) -> List[L1DocTest]:
        ...
        return self.__evaluate_l1doctests(source_tests) 
    
    def __evaluate_l1doctests(self, source_tests:str=None) -> List[L1DocTest]:
        """
