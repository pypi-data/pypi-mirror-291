...
class Cast(depthai.Node):
    class Properties:
        ...
        outputType: depthai.RawImgFrame.Type
...
class ImageAlign(depthai.Node):
    class Properties:
        alignHeight: int
        alignWidth: int
        initialConfig: depthai.RawImageAlignConfig
        interpolation: depthai.Interpolation
        numFramesPool: int
        numShaves: int
...
class PointCloud(depthai.Node):
    class Properties:
        initialConfig: depthai.RawPointCloudConfig
        numFramesPool: int
        def __init__(self, *args, **kwargs) -> None: ...
    def __init__(self, *args, **kwargs) -> None: ...
    def setNumFramesPool(self, arg0: int) -> None: ...
