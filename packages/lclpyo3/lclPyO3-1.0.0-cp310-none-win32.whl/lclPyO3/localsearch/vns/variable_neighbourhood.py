from lclPyO3.localsearch.abstract_local_search import AbstractLocalSearch
from lclPyO3.termination.always_true_criterion import AlwaysTrueCriterion

from lclPyO3.aidfunc.is_improvement_func import bigger, smaller
from lclPyO3.aidfunc.pass_func import pass_func
from lclPyO3.aidfunc.add_to_data_func import add_to_data_func
from lclPyO3.aidfunc.convert_data import convert_data
from lclPyO3.aidfunc.error_func import NoNextNeighbourhood
from lclPyO3.aidfunc.logging import log_improvement
...
class VariableNeighbourhood(AbstractLocalSearch):
    ...
    .. doctest::
        ...
        >>> import numpy
        >>> from lclPyO3.localsearch.vns.variable_neighbourhood \\
        ...     import VariableNeighbourhood
        >>> from lclPyO3.localsearch.move.tsp_array_swap import TspArraySwap
        >>> from lclPyO3.localsearch.move.array_reverse_order \\
        ...     import ArrayReverseOrder
        >>> from lclPyO3.localsearch.move.multi_neighbourhood \\
        ...     import MultiNeighbourhood
        >>> from lclPyO3.localsearch.vns.variable_neighbourhood \\
        ...     import VariableNeighbourhood
        >>> from lclPyO3.evaluation.tsp_evaluation_function \\
    ...
    def reset(self):
        ...
        .. doctest::
            ...
            >>> from lclPyO3.localsearch.vns.variable_neighbourhood \\
            ...     import VariableNeighbourhood
            >>> from lclPyO3.localsearch.move.tsp_array_swap \\
            ...     import TspArraySwap
            >>> from lclPyO3.localsearch.move.array_reverse_order \\
            ...     import ArrayReverseOrder
            >>> from lclPyO3.localsearch.move.multi_neighbourhood \\
