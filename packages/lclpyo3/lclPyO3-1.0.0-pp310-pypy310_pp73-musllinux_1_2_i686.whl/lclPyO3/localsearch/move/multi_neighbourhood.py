...
import itertools
import numpy
from lclPyO3.localsearch.move.abstract_move \
    import AbstractMove
...
class MultiNeighbourhood(AbstractMove):
    ...
    .. doctest::
        ...
        >>> import numpy
        >>> from lclPyO3.localsearch.move.array_swap import ArraySwap
    ...
    .. doctest::
        ...
        >>> from lclPyO3.localsearch.move.multi_neighbourhood \\
        ...     import MultiNeighbourhood
        >>> from lclPyO3.evaluation.quadratic_assignment_evaluation_function \\
