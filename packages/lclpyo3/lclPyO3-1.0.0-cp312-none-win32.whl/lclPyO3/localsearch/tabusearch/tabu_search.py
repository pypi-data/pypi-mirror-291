...
from lclPyO3.localsearch.tabusearch.tabu_list import TabuList
...
class TabuSearch(AbstractLocalSearch):
    ...
    .. doctest::
        ...
        >>> from lclPyO3.localsearch.tabusearch.sum_diff_state \\
        ...     import SumDiffState
    ...
    def reset(self):
        ...
        .. doctest::
            ...
            >>> import numpy
            >>> import random
            >>> from lclPyO3.localsearch.tabusearch.tabu_search \\
            ...     import TabuSearch
