...
from lclPyO3.localsearch.acceptance.simulated_annealing_acceptance_function \
    import SimulatedAnnealingAcceptanceFunction

from lclPyO3.aidfunc.is_improvement_func \
...
class SimulatedAnnealing(AbstractLocalSearch):
    ...
    .. doctest::
        ...
        >>> from lclPyO3.localsearch.simulatedannealing.simulated_annealing \\
        ...     import SimulatedAnnealing
        >>> from lclPyO3.localsearch.simulatedannealing.geometric_cooling_function \\
        ...     import GeometricCoolingFunction
        >>> from lclPyO3.localsearch.simulatedannealing.cnst_iterations_temp_function \\
        ...     import CnstIterationsTempFunction
        >>> from lclPyO3.evaluation.tsp_evaluation_function \\
        ...     import TspEvaluationFunction
        >>> from lclPyO3.termination.min_temperature_termination_criterion \\
