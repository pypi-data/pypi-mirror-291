...
class Instrument(_message.Message):
    __slots__ = ("platform", "kind", "id", "name", "price_tick", "volume_tick", "long_margin_ratio", "short_margin_ratio", "max_leverage", "volume_multiple", "max_order_size", "min_order_size", "is_trading", "exchange_id", "info", "extend")
