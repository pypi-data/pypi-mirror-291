...
from ._01_helpers import shorten as _shorten
...
class Scraper(Generic[WebtoonId]):  # MARK: SCRAPER
    ...
    def from_url(
        ...
        **kwargs,
        ...
        try:
            webtoon_id: WebtoonId | None = cls._extract_webtoon_id(furl(url))
    ...
    @classmethod
    @abstractmethod
    def _extract_webtoon_id(cls, url: furl) -> WebtoonId | None:
        raise NotImplementedError
