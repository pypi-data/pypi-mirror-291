...
class ReportModifier:
    ...
    **Option "keyword_as_structure"**
    ...
    def write_report(self) -> None:
        ...
        The yaml-configuration needs to be set as test tag. It's possible to define a
        basic configuration, therefore "report:basic_config needs to be set as tag and
