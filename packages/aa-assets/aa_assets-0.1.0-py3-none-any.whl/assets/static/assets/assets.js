    ...
    return $(tableId).DataTable({
        ...
        'columns': [
            ...
            },
            {
                'data': null,
                'render': function(data, type, row) {
                    return '<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#buyModal" data-action="single" data-item-id="' + row.item_id + '" data-item-name="' + row.name + '" data-item-quantity="' + row.quantity + '">Buy</button>';
                }
            }
        ],
        'order': [[4, 'desc']],
