...
class Search:
    async def search(self, query: str, limit: int = 10, offset: int = 0) -> Union[dict, None]:
        """
        Ищет артистов, альбомы, аудиотреки и плейлисты по запросу.

        Пример использования:\n
        result = await client.search(query="prombl", limit=1)\n
        print(result)
    ...
    async def searchArtists(self, query: str, limit: int = 10, offset: int = 0) -> Union[List[Union[Artist, dict]], Artist, dict, None]:
        """
        Ищет артистов по запросу.

        Пример использования:\n
        result = await client.searchArtists(query="prombl", limit=1)\n
        print(result)
    ...
    async def searchAlbums(self, query: str, limit: int = 10, offset: int = 0) -> Union[List[Union[Album, dict]], Album, dict, None]:
        """
        Ищет альбомы по запросу.

        Пример использования:\n
        result = await client.searchAlbums(query="prombl — npc", limit=1)\n
        print(result)
    ...
    async def searchTracks(self, query: str, limit: int = 10, offset: int = 0) -> Union[List[Union[Track, dict]], Track, dict, None]:
        """
        Ищет аудиотреки по запросу.

        Пример использования:\n
        result = await client.searchTracks(query="prombl — zapreti", limit=1)\n
        print(result)
    ...
    async def searchPlaylists(self, query: str, limit: int = 10, offset: int = 0) -> Union[List[Union[Playlist, dict]], Playlist, dict, None]:
        """
        Ищет плейлисты по запросу.

        Пример использования:\n
        result = await client.searchPlaylists(query="Релизы 20.10.2023", limit=1)\n
        print(result)
    ...
    async def _searchItems(self, method: str, params: tuple, itemClass: Union[List[Type[Union[Artist, Album, Track, Playlist]]], Type[Union[Artist, Album, Track, Playlist]]]) -> Union[List[Union[Artist, Album, Track, Playlist]], Artist, Album, Track, Playlist, dict, None]:
