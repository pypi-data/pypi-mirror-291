...
class Update:
    ...
    def copyPlaylist(self, playlistId: int, ownerId: int = None, groupId: int = None, newTitle: Union[str, None] = str(), newDescription: Union[str, None] = str(), newPhoto: Union[str, None] = str()) -> Union[int, None, dict]:
        """
        ...
        photo = getattr(playlist, "photo", None)
        ...
        self.add(list(ownerIds), list(trackIds), newPlaylistId, groupId)
