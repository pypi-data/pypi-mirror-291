...
class Utils:
    async def APIReq(self, method: str, params: dict = {}, HTTPMethod: str = "GET") -> Union[dict, List[dict], bool, int]:
        """
        ...
        result = await client.APIReq(method="wall.post", params={"message": "Привет, мир!"}, HTTPMethod="POST")\n
        print(result)
    ...
    async def createVKccUrl(self, url: str) -> str:
        ...
        Пример использования:\n
        result = await client.createVKccUrl(url="google.com")\n
        print(result)
