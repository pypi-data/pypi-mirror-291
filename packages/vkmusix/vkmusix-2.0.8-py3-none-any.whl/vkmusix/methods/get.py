...
class Get:
    ...
    def getTracks(self, groupId: int = None) -> Union[List[Track], Track, None, dict]:
        """
    ...
    def getRelatedArtists(self, artistId: int, limit: int = 10) -> Union[List[Artist], Artist, None, dict]:
        """
        ...
        return finalizeResponse(self._VKReq("getRelatedArtistsById", {"artist_id": artistId, "count": limit}).get("artists"), Artist)


    def _getTracks(self, tracks: str, objectType: Union[Type[Union[Album, Playlist]], None] = None) -> Union[List[Track], dict]:
    ...
    def getPlaylists(self, ownerId: int = None, playlistTypes: Union[str, List[str]] = ["own", "foreign", "album"]) -> Union[List[Union[Playlist, Album]], Playlist, Album, None, dict]:
        """
    ...
    def getCuratorTracks(self, curatorId: int, limit: int = 10, offset: int = 0) -> Union[List[Track], Track, None, dict]:
        """
    ...
    def getTracksFromFeed(self) -> Union[List[Track], dict]:
        """
    ...
    def getRecommendations(self, limit: int = 10, offset: int = 0, ownerId: int = None, trackId: int = None) -> Union[List[Track], Track, None, dict]:
        """
        ...
        return finalizeResponse(self._VKReq("getRecommendations", {"count": limit, "offset": offset, **({"target_audio": f"{ownerId}_{trackId}"} if all((ownerId, trackId)) else {})}).get("items"), Track)


    def getNew(self) -> Union[List[Track], dict]:
        """
    ...
    def getPopular(self) -> Union[List[Track], dict]:
        """
    ...
    def getEditorsPicks(self) -> Union[List[Track], dict]:
        """
    ...
    def getTrackCount(self, ownerId: int) -> Union[int, dict]:
        """
    ...
    def getSearchTrends(self, limit: int = 10, offset: int = 0) -> Union[List[str], str, None, dict]:
        """
    ...
    def getBroadcast(self, id: int = None, isGroup: bool = False) -> Union[Track, None, bool, dict]:
        """
