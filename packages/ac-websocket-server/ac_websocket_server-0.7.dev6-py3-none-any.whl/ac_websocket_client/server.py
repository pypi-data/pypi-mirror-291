...
class ServerUI(GriddedFrame):
    ...
    def __init__(self, parent):
        ...
        self._lights['registered'] = TrafficLight(self, row=1, column=4)
        ...
        self._buttons['save'] = tk.StringVar(value='Save')
        ...
        self._lights['save'] = TrafficLight(self, row=2, column=4)
        ...
        GriddedButton(self, grid_row=5, grid_col=3,
        ...
        GriddedButton(self, grid_row=6, grid_col=3,
        ...
        GriddedButton(self, grid_row=7, grid_col=3,
    ...
    def update_ui(self):
        ...
        if self.parent.states.needs_saving:
