...
class TestJobHistories:
    parametrize = pytest.mark.parametrize("client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    def test_method_create(self, client: EndexFactsetPeople) -> None:
        job_history = client.job_histories.create(
            ids=["0DPHLH-E"],
        )
        assert_matches_type(PeopleJobsResponse, job_history, path=["response"])
    ...
    def test_raw_response_create(self, client: EndexFactsetPeople) -> None:
        response = client.job_histories.with_raw_response.create(
            ids=["0DPHLH-E"],
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        job_history = response.parse()
        assert_matches_type(PeopleJobsResponse, job_history, path=["response"])

    @parametrize
    def test_streaming_response_create(self, client: EndexFactsetPeople) -> None:
        with client.job_histories.with_streaming_response.create(
            ids=["0DPHLH-E"],
        ) as response:
    ...
    def test_method_list(self, client: EndexFactsetPeople) -> None:
        job_history = client.job_histories.list(
            ids=["string"],
        )
        assert_matches_type(PeopleJobsResponse, job_history, path=["response"])
    ...
    def test_raw_response_list(self, client: EndexFactsetPeople) -> None:
        response = client.job_histories.with_raw_response.list(
            ids=["string"],
        )
    ...
    def test_streaming_response_list(self, client: EndexFactsetPeople) -> None:
        with client.job_histories.with_streaming_response.list(
            ids=["string"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncJobHistories:
    ...
    async def test_raw_response_create(self, async_client: AsyncEndexFactsetPeople) -> None:
        response = await async_client.job_histories.with_raw_response.create(
            ids=["0DPHLH-E"],
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        job_history = await response.parse()
        assert_matches_type(PeopleJobsResponse, job_history, path=["response"])

    @parametrize
    async def test_streaming_response_create(self, async_client: AsyncEndexFactsetPeople) -> None:
        async with async_client.job_histories.with_streaming_response.create(
            ids=["0DPHLH-E"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_list(self, async_client: AsyncEndexFactsetPeople) -> None:
        job_history = await async_client.job_histories.list(
            ids=["string"],
        )
        assert_matches_type(PeopleJobsResponse, job_history, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncEndexFactsetPeople) -> None:
        response = await async_client.job_histories.with_raw_response.list(
            ids=["string"],
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncEndexFactsetPeople) -> None:
        async with async_client.job_histories.with_streaming_response.list(
            ids=["string"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
