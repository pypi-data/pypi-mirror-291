...
from endex_factset_people import EndexFactsetPeople, AsyncEndexFactsetPeople, APIResponseValidationError
from endex_factset_people._models import BaseModel, FinalRequestOptions
from endex_factset_people._constants import RAW_RESPONSE_HEADER
from endex_factset_people._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from endex_factset_people._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: EndexFactsetPeople | AsyncEndexFactsetPeople) -> int:
...
class TestEndexFactsetPeople:
    client = EndexFactsetPeople(base_url=base_url, access_token=access_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "endex_factset_people/_legacy_response.py",
                        "endex_factset_people/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "endex_factset_people/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: EndexFactsetPeople) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENDEX_FACTSET_PEOPLE_BASE_URL="http://localhost:5000/from/env"):
            client = EndexFactsetPeople(access_token=access_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: EndexFactsetPeople) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: EndexFactsetPeople) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: EndexFactsetPeople) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = EndexFactsetPeople(
        ...
        client = EndexFactsetPeople(base_url=base_url, access_token=access_token, _strict_response_validation=False)
    ...
    @mock.patch("endex_factset_people._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/factset-people/v1/profiles").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            self.client.post(
                "/factset-people/v1/profiles",
                body=cast(object, dict(ids=["0DPHLH-E"])),
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/factset-people/v1/profiles").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        self, client: EndexFactsetPeople, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        ...
        respx_mock.post("/factset-people/v1/profiles").mock(side_effect=retry_handler)

        response = client.profiles.with_raw_response.create(ids=["0DPHLH-E"])

        assert response.retries_taken == failures_before_success


class TestAsyncEndexFactsetPeople:
    client = AsyncEndexFactsetPeople(base_url=base_url, access_token=access_token, _strict_response_validation=True)
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = AsyncEndexFactsetPeople(
            base_url=base_url,
            access_token=access_token,
            _strict_response_validation=True,
            default_headers={
    ...
    def test_multipart_repeating_array(self, async_client: AsyncEndexFactsetPeople) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENDEX_FACTSET_PEOPLE_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncEndexFactsetPeople(access_token=access_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncEndexFactsetPeople) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncEndexFactsetPeople) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncEndexFactsetPeople) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncEndexFactsetPeople(
            base_url=base_url, access_token=access_token, _strict_response_validation=True
        )
    ...
    async def test_retries_taken(
        self, async_client: AsyncEndexFactsetPeople, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        ...
        response = await client.profiles.with_raw_response.create(ids=["0DPHLH-E"])
