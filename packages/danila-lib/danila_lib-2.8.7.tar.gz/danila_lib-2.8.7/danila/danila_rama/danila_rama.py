...
class Danila_rama:
    def __init__(self, local, yolov5_dir, danila_rama_params):
        if danila_rama_params.danila_rama_text_recognize_params.prod_redone:
            self.danila_rama = Danila_rama_base(local, yolov5_dir=yolov5_dir, danila_rama_params=danila_rama_params)
        else:
