...
def sample_excel_file(tmp_path):
    ...
    df_taxonomy = pd.DataFrame({
        ...
        'Order': ['Primates', 'Carnivora', 'Coleoptera'],
        'Family': ['Hominidae', 'Felidae', 'Carabidae'],
        'Subfamily': ['', '', ''],
        'Tribe': ['', '', ''],
        'Genus': ['Homo', 'Felis', 'Carabus'],
...
def test_tree_topology(sample_excel_file):
    ...
    assert homo_sapiens.guids == {"processid": "P1", "sampleid": "S1"}
    ...
    assert carabus_coriaceus.guids == {"processid": "P3", "sampleid": "S3"}
