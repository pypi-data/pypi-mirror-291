...
def _graft_lineage(tree, lineage):
    """
...
class Parser:
    ...
    def parse(self):
        ...
        for _, row in taxonomy.iterrows():
            ...
            # Annotate the lowest taxon object with the sample ID
            if lineage:
                lineage[-1].guids = {"processid": lab_mapping[sample_id], "sampleid": sample_id}

            # Graft the lineage onto the tree
            _graft_lineage(tree, lineage)
