#!/bin/bash
#SBATCH --job-name=FePc_med_spin_NHO_on_Fe_parallel_3-c5ZPr2TSi4
...
cp -v "$SLURM_SUBMIT_DIR"/{*.com,*.chk,*.py,*.traj,*.pkl} "$TMP_WORK_DIR"/
