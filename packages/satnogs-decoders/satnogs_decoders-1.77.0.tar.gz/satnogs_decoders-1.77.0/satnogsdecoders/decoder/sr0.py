...
class Sr0(KaitaiStruct):
    ...
    :field callsign_lora: id1.id2.ax25_frame.ax25_payload.callsign_fsk
    ...
    class Type1(KaitaiStruct):
        ...
        def lora_or_fsk(self):
            if hasattr(self, '_m_lora_or_fsk'):
                return self._m_lora_or_fsk if hasattr(self, '_m_lora_or_fsk') else None
    ...
    class Lora(KaitaiStruct):
        ...
        def battery_temperature_celsius(self):
            if hasattr(self, '_m_battery_temperature_celsius'):
                return self._m_battery_temperature_celsius if hasattr(self, '_m_battery_temperature_celsius') else None
        ...
        def solar_bus_current_a(self):
            if hasattr(self, '_m_solar_bus_current_a'):
                return self._m_solar_bus_current_a if hasattr(self, '_m_solar_bus_current_a') else None
        ...
        def base_plate_temperature_celsius(self):
            if hasattr(self, '_m_base_plate_temperature_celsius'):
                return self._m_base_plate_temperature_celsius if hasattr(self, '_m_base_plate_temperature_celsius') else None
        ...
        def solar_panel_temperature_celsius(self):
            if hasattr(self, '_m_solar_panel_temperature_celsius'):
                return self._m_solar_panel_temperature_celsius if hasattr(self, '_m_solar_panel_temperature_celsius') else None
        ...
        def bus_current_a(self):
            if hasattr(self, '_m_bus_current_a'):
                return self._m_bus_current_a if hasattr(self, '_m_bus_current_a') else None
        ...
        def solar_bus_voltage_v(self):
            if hasattr(self, '_m_solar_bus_voltage_v'):
                return self._m_solar_bus_voltage_v if hasattr(self, '_m_solar_bus_voltage_v') else None
        ...
        def battery_remaining_capacity_ah(self):
            if hasattr(self, '_m_battery_remaining_capacity_ah'):
                return self._m_battery_remaining_capacity_ah if hasattr(self, '_m_battery_remaining_capacity_ah') else None
        ...
        def obc_temperature_celsius(self):
            if hasattr(self, '_m_obc_temperature_celsius'):
                return self._m_obc_temperature_celsius if hasattr(self, '_m_obc_temperature_celsius') else None
        ...
        def external_temperature_celsius(self):
            if hasattr(self, '_m_external_temperature_celsius'):
                return self._m_external_temperature_celsius if hasattr(self, '_m_external_temperature_celsius') else None
        ...
        def bus_voltage_v(self):
            if hasattr(self, '_m_bus_voltage_v'):
                return self._m_bus_voltage_v if hasattr(self, '_m_bus_voltage_v') else None
        ...
        def battery_maximum_capacity_ah(self):
            if hasattr(self, '_m_battery_maximum_capacity_ah'):
                return self._m_battery_maximum_capacity_ah if hasattr(self, '_m_battery_maximum_capacity_ah') else None
        ...
        def radiation_microsv_per_h(self):
            if hasattr(self, '_m_radiation_microsv_per_h'):
                return self._m_radiation_microsv_per_h if hasattr(self, '_m_radiation_microsv_per_h') else None
