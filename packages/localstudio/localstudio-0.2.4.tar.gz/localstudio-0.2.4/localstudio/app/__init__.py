...
from localstudio.app import config, swagger
...
from localstudio.app.utils import cache, fs, logs, monitoring
from localstudio.app.utils.flask import ParsedUserAgent, ORJSONProvider
...
def configure_auth():
    from localstudio.app.services import persons_service
...
def load_api(app):
    from localstudio.app import api
