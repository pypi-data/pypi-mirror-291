...
from localstudio.app.utils import permissions, shell
from localstudio.app.services import projects_service, stats_service
...
class StatusResourcesResource(BaseStatusResource):
    def get(self):
        ...
        if config.ENABLE_JOB_QUEUE:
            from localstudio.app.stores.queue_store import job_queue
