...
from localstudio.app.stores import publisher_store
...
def emit(event, data={}, persist=True, project_id=None):
    ...
    from localstudio.app.config import ENABLE_JOB_QUEUE
...
def save_event(event, data, project_id=None):
    ...
    """
    try:
        from localstudio.app.services.persons_service import get_current_user_raw
