...
from localstudio.app.utils import thumbnail as thumbnail_utils
from localstudio.app.stores import auth_tokens_store, file_store
...
def dump_database(store=False):
    ...
    filename = f"localstudio-db-backup-{now}.sql.gz"
    if store:
