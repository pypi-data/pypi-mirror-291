...
from localstudio import __version__ as localstudio_version
...
def init_monitoring(app):
    ...
    if config.PROMETHEUS_METRICS_ENABLED:
        ...
        metrics.info("localstudio_info", "Application info", version=localstudio_version)
