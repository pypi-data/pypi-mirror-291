...
from localstudio.app.utils import dbhelpers, auth, commands
from localstudio.app.services import persons_service, auth_service
...
from localstudio import __file__ as root_path
...
def version():
    ...
    """
    from localstudio import __version__

    print(f"localstudioversion: {__version__}")
...
def clear_memory_cache():
    ...
    from localstudio.app import cache
...
def dump_database(store=False):
    """
    Dump database described in localstudioenvironment variables and save it to
