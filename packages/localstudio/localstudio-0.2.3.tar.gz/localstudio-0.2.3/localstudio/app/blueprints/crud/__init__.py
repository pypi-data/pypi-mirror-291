...
from localstudio.app.blueprints.crud.asset_instance import (
    AssetInstanceResource,
    AssetInstancesResource,
)
from localstudio.app.blueprints.crud.attachment_file import (
    AttachmentFilesResource,
    AttachmentFileResource,
)
from localstudio.app.blueprints.crud.comments import CommentsResource, CommentResource
from localstudio.app.blueprints.crud.custom_action import (
    CustomActionsResource,
    CustomActionResource,
)
from localstudio.app.blueprints.crud.status_automation import (
    StatusAutomationsResource,
    StatusAutomationResource,
)
from localstudio.app.blueprints.crud.day_off import DayOffsResource, DayOffResource
from localstudio.app.blueprints.crud.department import (
    DepartmentsResource,
    DepartmentResource,
)
from localstudio.app.blueprints.crud.entity import EntityResource, EntitiesResource
from localstudio.app.blueprints.crud.entity_type import (
    EntityTypesResource,
    EntityTypeResource,
)
from localstudio.app.blueprints.crud.entity_link import (
    EntityLinksResource,
    EntityLinkResource,
)
from localstudio.app.blueprints.crud.event import EventsResource, EventResource
from localstudio.app.blueprints.crud.file_status import (
    FileStatusesResource,
    FileStatusResource,
)
from localstudio.app.blueprints.crud.metadata_descriptor import (
    MetadataDescriptorsResource,
    MetadataDescriptorResource,
)
from localstudio.app.blueprints.crud.milestone import (
    MilestonesResource,
    MilestoneResource,
)
from localstudio.app.blueprints.crud.notification import (
    NotificationsResource,
    NotificationResource,
)
from localstudio.app.blueprints.crud.organisation import (
    OrganisationsResource,
    OrganisationResource,
)
from localstudio.app.blueprints.crud.output_file import (
    OutputFilesResource,
    OutputFileResource,
)
from localstudio.app.blueprints.crud.output_type import (
    OutputTypeResource,
    OutputTypesResource,
)
from localstudio.app.blueprints.crud.news import NewssResource, NewsResource
from localstudio.app.blueprints.crud.person import PersonResource, PersonsResource
from localstudio.app.blueprints.crud.preview_file import (
    PreviewFilesResource,
    PreviewFileResource,
)
from localstudio.app.blueprints.crud.playlist import (
    PlaylistsResource,
    PlaylistResource,
)
from localstudio.app.blueprints.crud.project import (
    ProjectResource,
    ProjectsResource,
    ProjectTaskTypeLinksResource,
)
from localstudio.app.blueprints.crud.project_status import (
    ProjectStatusResource,
    ProjectStatussResource,
)
from localstudio.app.blueprints.crud.schedule_item import (
    ScheduleItemsResource,
    ScheduleItemResource,
)
from localstudio.app.blueprints.crud.subscription import (
    SubscriptionsResource,
    SubscriptionResource,
)
from localstudio.app.blueprints.crud.search_filter import (
    SearchFiltersResource,
    SearchFilterResource,
)
from localstudio.app.blueprints.crud.search_filter_group import (
    SearchFilterGroupsResource,
    SearchFilterGroupResource,
)
from localstudio.app.blueprints.crud.software import (
    SoftwaresResource,
    SoftwareResource,
)
from localstudio.app.blueprints.crud.task_type import (
    TaskTypesResource,
    TaskTypeResource,
)
from localstudio.app.blueprints.crud.task_status import (
    TaskStatusesResource,
    TaskStatusResource,
)
from localstudio.app.blueprints.crud.task import TasksResource, TaskResource
from localstudio.app.blueprints.crud.time_spent import (
    TimeSpentsResource,
    TimeSpentResource,
)
from localstudio.app.blueprints.crud.working_file import (
    WorkingFilesResource,
    WorkingFileResource,
)
from localstudio.app.blueprints.crud.preview_background_file import (
