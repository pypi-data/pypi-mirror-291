...
from localstudio.utils import movie
from localstudio.app.utils import (
    events,
    fields,
    remote_job,
...
from localstudio.app.utils import fs
...
def prepare_and_store_movie(
    ...
    and store the files.
    """
    from localstudio.app import app as current_app
