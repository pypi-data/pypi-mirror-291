...
class UpdateConnector(BrynQ):
    ...
    def update_creditor(self, method: str, data: dict, overload_fields: dict = None) -> requests.Response:
        ...
        :return: status code for request and optional error message
        """
        allowed_fields_base = ['creditor_id', 'is_creditor', 'collective_account', 'preferred_delivery_method', 'automatic_payment', 'compact', 'payment_specification', 'remark', 'preferred_provisioning',
                               'social_security_number', 'date_of_birth', 'preferred_iban']
        allowed_fields_person = ['person_id', 'internal_id', 'match_person_on', 'log_birthname_seperately', 'gender', 'salutation', 'correspondence', 'email', 'mobile_phone',
                                 'outsite_access', 'outsite_email', 'auto_number', 'postal_address_applied', 'first_name', 'middle_name', 'last_name']
