...
class DataMatrixEncodeMode(Enum):
      """!
       ...
       #Auto mode
       codetext = "犬Right狗";
       generator = BarcodeGenerator(EncodeTypes.DATA_MATRIX, codetext);
       ...
       generator = BarcodeGenerator(EncodeTypes.DATA_MATRIX, encodedArr);
       generator.getParameters().getBarcode().getDataMatrix().setDataMatrixEncodeMode(DataMatrixEncodeMode.BINARY);
       generator.save("test.bmp", BarcodeImageFormat.PNG);
       #Extended codetext mode
       #create codetext
       codetextBuilder= DataMatrixExtCodetextBuilder();
       codetextBuilder.addECICodetextWithEncodeMode(ECIEncodings.Win1251,DataMatrixEncodeMode.BYTES,"World");
       codetextBuilder.addPlainCodetext("Will");
...
class QREncodeMode(Enum):
      """!
       ...
       <pre>
           generator = BarcodeGenerator(EncodeTypes.QR, "12345TEXT");
...
class MaxiCodeEncodeMode(Enum):
     ...
     ## <p>
     # Extended mode which supports multi ECI modes.</p>
     # It is better to use MaxiCodeExtCodetextBuilder for extended codetext generation.</p>
     # Use Display2DText property to set visible text to removing managing characters.</p>
     # ECI identifiers are set as single slash and six digits identifier "\000026" - UTF8 ECI identifier</p>
     # All unicode characters after ECI identifier are automatically encoded into correct character codeset.</p>
     # @deprecated
      EXTENDED_CODETEXT = 2;
...
class DotCodeEncodeMode(Enum):
      ...
      ## Extended mode which supports multi ECI modes.</p>
     # It is better to use DotCodeExtCodetextBuilder for extended codetext generation.</p>
     # Use Display2DText property to set visible text to removing managing characters.</p>
     # ECI identifiers are set as single slash and six digits identifier "\000026" - UTF8 ECI identifier</p>
     # All unicode characters after ECI identifier are automatically encoded into correct character codeset.</p>
     # @deprecated
...
class Pdf417EncodeMode(Enum):
      ...
      ## Extended mode which supports multi ECI modes.</p>
      # It is better to use Pdf417ExtCodetextBuilder for extended codetext generation.</p>
      # Use Display2DText property to set visible text to removing managing characters.</p>
      # ECI identifiers are set as single slash and six digits identifier "\000026" - UTF8 ECI identifier</p>
      # All unicode characters after ECI identifier are automatically encoded into correct character codeset.</p>
      EXTENDED = 3
...
class AztecEncodeMode(Enum):
      ...
      ## Extended mode which supports multi ECI modes.</p>
      # It is better to use AztecExtCodetextBuilder for extended codetext generation.</p>
      # Use Display2DText property to set visible text to removing managing characters.</p>
      # ECI identifiers are set as single slash and six digits identifier "\000026" - UTF8 ECI identifier</p>
      # All unicode characters after ECI identifier are automatically encoded into correct character codeset.</p>
      # @deprecated
