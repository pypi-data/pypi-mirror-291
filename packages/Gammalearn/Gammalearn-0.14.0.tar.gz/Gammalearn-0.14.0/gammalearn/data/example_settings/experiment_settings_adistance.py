...
<<<<<<<< HEAD:gammalearn/data/example_settings/experiment_settings_adistance.py
                                  LogGradientNormPerTask, LogLossWeighting, LogGradientCosineSimilarity,
                                  WriteADistance)
========
                                  LogGradientNormPerTask, LogLossWeighting, LogGradientCosineSimilarity)
>>>>>>>> master:gammalearn/data/example_settings/experiment_settings_dwa.py
...
the loss function and its weight
"""
loss_balancing = criterions.DynamicWeightAveraging(targets, **loss_balancing_options)
>>>>>>>> master:gammalearn/data/example_settings/experiment_settings_dwa.py
