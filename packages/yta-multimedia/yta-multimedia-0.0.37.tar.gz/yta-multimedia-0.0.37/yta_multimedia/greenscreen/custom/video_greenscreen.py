...
from yta_general_utils.type_checker import variable_is_type, is_google_drive_url
...
class VideoGreenscreen:
    ...
    def __init__(self, greenscreen: Union[GreenscreenDetails, str]):
        # TODO: This is repeated in 'image_greenscreen.py (refactor)
        # If provided 'greenscreen' is an str we will need
        # to automatically detect greenscreen area
        if variable_is_type(greenscreen, str):
            TMP_VIDEO_FILENAME = create_tmp_filename('tmp_gs_video.mp4')
            ...
            greenscreen = GreenscreenDetails(
                ...
                filename_or_google_drive_url = TMP_VIDEO_FILENAME,
                # TODO: Make this Enum to be more strict
                type = 'video'
            )

        # TODO: Implement checking if greenscreen.type is 'video'
