...
"""
from yta_multimedia.green_screen.classes.greenscreen_details import GreenscreenDetails
from yta_multimedia.green_screen.classes.greenscreen_area_details import GreenscreenAreaDetails

LAPTOP_ON_TABLE_VIDEO_GREENSCREEN = GreenscreenDetails(
    greenscreen_areas = [
        GreenscreenAreaDetails(
            rgb_color = '#00AE3D',
            upper_left_pixel = (567, 232),
            lower_right_pixel = (1392, 742),
            frames = None
        )
    ],
    google_drive_url = 'https://drive.google.com/file/d/1_luaJcNqP49AzeXuF4LPpAq7LvNzr95O/view?usp=sharing'
)