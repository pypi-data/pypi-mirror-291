...
class LoadingBarWithImagesManimAnimation(BaseManimAnimation):
    ...
    def animate(self):
        ...
        loading_bar_animation = loading_bar.get_animation(self.parameters['images'], self.parameters['start_percentage'], self.parameters['end_percentage'], self.parameters['duration'])
