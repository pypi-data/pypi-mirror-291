...
class PickleLLCAPI:
    ...
    def make_post_request(self, payload):
        ...
        if response.status_code == 200:
            ...
            raise ValueError(f'Failed to call API: {response.status_code} {response.text}')
    ...
    def run_regression(self, train_data, test_data, moments_to_predict, stock_symbol=None):
        """
