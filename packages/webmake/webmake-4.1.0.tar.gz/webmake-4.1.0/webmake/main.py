...
def parse_command_line():
    ...
    parser.add_argument('-p', '--polling-watcher', nargs='?', const="*", help='Use the polling watcher instead if inotify if there are dependencies with the given path prefix (or always if prefix not specified).')
...
def main():
    ...
    if args.watch:
        watcher.start_watching(args.polling_watcher)
