...
class AppCenterApp:
    ...
    def create_main_screen(self):
        ...
        # File Path
        tk.Label(self.frame_main, text="File Path:", bg="#f0f0f0", fg='#333333', font=("Arial", 16)).pack(anchor=tk.W, padx=20, pady=(20, 5))
        self.entry_file_path = tk.Entry(self.frame_main, width=50, font=("Arial", 14), bg="white", fg="black")
        self.entry_file_path.pack(padx=20, pady=(0, 10))
        tk.Button(self.frame_main, text="Browse", command=self.browse_file, bg="#007bff", fg="black", font=("Arial", 14, "bold"),highlightbackground="#e0e0e0",  highlightcolor="#e0e0e0", relief=tk.RAISED).pack(pady=10)

        # Build Version
        tk.Label(self.frame_main, text="Build Version:", bg="#f0f0f0", fg='#333333',font=("Arial", 16)).pack(anchor=tk.W, padx=20, pady=(10, 5))
        self.entry_build_version = tk.Entry(self.frame_main, font=("Arial", 14), bg="white", fg="black")
        self.entry_build_version.pack(padx=20, pady=(0, 10))

        # Group
        tk.Label(self.frame_main, text="Group:", bg="#f0f0f0", fg='#333333', font=("Arial", 16)).pack(anchor=tk.W, padx=20, pady=(10, 5))
        self.group_var = tk.StringVar(value="QA")
        self.dropdown_group = ttk.Combobox(self.frame_main, textvariable=self.group_var, values=["QA", "Collaborators"], font=("Arial", 14))
        self.dropdown_group.set("QA")  # Default value
        self.dropdown_group.pack(padx=20, pady=(0, 20))
        self.dropdown_group.configure(state="readonly")
    ...
    def distribute_release(self):
        ...
        try:
            ...
            app_name = "Blibli/iOS-Simulator-App"
            token = "69610315c8d296873169762620cc2fa2a82a452b"
