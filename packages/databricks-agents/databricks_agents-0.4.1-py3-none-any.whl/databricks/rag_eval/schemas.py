...
def get_retrieval_llm_rating_col_name(assessment_name: str) -> str:
    ...
    return (
        f"{_LLM_JUDGED_RETRIEVAL_METRIC_COL_PREFIX}{assessment_name}{_RATINGS_SUFFIX}"
    )
...
def get_retrieval_llm_rationale_col_name(assessment_name: str) -> str:
    ...
    return f"{_LLM_JUDGED_RETRIEVAL_METRIC_COL_PREFIX}{assessment_name}{_RATIONALES_SUFFIX}"
...
def get_retrieval_llm_error_message_col_name(assessment_name: str) -> str:
    ...
    return f"{_LLM_JUDGED_RETRIEVAL_METRIC_COL_PREFIX}{assessment_name}{_ERROR_MESSAGES_SUFFIX}"
...
def is_retrieval_llm_error_message_col(column_name: str) -> bool:
    ...
    return column_name.startswith(
        _LLM_JUDGED_RETRIEVAL_METRIC_COL_PREFIX
    ) and column_name.endswith(_ERROR_MESSAGES_SUFFIX)
