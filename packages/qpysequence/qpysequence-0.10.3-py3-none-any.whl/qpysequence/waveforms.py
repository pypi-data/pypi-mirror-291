...
class Waveforms:
    ...
    def add(self, array: list[float] | np.ndarray, index: int = -1, name: str = None) -> int:
    ...
    def modify_pair(
        ...
        waveform_pair = self.find_pair_by_name(name)
        waveform_pair.waveform_i.data = pair[0]
        waveform_pair.waveform_q.data = pair[1]
