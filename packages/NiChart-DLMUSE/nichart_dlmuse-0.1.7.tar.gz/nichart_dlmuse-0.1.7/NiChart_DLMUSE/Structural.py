...
from NiChart_DLMUSE import (
    ...
    CombineMasksInterface,
    MaskImageInterface,
    ReorientImageInterface,
    ROIRelabelInterface,
    nnUNetInterface,
)
...
def run_structural_pipeline(
    ...
    DLMUSEmdl_path: Path,
    outDir: str,
    dict_MUSE_ROI_Index: str,
    dict_MUSE_derived_ROI: str,
    nnUNet_raw_data_base: Any = None,
    nnUNet_preprocessed: Any = None,
    model_folder: Any = None,
    DLICV_task: Any = None,
    DLMUSE_task: Any = None,
    DLICV_fold: Any = None,
    DLMUSE_fold: Any = None,
    all_in_gpu: str = "None",
    disable_tta: bool = False,
    mode: str = "fastest",
    extract_roi_masks: bool = False,
) -> None:
    """
    ...
    roi_to_csv = Node(
        CalculateROIVolumeInterface.CalculateROIVolume(), name="roi_to_csv"
    )
    ...
    roi_to_csv.inputs.extract_roi_masks = (
        extract_roi_masks  # If True, we create an individual mask for each ROI
    )
    roi_to_csv.inputs.out_dir_roi_masks = os.path.join(
        outDir, "out_muse_individual_roi_masks"
    )
