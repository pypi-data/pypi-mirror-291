...
from geodesic.config import get_config, ClusterConfig, get_config_manager, _default_config
...
def authenticate(
    host: Optional[str] = None, name: Optional[str] = None, port_override: Optional[int] = None
) -> None:
