...
class Job(_APIObject):
    ...
    def add_model_step(
        ...
        *,
        ...
        Args:
            ...
            feature_tiles: if the number of tiles to split the job into are not implicitly derived from other inputs,
                this will set how many tiles it will divide the search requests into.
    ...
    def widget(self):
        ...
        # Infinite loop is fine here, this is a widget so the user can just interrupt the kernel if they want to stop.
        while True:
    ...
    def add_rechunk_step(
        self, *, asset_name: str, chunk_shape: List[int], step_name: str = None, workers: int = 1
    ):
    ...
    def add_multiscale_step(
        self, *, asset_name: str, step_name: str = None, min_zoom: int = 0, workers: int = 1
    ):
