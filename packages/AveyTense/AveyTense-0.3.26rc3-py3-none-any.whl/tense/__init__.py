...
class Tense(NennaiAbroads, NennaiStringz, NennaiRandomize, Time, Math, tc.Positive[str], tc.Negative[str], tc.Invertible[str]):
    ...
    import dis as __dis, typing as __tp, types as __ty
    ...
    def __invert__(self):
        ...
        return self.__str__()
    @_cm
    def toList(self, v: __tc.Union[__tc.Iterable[_T], __tc.ListConvertible[_T]], /):
        """
        \\@since 0.3.26rc3
        ```ts \\
    ...
    def owoify(self, s: _uni[str, __tc.StringVar], /):
        ...
        aren't included normally (0.3.26a3, 0.3.26b1, 0.3.26rc2), still, \\
