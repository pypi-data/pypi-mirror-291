...
import collections.abc as abc2, enum, inspect as ins, zipfile as zi, tkinter as tk, dis, types as ty, typing as tp, typing_extensions as tpe, string as st, functools as ft, uuid as uu
...
del abc2, ins, sb, tk, zi, enum, ty, tp, tpe, st, ft, tim, uu, uni # not for export