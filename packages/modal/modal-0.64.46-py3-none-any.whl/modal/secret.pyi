...
class _Secret(modal.object._Object):
    ...
    @staticmethod
    def from_name(label: str, namespace=1, environment_name: typing.Optional[str] = None) -> _Secret: ...
    @staticmethod
    async def lookup(
        label: str,
        namespace=1,
...
class Secret(modal.object.Object):
    ...
    def from_dotenv(path=None, *, filename=".env"): ...
    @staticmethod
    def from_name(label: str, namespace=1, environment_name: typing.Optional[str] = None) -> Secret: ...
