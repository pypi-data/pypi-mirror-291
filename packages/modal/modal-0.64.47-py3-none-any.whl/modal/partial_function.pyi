...
class PartialFunction(typing.Generic[P, T]):
    raw_f: typing.Callable[P, T]
    flags: _PartialFunctionFlags
    webhook_config: typing.Optional[modal_proto.api_pb2.WebhookConfig]
    is_generator: typing.Optional[bool]
...
def _find_partial_methods_for_user_cls(
    user_cls: typing.Type[typing.Any], flags: _PartialFunctionFlags
...
def _web_endpoint(
    ...
    *,
    ...
    custom_domains: typing.Optional[typing.Iterable[str]] = None,
) -> typing.Callable[[typing.Callable[P, T]], _PartialFunction[P, T]]: ...
def _asgi_app(
    _warn_parentheses_missing=None,
    *,
    label: typing.Optional[str] = None,
...
def web_endpoint(
    ...
    *,
    ...
    wait_for_response: bool = True,
    custom_domains: typing.Optional[typing.Iterable[str]] = None,
) -> typing.Callable[[typing.Callable[P, T]], PartialFunction[P, T]]: ...
def asgi_app(
    _warn_parentheses_missing=None,
    *,
    label: typing.Optional[str] = None,
