...
class TestAutocompletion:
    ...
    def test_method_list(self, client: BdnbAPI) -> None:
        ...
        assert_matches_type(SyncDefault[AutocompletionEntitesTexteAPIExpert], autocompletion, path=["response"])
...
class TestAsyncAutocompletion:
    ...
    async def test_method_list(self, async_client: AsyncBdnbAPI) -> None:
        ...
        assert_matches_type(AsyncDefault[AutocompletionEntitesTexteAPIExpert], autocompletion, path=["response"])
