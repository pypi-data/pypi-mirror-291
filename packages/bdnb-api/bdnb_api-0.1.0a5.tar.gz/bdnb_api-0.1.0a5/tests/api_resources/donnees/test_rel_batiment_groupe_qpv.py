...
from bdnb_api.types import RelBatimentGroupeQpvAPIExpert
...
class TestRelBatimentGroupeQpv:
    ...
    def test_method_list(self, client: BdnbAPI) -> None:
        ...
        assert_matches_type(SyncDefault[RelBatimentGroupeQpvAPIExpert], rel_batiment_groupe_qpv, path=["response"])
...
class TestAsyncRelBatimentGroupeQpv:
    ...
    async def test_method_list(self, async_client: AsyncBdnbAPI) -> None:
        ...
        assert_matches_type(AsyncDefault[RelBatimentGroupeQpvAPIExpert], rel_batiment_groupe_qpv, path=["response"])
