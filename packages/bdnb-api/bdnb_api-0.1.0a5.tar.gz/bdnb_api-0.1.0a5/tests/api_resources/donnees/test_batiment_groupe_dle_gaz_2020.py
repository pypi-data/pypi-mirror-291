...
from bdnb_api.types.shared import BatimentGroupeDleGaz2020APIExpert
...
class TestBatimentGroupeDleGaz2020:
    ...
    def test_method_list(self, client: BdnbAPI) -> None:
        ...
        assert_matches_type(
            SyncDefault[BatimentGroupeDleGaz2020APIExpert], batiment_groupe_dle_gaz_2020, path=["response"]
        )
...
class TestAsyncBatimentGroupeDleGaz2020:
    ...
    async def test_method_list(self, async_client: AsyncBdnbAPI) -> None:
        ...
        assert_matches_type(
            AsyncDefault[BatimentGroupeDleGaz2020APIExpert], batiment_groupe_dle_gaz_2020, path=["response"]
        )
