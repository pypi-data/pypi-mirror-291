...
class ODAPCatData(UserData):
    ...
    def __init__(
        ...
        *,  # all arguments below must be defined as a keyword argument
        ...
        Param: <https://github.com/mikejohnson51/opendap.catalog/blob/master/docs/cat_params.json>
        Grids: <https://github.com/mikejohnson51/opendap.catalog/blob/master/docs/cat_grids.json>
