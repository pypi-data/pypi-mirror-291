...
from vitaleey_cli.api.config import EnvironmentNames
...
class Gateway:
    ...
    def __init__(self, environment, config_dir):
        ...
        self._environment = EnvironmentNames().get_group(environment)
    ...
    def _find_config_dir(self, config_dir, environment):
        ...
        for env in EnvironmentNames().get_group_options(environment):
