...
# Static methods
    ...
    def GetAll(model, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then an array of HexSpotweldAssembly objects is returned.
        If the property argument is given, that property value for each DEFINE_HEX_SPOTWELD_ASSEMBLY is returned in the array
    ...
    def GetFlagged(model, flag, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then an array of HexSpotweldAssembly objects is returned.
        If the property argument is given, then that property value for each DEFINE_HEX_SPOTWELD_ASSEMBLY is returned in the array
        instead of a HexSpotweldAssembly object
