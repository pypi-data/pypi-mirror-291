...
class IgaEdgeUVW(Oasys.gRPC.OasysItem, metaclass=IgaEdgeUVWType):
    _props = {'eid', 'exyzid', 'include', 'label', 'patchid', 'rend', 'rstart', 'sense'}
...
# Static methods
    ...
    def GetAll(model, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then an array of IgaEdgeUVW objects is returned.
        If the property argument is given, that property value for each IGA Edge UVW is returned in the array
    ...
    def GetFlagged(model, flag, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then an array of IgaEdgeUVW objects is returned.
        If the property argument is given, then that property value for each IGA Edge UVW is returned in the array
        instead of a IgaEdgeUVW object
