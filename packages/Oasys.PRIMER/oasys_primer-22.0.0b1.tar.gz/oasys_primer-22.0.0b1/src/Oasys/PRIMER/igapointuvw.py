...
class IgaPointUVW(Oasys.gRPC.OasysItem, metaclass=IgaPointUVWType):
    _props = {'include', 'label', 'nid', 'pid', 'u', 'v', 'w'}
...
# Static methods
    ...
    def GetAll(model, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then an array of IgaPointUVW objects is returned.
        If the property argument is given, that property value for each IGA Point UVW is returned in the array
    ...
    def GetFlagged(model, flag, property=Oasys.gRPC.defaultArg):
        ...
        If the optional property argument is not given then an array of IgaPointUVW objects is returned.
        If the property argument is given, then that property value for each IGA Point UVW is returned in the array
        instead of a IgaPointUVW object
