...
class IaruCoordinationEnum(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """IaruCoordinationEnum - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["IARU Coordinated", "IARU Declined", "IARU Uncoordinated", "N/A", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["IARU Coordinated", "IARU Declined", "IARU Uncoordinated", "N/A", ]  # noqa: E501
