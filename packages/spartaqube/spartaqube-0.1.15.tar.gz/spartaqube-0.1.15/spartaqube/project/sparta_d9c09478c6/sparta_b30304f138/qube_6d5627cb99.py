...
def sparta_4b5a23dad1(json_data,userObj):
	A=json_data
	try:D=A[_A];E=A[_C];B=os.path.dirname(D);F,G=sparta_8272e11524(B,E);C={_B:1,'files':G,_D:F,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_a7f27a7f80(json_data,userObj):
	A=json_data
	try:B=A[_A];D=A[_C];E,F=sparta_8272e11524(B,D);C={_B:1,'files':F,_D:E,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_8272e11524(currentPath,typeexplorer=None):
...
def sparta_f7806229ef(currentPath):
