	...
	def start_stream(self,gui_websocket,b_get_print_buffer=True):
		...
		def thread_streaming_processing_func():
			while not self.stop_event.is_set():
				while queue_connector:msg=queue_connector.pop();msg_df=sparta_8be9597829(msg);msg_json=sparta_a355416660(msg_df);res={_B:1,'msg':msg,'msg_json':msg_json,'maxlen':queue_connector.maxlen};resJson=json.dumps(res);gui_websocket.send(resJson)
