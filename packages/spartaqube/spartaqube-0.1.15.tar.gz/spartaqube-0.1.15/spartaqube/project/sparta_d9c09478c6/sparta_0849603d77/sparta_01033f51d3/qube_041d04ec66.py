...
plot_example"""}]
def sparta_bb17d50950():return sparta_92894d4777(type=_N)
def sparta_4fd9c4ad02():return sparta_92894d4777(type='gauge2')
def sparta_a1a263d916():
	type='gauge3'
	if conf_settings.IS_DEV:B=_F
	else:B=_G
