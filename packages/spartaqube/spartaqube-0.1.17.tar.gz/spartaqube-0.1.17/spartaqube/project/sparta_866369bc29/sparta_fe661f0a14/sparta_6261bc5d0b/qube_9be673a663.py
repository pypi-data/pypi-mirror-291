...
def sparta_c0ff249927(type='line'):
...
plot_example"""}]
def sparta_bf4c02863d():return sparta_c0ff249927(type='line')
def sparta_9acab7f7cd():return sparta_c0ff249927(type='bar')
def sparta_85da2f62b6():return sparta_c0ff249927(type='scatter')
def sparta_b6544656fc():
	if conf_settings.IS_DEV:A=_F
	else:A=_G
...
plot_example"""}]
def sparta_0de8bfa66d(type='pie'):
	if conf_settings.IS_DEV:A=_F
	else:A=_G
...
plot_example"""}]
def sparta_dccd99ba38():return sparta_0de8bfa66d(type='donut')
def sparta_fe2ffb9c90():return sparta_0de8bfa66d(type='polar')
def sparta_0adf73c812():
	type='bubble'
	if conf_settings.IS_DEV:A=_F
	else:A=_G
	B={_I:_L,_J:_M,_K:_N};C=_O;D=_P;return[{_A:f"Simple {type}",_B:_E,_C:'',_D:f"""{A}
