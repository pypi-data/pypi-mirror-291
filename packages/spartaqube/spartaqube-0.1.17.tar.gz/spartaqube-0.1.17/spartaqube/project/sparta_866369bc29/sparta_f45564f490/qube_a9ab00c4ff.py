...
def sparta_6a486a2821(user_obj):
	B=user_obj
	...
	return A
def sparta_42717e8255(json_data,user_obj):
...
def sparta_e7dd18b5d2(json_data,user_obj):
...
def sparta_20509082f7(json_data,user_obj):
	...
	return{_C:1}
def sparta_66c1fbd1bf(json_data,user_obj):
