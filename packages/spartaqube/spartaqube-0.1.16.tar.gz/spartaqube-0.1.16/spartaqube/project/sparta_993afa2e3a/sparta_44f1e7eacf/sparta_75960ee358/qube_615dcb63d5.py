...
plot_example"""}]
def sparta_dbe74532b1():return sparta_c0603f7237(type=_N)
def sparta_d6a36438cb():return sparta_c0603f7237(type='gauge2')
def sparta_bc0a0581ae():
	type='gauge3'
	if conf_settings.IS_DEV:B=_F
	else:B=_G
