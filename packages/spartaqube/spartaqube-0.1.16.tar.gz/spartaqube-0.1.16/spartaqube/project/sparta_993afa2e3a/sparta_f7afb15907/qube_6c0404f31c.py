...
def sparta_4add7053bd(user_obj):
	B=user_obj
	...
	return A
def sparta_0788d03350(json_data,user_obj):
...
def sparta_4129bf0f23(json_data,user_obj):
...
def sparta_6abd4d650b(json_data,user_obj):
	...
	return{_C:1}
def sparta_0aac1bf0b1(json_data,user_obj):
