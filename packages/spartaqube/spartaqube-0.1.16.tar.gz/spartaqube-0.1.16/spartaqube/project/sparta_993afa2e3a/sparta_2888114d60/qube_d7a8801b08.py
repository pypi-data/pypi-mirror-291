...
def sparta_2348a045a1(json_data,userObj):
	A=json_data
	try:D=A[_A];E=A[_C];B=os.path.dirname(D);F,G=sparta_db5fe738fa(B,E);C={_B:1,'files':G,_D:F,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_412b92f03e(json_data,userObj):
	A=json_data
	try:B=A[_A];D=A[_C];E,F=sparta_db5fe738fa(B,D);C={_B:1,'files':F,_D:E,_A:B}
	except:C={_B:-1,'msg':_E}
	return C
def sparta_db5fe738fa(currentPath,typeexplorer=None):
...
def sparta_beb5a3ce22(currentPath):
