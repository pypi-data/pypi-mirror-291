...
import EVMVerifier.certoraContextAttributes as ProvAttrs
...
class MutateValidator:
    ...
    def mutation_attribute_in_prover(self) -> None:
        ...
        prover_attrs = [attr.get_conf_key() for attr in ProvAttrs.ContextAttributes.attribute_list]
    ...
    def validate_arg_types(self) -> None:
        ...
        for arg in Attrs.MutateAttributes.attribute_list:
