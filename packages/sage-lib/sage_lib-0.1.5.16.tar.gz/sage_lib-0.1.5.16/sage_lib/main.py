...
def generate_AbInitioThermodynamics(path: str, source: str = None, forces_tag:str=None, energy_tag:str=None, subfolders: bool = False, output_path: str = None, 
                            output_source: str = None, verbose: bool = False, index:int=None,
                plot:str=None, reference:list=None, k:int=None, optimize:bool=None):
    """
    ( 3 )
    """
    output_path = output_path if output_path is not None else '.'
...
def add_arguments(parser):
    ...
    parser.add_argument('--index', type=int, help='')    
...
def main():
    ...
    parser_AbIT.add_argument('--plot', type=str, choices=['phase_diagram', 'ensemble_analysis', 'composition_analysis'], help='')
    parser_AbIT.add_argument('--reference', nargs='+', help='')
    parser_AbIT.add_argument('--k', type=int, default=6, help='')
    parser_AbIT.add_argument('--optimize', default=False, action='store_true', help='')
