...
SDL_FUNC("SDL_WarpMouseGlobal", ctypes.c_int, ctypes.c_float, ctypes.c_float)
SDL_FUNC("SDL_SetWindowRelativeMouseMode", ctypes.c_int, ctypes.POINTER(SDL_Window), ctypes.c_bool)
SDL_FUNC("SDL_GetWindowRelativeMouseMode", ctypes.c_bool, ctypes.POINTER(SDL_Window))
SDL_FUNC("SDL_CaptureMouse", ctypes.c_int, ctypes.c_bool)
...
SDL_FUNC("SDL_SetCursor", ctypes.c_int, ctypes.POINTER(SDL_Cursor))
...
SDL_FUNC("SDL_ShowCursor", ctypes.c_int)
SDL_FUNC("SDL_HideCursor", ctypes.c_int)
