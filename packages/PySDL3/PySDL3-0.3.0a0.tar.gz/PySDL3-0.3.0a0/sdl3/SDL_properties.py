...
SDL_FUNC("SDL_CopyProperties", ctypes.c_int, SDL_PropertiesID, SDL_PropertiesID)
SDL_FUNC("SDL_LockProperties", ctypes.c_int, SDL_PropertiesID)
...
SDL_FUNC("SDL_SetPointerPropertyWithCleanup", ctypes.c_int, SDL_PropertiesID, ctypes.c_char_p, ctypes.c_void_p, SDL_CleanupPropertyCallback, ctypes.c_void_p)
SDL_FUNC("SDL_SetPointerProperty", ctypes.c_int, SDL_PropertiesID, ctypes.c_char_p, ctypes.c_void_p)
SDL_FUNC("SDL_SetStringProperty", ctypes.c_int, SDL_PropertiesID, ctypes.c_char_p, ctypes.c_char_p)
SDL_FUNC("SDL_SetNumberProperty", ctypes.c_int, SDL_PropertiesID, ctypes.c_char_p, ctypes.c_int64)
SDL_FUNC("SDL_SetFloatProperty", ctypes.c_int, SDL_PropertiesID, ctypes.c_char_p, ctypes.c_float)
SDL_FUNC("SDL_SetBooleanProperty", ctypes.c_int, SDL_PropertiesID, ctypes.c_char_p, ctypes.c_bool)
...
SDL_FUNC("SDL_ClearProperty", ctypes.c_int, SDL_PropertiesID, ctypes.c_char_p)

SDL_EnumeratePropertiesCallback = ctypes.CFUNCTYPE(None, ctypes.c_void_p, SDL_PropertiesID, ctypes.c_char_p)

SDL_FUNC("SDL_EnumerateProperties", ctypes.c_int, SDL_PropertiesID, SDL_EnumeratePropertiesCallback, ctypes.c_void_p)
