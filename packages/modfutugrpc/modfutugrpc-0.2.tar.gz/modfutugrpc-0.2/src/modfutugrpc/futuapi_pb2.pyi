...
class PlaceOrder_Req(_message.Message):
    __slots__ = ("acc_id", "trd_env", "code", "side", "order_type", "qty", "price")
    ...
    qty: int
    price: float
    def __init__(self, acc_id: _Optional[str] = ..., trd_env: _Optional[str] = ..., code: _Optional[str] = ..., side: _Optional[str] = ..., order_type: _Optional[str] = ..., qty: _Optional[int] = ..., price: _Optional[float] = ...) -> None: ...
...
class GetActiveOrders_Req(_message.Message):
    __slots__ = ("acc_id", "trd_env")
    ACC_ID_FIELD_NUMBER: _ClassVar[int]
    TRD_ENV_FIELD_NUMBER: _ClassVar[int]
    acc_id: str
    trd_env: str
    def __init__(self, acc_id: _Optional[str] = ..., trd_env: _Optional[str] = ...) -> None: ...
...
class OnUpdateTradeOrder_Msg(_message.Message):
    __slots__ = ("order_id", "trade_order", "update_holding", "deal_fee")
    ORDER_ID_FIELD_NUMBER: _ClassVar[int]
    TRADE_ORDER_FIELD_NUMBER: _ClassVar[int]
    UPDATE_HOLDING_FIELD_NUMBER: _ClassVar[int]
    DEAL_FEE_FIELD_NUMBER: _ClassVar[int]
    order_id: str
    trade_order: _order_pb2.Order
    update_holding: _position_pb2.Position
    deal_fee: _orderfee_pb2.OrderFee
    def __init__(self, order_id: _Optional[str] = ..., trade_order: _Optional[_Union[_order_pb2.Order, _Mapping]] = ..., update_holding: _Optional[_Union[_position_pb2.Position, _Mapping]] = ..., deal_fee: _Optional[_Union[_orderfee_pb2.OrderFee, _Mapping]] = ...) -> None: ...
