...
class UsersAPI:  # noqa: D101
    ...
    def user_who_personal_key(self):
        ...
        sak_caller_info_object = self.connection.configuration._get_sak_key_details()
    ...
    def who(self, org: Optional[str] = None):
        ...
        if self.connection.configuration.app_key and self.connection.configuration.app_key.startswith(
            ...
            sak_caller_info_object = self.user_who_personal_key()
            return sak_caller_info_object
