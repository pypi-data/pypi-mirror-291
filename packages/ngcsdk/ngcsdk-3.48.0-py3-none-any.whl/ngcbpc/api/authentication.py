...
class Authentication:  # noqa: D101
    ...
    def get_sak_key_details():
        ...
        sak_key_request = SakCallerInfoRequest({"credentials": Authentication.config.app_key})
        try:
    ...
    def _raise_for_status(response):
        ...
        try:
            ...
            raise Authentication._create_api_error_from_http_exception(e)
