...
NGC_CLI_MAX_CONCURRENCY = int(environ.get("NGC_CLI_MAX_CONCURRENCY") or multiprocessing.cpu_count() * 2)
...
NGC_CLI_PROGRESS_UPDATE_FREQUENCY = float(environ.get("NGC_CLI_PROGRESS_UPDATE_FREQUENCY", "0.1"))
