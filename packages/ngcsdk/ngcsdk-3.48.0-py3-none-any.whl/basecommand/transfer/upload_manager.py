...
class UploadManager:
    ...
    def upload_dataset(  # noqa: C901
        ...
        if storage_type == STORAGE_TYPE_OBJECT:
            ...
            storage_url = self.get_grpc_url(dataset_info.aceStorageServiceUrl, None)
    ...
    def get_default_storage(self, org_name, ace_name):
        """Return storage config with is default true."""
    ...
    def get_grpc_url(url, default_storage):  # noqa: D102
        ...
        grpc_port = default_storage.grpcPort if default_storage and default_storage.grpcPort else GRPC_SERVER_PORT
