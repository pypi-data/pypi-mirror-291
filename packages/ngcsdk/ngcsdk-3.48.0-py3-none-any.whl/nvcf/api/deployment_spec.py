...
class DeploymentSpecification:
    """This class represents a deployment specification for NVCF"""  # noqa: D404, D415
    ...
    def from_str(cls: Type[T], in_str: str) -> T:
        ...
        try:
            ...
            raise NgcException(
                "Incorrect deployment specification format: expect backend:gpu:instanceType:minInstances:maxInstances."
            ) from None

    @classmethod
    def from_dict(cls: Type[T], in_dict: dict) -> T:  # noqa: D102
