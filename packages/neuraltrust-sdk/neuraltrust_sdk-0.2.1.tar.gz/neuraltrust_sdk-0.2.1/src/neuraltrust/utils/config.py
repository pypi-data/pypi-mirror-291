...
class ConfigHelper:
    ...
    def load_llm_judge_model():
        return ConfigHelper.load_config_field("llm_judge_model") or os.getenv("LLM_JUDGE_MODEL")
    ...
    def load_llm_provider():
        return ConfigHelper.load_config_field("llm_provider") or os.getenv("LLM_PROVIDER")
